...
{slot_reference: "name", value: [{value_type: "string", value_content: "service CLS Administration Console"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Console technique pour gérer des propriétés des applications"}, ]}, 
