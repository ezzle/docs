...
{slot_reference: "description", value: [{value_type: "string", value_content: "Module Composants de base : diagramme db BC : données, paramètres et correspondance que nous envoyons : tableaux techniques"}, ]}, 
