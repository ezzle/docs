...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_769905_Class9"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Schuldgegevens op flow van debiteurenbeheer naar Vlabel managed by Mijn kantoor invordering03-Debiteurenbeheer_Prod"}, ]}, 
