...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module lettre de missions de l' huissier de justice  rédiger des lettres de missions"}, ]}, 
