...
{slot_reference: "name", value: [{value_type: "string", value_content: "TC non automatisée  TC VB Lite” contient en fait seulement de la fonctionalité de consultation et calcul (écran de simulation) (utilisé par AG D&amp;A)"}, ]}, 
