...
{slot_reference: "name", value: [{value_type: "string", value_content: "9 Services Contentieux et Evaluations"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "9 services Contentieux et Evaluations"}, ]}, 
