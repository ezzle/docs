...
{slot_reference: "name", value: [{value_type: "string", value_content: "données tarifaires sur le flux de tarbel vers tarweb"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données tarifaires sur le flux de tarbel vers tarweb"}, ]}, 
