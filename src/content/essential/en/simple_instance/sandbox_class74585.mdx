...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 371BIS: demande pour attestation hypothécaire concernant une commerce"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demande pour attestation hypothécaire concernant un commerce."}, ]}, 
