...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire données de comptabilité sur le flux mensuel de Open ICPC vers Gestion des Debiteurs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux mensuel du formulaire avec les données de comptabilité de Open ICPC vers Gestion Des Débiteurs"}, ]}, 
