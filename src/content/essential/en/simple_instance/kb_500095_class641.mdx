...
{slot_reference: "name", value: [{value_type: "string", value_content: "questions pour renseignements internationaux et assistance au recouvrement sur le flux de Stirint int inv vers Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "questions pour renseignements internationaux et assistance au recouvrement sur le flux de Stirint int inv vers Stirint isi"}, ]}, 
