...
{slot_reference: "name", value: [{value_type: "string", value_content: "données des membres du personnel sur le flux de Autp vers Filenet object store PNO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des membres du personnel sur le flux de Autp vers filenet object store PNO"}, ]}, 
