...
{slot_reference: "name", value: [{value_type: "string", value_content: "Continuer à élaborer le Jobs@Fin comme outil interne central pour la mobilité"}, ]}, 
