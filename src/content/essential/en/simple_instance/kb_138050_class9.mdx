...
{slot_reference: "name", value: [{value_type: "string", value_content: "Data owners must have the authority and means to manage the data for which they are accountable. Part of the role of data owner, is to ensure data quality"}, ]}, 
