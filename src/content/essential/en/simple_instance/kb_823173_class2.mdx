...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_823173_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "informatie schulden ivm vereenvoudigde fiscale derdenbeslagen op flow van ICPC naar SAFS managed by ICPC_PROD"}, ]}, 
