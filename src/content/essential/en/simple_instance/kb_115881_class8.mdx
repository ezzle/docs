...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "MYSPF1 Database (RDC) managed by Calcul IPP  Aanslagjaar 2020_PROD"}, ]}, 
