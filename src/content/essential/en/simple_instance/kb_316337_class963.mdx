...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Arcmap (repris par Cadgis)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Arcmap service
Logiciel SIG utilisé dans le traitement des données géographiques au sein de l'AGDP.
Retired: repris par Cadgis."}, ]}, 
