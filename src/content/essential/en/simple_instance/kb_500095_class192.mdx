...
{slot_reference: "name", value: [{value_type: "string", value_content: "référence vers des instructions et documentation non-fiscale sur le flux de SPS consultation vers niet fiscale doc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "référence vers des instructions et documentation non-fiscale sur le flux de consultation fiches SPS vers application Niet fiscale doc"}, ]}, 
