...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des risques D&amp;A (P17.2)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Vérification des risques associés au transport de marchandises (SEDA)"}, ]}, 
