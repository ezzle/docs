...
{slot_reference: "description", value: [{value_type: "string", value_content: "synchronisatie rekeningnummers tussen db Taxi en db REK op mainframe"}, ]}, 
