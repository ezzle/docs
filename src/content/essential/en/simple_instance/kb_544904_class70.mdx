...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_544904_Class71"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_544904_Class72"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Toekomst: refertenummers internationaal verzonden pakjes op input flow E Commerce naar NCTS_PROD managed by PC Acces toepassing internationaal verzonden pakjes / in toekomst = E Commerce"}, ]}, 
