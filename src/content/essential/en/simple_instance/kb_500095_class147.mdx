...
{slot_reference: "name", value: [{value_type: "string", value_content: "données de vérification concernant des autorisations sur le flux de AEO vers ICS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux par webservice AEO sur le Datapower Esb pour verifier les  autorisations AEO et autres"}, ]}, 
