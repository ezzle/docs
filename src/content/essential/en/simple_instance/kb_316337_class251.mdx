...
{slot_reference: "name", value: [{value_type: "string", value_content: "Transférer toutes les applications informatiques existantes développées en interne aux prestataires de services ICT internes ou externes"}, ]}, 
