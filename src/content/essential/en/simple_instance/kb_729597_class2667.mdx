...
{slot_reference: "name", value: [{value_type: "string", value_content: "MOSS  reporting: een module van statistieken en rapportering, die toelaat gebruikersstatistieken te visualiseren van een specifiek BTW régime"}, ]}, 
