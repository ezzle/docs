...
{slot_reference: "name", value: [{value_type: "string", value_content: "dettes Database (RDC)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "DETTES Base de données relationnelle sur RDC DB2 Environnement Pour info : composition de la famille éventuellement incluse dans le E-Notaire à l'avenir (GDPR donné)"}, ]}, 
