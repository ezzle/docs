...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_499342_Class50"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Maandelijkse flow van artikelnummers voor inkohiering Verkeersbelasting van ICPC naar Geaut. VB"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Artikelnummers voor inkohiering Verkeersbelasting op Maandelijkse flow van ICPC naar Geautomatiseerde Verkeersbelasting managed by ICPC_PROD"}, ]}, 
