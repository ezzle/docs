...
{slot_reference: "name", value: [{value_type: "string", value_content: "MODA 1 (Douane Mobile) windows_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "MODA = Mobiel toezicht Douane, application pour la gestion des missions des Teams mobiles du département Operations."}, ]}, 
