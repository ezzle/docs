...
{slot_reference: "name", value: [{value_type: "string", value_content: "selection parcelles de Cadgis en xml sur le flux de Cadgis vers Stipad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "selection parcelles de Cadgis en xml sur le flux de Cadgis vers Stipad"}, ]}, 
