...
{slot_reference: "description", value: [{value_type: "string", value_content: "Dans chaque domaine, nous voulons améliorer notre position par rapport à celle de nos principaux partenaires commerciaux."}, ]}, 
