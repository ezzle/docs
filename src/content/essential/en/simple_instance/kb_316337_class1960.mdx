...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PROXY"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion et configuration de proxy de l'accès des fonctionnaires et des applications à l'Internet"}, ]}, 
