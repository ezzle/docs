...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_425693_Class105"}, ]}, 
{slot_reference: "app_pro_persists_info_rep", value: [{value_type: "boolean", value_content: "false"}, ]}, 
{slot_reference: "used_in_app_dependencies", value: [{value_type: "simple_instance", value_content: "KB_456742_Class5"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Jaarlijkse bestanden met statistische gegevens op flow van Myrent naar Statis managed by SP17  Huurcontracten  Contrats de location_PROD  MyRent  BAUX"}, ]}, 
