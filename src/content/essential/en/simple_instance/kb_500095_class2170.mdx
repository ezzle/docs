...
{slot_reference: "name", value: [{value_type: "string", value_content: "matricule sur le flux de Autp vers My Academy"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Autp vers My Academy (matricule)"}, ]}, 
