...
{slot_reference: "name", value: [{value_type: "string", value_content: "Etablissement des impôts directs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Groupe des capacités relatives à l'établissement des impôts directs"}, ]}, 
