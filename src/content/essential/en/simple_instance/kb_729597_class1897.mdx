...
{slot_reference: "name", value: [{value_type: "string", value_content: "site web général cdib  application de consultation des procédures douane"}, ]}, 
