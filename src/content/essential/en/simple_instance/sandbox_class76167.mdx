...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant la politique du maintien de l'ordre sur le flux de Monitoringtool Handhaving vers IRMA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant la politique du maintien de l'ordre sur le flux de Monitoringtool Handhaving vers IRMA"}, ]}, 
