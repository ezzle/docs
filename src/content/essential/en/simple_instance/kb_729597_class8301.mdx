...
{slot_reference: "description", value: [{value_type: "string", value_content: "La résolution des noms passe encore par WINS pour des raisons de compatibilité avec les anciennes applications."}, ]}, 
