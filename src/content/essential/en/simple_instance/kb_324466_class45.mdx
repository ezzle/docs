...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_324466_Class46"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "(archived) Informatie op flow van PDF60 naar Funcadnet managed by PDF60_PROD"}, ]}, 
