...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class73"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "internationale financiële inlichtingen i.v.m. Directe Belastingen op flow van CCN gateway 1 naar STIRint  CRS managed by CCN gateway 1"}, ]}, 
