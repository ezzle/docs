...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class149"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "cijfers omtrent aangiften Professionele Diesel op flow van PDIE Masp naar IPI informatieplan managed by PDIE_PROD (masp)"}, ]}, 
