...
{slot_reference: "description", value: [{value_type: "string", value_content: "Outil utilisé pour le déploiement de services (applications WebLogic et bases de données DB2)"}, ]}, 
