...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI dashboard  enquête ad hoc pour demander les KPI's pour un service ou région spécifique (ou national)"}, ]}, 
