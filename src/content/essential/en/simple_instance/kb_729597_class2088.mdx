...
{slot_reference: "name", value: [{value_type: "string", value_content: "établissements d'accises-naviger vers les détails des licence et accises"}, ]}, 
