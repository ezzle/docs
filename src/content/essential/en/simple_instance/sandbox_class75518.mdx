...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Trésorie dossier de fonds de détenus libérés ou inconnus  nouveau dossier"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire Trésorie dossier de fonds de détenus libérés ou inconnus  nouveau dossier"}, ]}, 
