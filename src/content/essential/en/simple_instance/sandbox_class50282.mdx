...
{slot_reference: "name", value: [{value_type: "string", value_content: "Belfirst (informations commerciales)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application externe offrant des informations commerciales contre paiement; par exemple, utilisée par l'AG Douane et Accises."}, ]}, 
