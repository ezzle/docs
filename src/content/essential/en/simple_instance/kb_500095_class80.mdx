...
{slot_reference: "name", value: [{value_type: "string", value_content: "url pour flux de Locostat vers Cadgis (human)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Locostat vers Cadgis (url)"}, ]}, 
