...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_544904_Class64"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_544904_Class50"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Toekomst: refertenummers internationaal verzonden pakjes op flow van E Commerce naar SAP systeem UPS DHL managed by PC Acces toepassing internationaal verzonden pakjes / in toekomst = E Commerce"}, ]}, 
