...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  transversal  Vue nationale par débiteur (sur plusieurs tribunaux)"}, ]}, 
