...
{slot_reference: "name", value: [{value_type: "string", value_content: "exactitude"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les
données sont exactes et égales à la réalité qu’elles 
sont censées représenter.  Ce critère englobe la notion 
de précision et de validité."}, ]}, 
