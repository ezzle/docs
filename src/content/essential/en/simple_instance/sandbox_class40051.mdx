...
{slot_reference: "name", value: [{value_type: "string", value_content: "Technologie  Modèle de distribution"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente une vue logique des environnements technologiques de déploiement significatives pour l'organisation."}, ]}, 
