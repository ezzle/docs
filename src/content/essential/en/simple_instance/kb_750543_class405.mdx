...
{slot_reference: "name", value: [{value_type: "string", value_content: "P049 Gestion de la clientèle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "?? Gestion de la clientèle (P49)"}, ]}, 
