...
{slot_reference: "name", value: [{value_type: "string", value_content: "continuer à étendre le groupe-cible qui reçoit une proposition de déclaration simplifiée (PDS)"}, ]}, 
