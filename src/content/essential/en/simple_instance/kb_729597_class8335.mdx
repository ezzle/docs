...
{slot_reference: "name", value: [{value_type: "string", value_content: "Recherche de topics et de queues"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce composant permet l’obtention d’un topic ou d’une queue après vérification des paramètres d’une destination. Ce module est disponible au sein du framework CCFF."}, ]}, 
