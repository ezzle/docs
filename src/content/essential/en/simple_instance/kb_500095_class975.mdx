...
{slot_reference: "name", value: [{value_type: "string", value_content: "données patrimoniales sur le flux de Funcadnet vers Legger (retired?)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données patrimoniales sur le flux de Funcadnet vers Legger"}, ]}, 
