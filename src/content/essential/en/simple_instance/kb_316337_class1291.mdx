...
{slot_reference: "name", value: [{value_type: "string", value_content: "service docICT"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Documentation ICT concernant les Architecture Building Blocks (technologie utilisée, c'est IRISNext) Authorisation= intern"}, ]}, 
