...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de l'entité précompte immobilier chez un indivision par application DU-FNF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de l'entité précompte immobilier chez une indivisibilité par application DU-FNF"}, ]}, 
