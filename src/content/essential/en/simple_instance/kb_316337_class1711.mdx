...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service ActiveDirectory"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Active Directory interne au SPF Finances (Microsoft), synchrone avec IAM."}, ]}, 
