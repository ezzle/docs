...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_037024_Class20"}, ]}, 
{slot_reference: "app_pro_persists_info_rep", value: [{value_type: "boolean", value_content: "false"}, ]}, 
{slot_reference: "app_pro_to_inforep_from_app", value: [{value_type: "simple_instance", value_content: "KB_135685_Class37"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Rapporten met gegevens onroerende goederen op flow van Stipad / ConsultImmo naar client Vlabel over ESB (flow naar externe niet FOD FIN applicatie) managed by Vlabel"}, ]}, 
