...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros de comptes financiers sur le flux de Taxi vers Fin Rek"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "synchronisation numéros de compte entre db Taxi et db REK sur mainframe"}, ]}, 
