...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_593883_Class24"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flow gegevens overtreders naar Camada"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "controleresultaten van de uitgevoerde aangiftegebonden controles op flow van Feedback naar Camada managed by FEEDBACK_Prod"}, ]}, 
