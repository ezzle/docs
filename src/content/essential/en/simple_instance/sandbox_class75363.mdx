...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Squeeze-out  Récupérer les fonds en TRansférer les titres virtuels"}, ]}, 
