...
{slot_reference: "name", value: [{value_type: "string", value_content: "demandes d'exonération en matière de l'achat avec exonération diplomatique de moyens de transport"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demandes d'exonération en matière de l'achat avec exonération diplomatique de moyens de transport"}, ]}, 
