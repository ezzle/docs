...
{slot_reference: "name", value: [{value_type: "string", value_content: "service COMPTEXT"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Comptabilité des extraits (local)"}, ]}, 
