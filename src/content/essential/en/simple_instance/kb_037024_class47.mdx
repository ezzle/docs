...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_037024_Class48"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "signaletiek natuurlijke persoon eigenaar onroerende goederen op flow van KSZ naar Consultimmo over ESB (inkomende stroom van externe niet Fod Fin applicatie) managed by KSZ applicatie 4e weg"}, ]}, 
