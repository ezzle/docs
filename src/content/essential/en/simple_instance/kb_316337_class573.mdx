...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mettre en oeuvre le processus « comptabilité analytique » et la poursuite et le développement du le rapportage sur le « coût de revient financier »"}, ]}, 
