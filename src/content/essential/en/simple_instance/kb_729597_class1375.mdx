...
{slot_reference: "name", value: [{value_type: "string", value_content: "Generer l'aperçu du calcul en pdf (valeur normale d'un nouveau établissement)"}, ]}, 
