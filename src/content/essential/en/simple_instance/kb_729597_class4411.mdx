...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  générer une lettre pour les institutions financières (gérer des livraisons)"}, ]}, 
