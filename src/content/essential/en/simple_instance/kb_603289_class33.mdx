...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_603289_Class34"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "powershell script voor toekennen van rechten op ECL/shared voor batch feed locostat via flow van Locostat naar ADM expert managed by CADNET LOCOSTAT _PROD"}, ]}, 
