...
{slot_reference: "name", value: [{value_type: "string", value_content: "Lancer un programme de 'Digitalisation' qui porte une attention particulière aux fondements de la digitalisation (comme la législation Only once et le scanning), et développer la prestation de services digitale"}, ]}, 
