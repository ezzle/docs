...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire demande d'autorisation d'import temporaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "régime douanier particulier  demande d'une autorisation pour l'usage du régime import temporaire: article 211, 1 sous a) du code Taric de certificat C516 autorisation pour l'usage du régime import temporaire"}, ]}, 
