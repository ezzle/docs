...
{slot_reference: "name", value: [{value_type: "string", value_content: "valeur de ventes des transactions immobilières sur le flux de Cadnet LocoSELECT vers modèle mathematique de SAS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "valeurs de vente des transactions immobilieres sur le flux de Cadnet LocoSELECT vers SAS  modèle mathematique"}, ]}, 
