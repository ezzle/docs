...
{slot_reference: "name", value: [{value_type: "string", value_content: "Dettes sociales et fiscales sur le flux de Esucc vers SP23 eFunctionnaire Instrumentant Ambtenaar"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dettes sociales et fiscales sur le flux de Esucc vers  SP23 eFunctionnaire Instrumentant Ambtenaar"}, ]}, 
