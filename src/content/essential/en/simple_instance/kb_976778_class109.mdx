...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_976778_Class110"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info over selectie aangiftes op flow van seda naar consultatie SPS fiches managed by SEDA"}, ]}, 
