...
{slot_reference: "name", value: [{value_type: "string", value_content: "aperçu des documents récemment rentrés (déclarations périodiques, listes de clients, déclarations intracommunautaires)"}, ]}, 
