...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_001950_Class43"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Data-extracten inzake NCTS-aangiftes via mail op manuele flow van Ncts naar Ncts Opladen (toekomst via ETL uit NCTS Rewrite) managed by NCTS_PROD"}, ]}, 
