...
{slot_reference: "name", value: [{value_type: "string", value_content: "données demandes étrangères remboursement TVA sur le flux manuel de VAT Refund vers E Forms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des demandes étrangères de remboursement TVA sur le flux manuel de VAT Refund vers E Forms"}, ]}, 
