...
{slot_reference: "name", value: [{value_type: "string", value_content: "saisie-arrêt simplifiée sur le flux de First vers CBB fichier central des avis de saisie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Saisie-arrêt simplifiée sur le flux de messages de  First vers le fichier central des messages de saisie (CBB) , car il faut inclure la saisie-arrêt de manière simplifiée."}, ]}, 
