...
{slot_reference: "name", value: [{value_type: "string", value_content: "Versements anticipés_PROD::traiter les remboursements des versements anticipés"}, ]}, 
