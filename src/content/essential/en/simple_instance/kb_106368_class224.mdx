...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class225"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens omtrent accijnsgerelateerde controles op flow van feedback accijnzen naar register 480 managed by Feedback Accijnzen-Feedback accises_Prod"}, ]}, 
