...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA dashboard  sauvegarde de commentaires pour un opérateur et quelques autres critères pour une transmission d'info entre membres d'un même CRC ou entre CRC's"}, ]}, 
