...
{slot_reference: "name", value: [{value_type: "string", value_content: "documentation patrimoniale de biens immobiliers de l'état Belge sur le flux de Stipad vers Findomimmo"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Documentation patrimoniale de biens immobiliers de l'état Belge sur le flux de Stipad vers Findomimmo"}, ]}, 
