...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation saisie-arrêt simplifiée par application Saisies Cessions"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation saisie-arrêt simplifiée par application Saisies Cessions"}, ]}, 
