...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_575642_Class32"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "D&amp;A Statistieken op flow van Informatieplan naar Mississippi managed by IPI Informatieplan-Plan d'information_Prod"}, ]}, 
