...
{slot_reference: "name", value: [{value_type: "string", value_content: "recours administratifs  chez la réception d'un recours administratif , ajouter un nouveau dossier à la liste"}, ]}, 
