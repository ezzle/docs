...
{slot_reference: "name", value: [{value_type: "string", value_content: "régistre 480  régistration d'un nouveau dossier d'infraction de l'AG D&amp;A , ajouter des infractions en plus à un dossier existant , enregistrer des infractions sans numéro de dossier et modifier un dossier existant"}, ]}, 
