...
{slot_reference: "name", value: [{value_type: "string", value_content: "Sociétés de leasing"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application chez l'AG Douane et Accises qui garde la trace des sociétés de leasing."}, ]}, 
