...
{slot_reference: "name", value: [{value_type: "string", value_content: "TaxGapTVA (estimation du tax gap concernant la TVA)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le modèle analytique pour l'estimation du tax gap concernant la TVA."}, ]}, 
