...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_608025_Class12"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "vervolgingskosten deurwaarders per maand, per bedrag, per schuldenaar en totalen per kalenderjaar of per periode op flow van ICPC naar PCFURE managed by ICPC_PROD"}, ]}, 
