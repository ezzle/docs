...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_242815_Class28"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info inhoudingsplicht op Flow van DAD naar Minfin Crassus portlet managed by Digital Access to Debts (DAD)"}, ]}, 
