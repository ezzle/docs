...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  modifier les paramètres pour le calcul d'une date (gérer des livraisons)"}, ]}, 
