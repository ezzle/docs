...
{slot_reference: "name", value: [{value_type: "string", value_content: "des plans de Arcgis destiné pour les communes sur le flux de Cadgis vers Urbain"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Cadgis à Urbain. Une fois par an, les plans d'Arcgis pertinents pour la municipalité sont livrés à la municipalité via Urbain."}, ]}, 
