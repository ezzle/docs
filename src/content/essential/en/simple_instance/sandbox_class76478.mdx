...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclarations PLDA sélectionnées sur le flux de Seda vers Gi Consult"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclarations PLDA sélectionnées sur le flux de Seda vers Gi Consult"}, ]}, 
