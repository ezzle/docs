...
{slot_reference: "name", value: [{value_type: "string", value_content: "Dépenses AG D&amp;A (P8.1)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Dépenses AG D&amp;A (P8.1)"}, ]}, 
