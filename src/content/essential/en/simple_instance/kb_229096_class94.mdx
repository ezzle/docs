...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class95"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Schulden n.a.v. overtredingen gekoppeld aan nummerplaten op flow van Anpr naar Btw bestand managed by ANPR_Dev"}, ]}, 
