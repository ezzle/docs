...
{slot_reference: "name", value: [{value_type: "string", value_content: "Diagramme de responsabilité organisationnel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente l'organigramme fonctionnel de l'organisation"}, ]}, 
