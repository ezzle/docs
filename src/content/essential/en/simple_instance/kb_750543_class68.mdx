...
{slot_reference: "name", value: [{value_type: "string", value_content: "gestion ICT"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "gestion ICT"}, ]}, 
