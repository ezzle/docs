...
{slot_reference: "name", value: [{value_type: "string", value_content: "Evaluatie op flow van Crescendo naar Autp (batch)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Evaluatie op flow van Crescendo naar Autp (batch)"}, ]}, 
