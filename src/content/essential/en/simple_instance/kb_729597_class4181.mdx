...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting disputes  ajouter des données supplémentaires à une dette suite à un contentieux administratif ou juridique"}, ]}, 
