...
{slot_reference: "name", value: [{value_type: "string", value_content: "régistre 480  enregistrer des infractions AG D&amp;A, constatées suite aux différentes missions de contrôle"}, ]}, 
