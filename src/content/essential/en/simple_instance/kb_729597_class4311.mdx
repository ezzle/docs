...
{slot_reference: "name", value: [{value_type: "string", value_content: "First   Collection-Solidarity  rentrer des dettes solidaires quand une dette doit être payé par plusieures personnes"}, ]}, 
