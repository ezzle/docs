...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données physique: catalogue tabulaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit, sous forme de table; une liste des données objets physique significatives pour l'organisation"}, ]}, 
