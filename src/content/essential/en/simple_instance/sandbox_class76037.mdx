...
{slot_reference: "name", value: [{value_type: "string", value_content: "données garanties locatives sur le flux de e-DEPO (portlet MyMinFin) vers l'application SP 10B Caisses"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des garanties locatives sur le flux de e-DEPO (MyMinFin portlet) vers l'application SP 10B Caisses"}, ]}, 
