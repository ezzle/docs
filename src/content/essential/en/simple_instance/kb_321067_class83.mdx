...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_321067_Class84"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_321067_Class85"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie op flow van WSM (wang screen mgr.) naar ICPC managed by WSM_PROD"}, ]}, 
