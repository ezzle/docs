...
{slot_reference: "name", value: [{value_type: "string", value_content: "Surveyorplan: récupérer les plans géomètres du stock de données Stipad.cm du Filenet"}, ]}, 
