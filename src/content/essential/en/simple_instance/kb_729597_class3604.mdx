...
{slot_reference: "name", value: [{value_type: "string", value_content: "MBM  régistration des (nouveaux) rapports de contrôle des fonctionnaires qui font partie des équippes mobiles du Département Opérations"}, ]}, 
