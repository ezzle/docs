...
{slot_reference: "name", value: [{value_type: "string", value_content: "db First groupe PE's"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db First groupe PE's"}, ]}, 
