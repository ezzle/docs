...
{slot_reference: "name", value: [{value_type: "string", value_content: "bien immobilier + parcelle (données) sur le flux de Consultimmo vers POW"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Consultimmo vers POW: plus que de simples données immobilières: immobilier + données de parcelle  Consultimmo / POW"}, ]}, 
{slot_reference: "system_content_lifecycle_status", value: [{value_type: "simple_instance", value_content: "KB_229567_Class67"}, ]}, 
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class78767"}, ]}, 
