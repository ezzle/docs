...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Vlabel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application auprès de l'administration Fiscale Flamande qui interagit avec DER. Il s'agit d'une application externe au SPF Finances."}, ]}, 
