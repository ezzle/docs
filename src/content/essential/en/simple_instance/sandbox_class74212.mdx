...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 275C: déduction pour capital à risque."}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Calcul de la déduction fiscale pour capital à risque."}, ]}, 
