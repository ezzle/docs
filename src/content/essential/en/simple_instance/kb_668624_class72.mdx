...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_668624_Class73"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Ingediende aangiften VENB, RPB, BNI-Ven op flow van Vensoc naar Biztax back office managed by Vensoc SP 08_PROD"}, ]}, 
