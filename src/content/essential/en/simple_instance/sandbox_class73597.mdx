...
{slot_reference: "name", value: [{value_type: "string", value_content: "Fichier Excel pour la compensation de dettes pour le bilan fiscal sur le flux manuel de PLDA vers ICPC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fichier Excel pour la compensation pour le bilan fiscal sur le flux manuel de PLDA à ICPC via le fichier Excel d'échange à Guido Thieleman."}, ]}, 
