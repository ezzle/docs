...
{slot_reference: "name", value: [{value_type: "string", value_content: "service UUID"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Bibliothèque du générateur d'UUID"}, ]}, 
