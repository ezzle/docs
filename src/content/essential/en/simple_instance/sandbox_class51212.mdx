...
{slot_reference: "name", value: [{value_type: "string", value_content: "DOUR (screen scraping et impression de formulaires)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la collecte d'informations sur des dossiers par screen scraping et impression de formulaires."}, ]}, 
