...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_498426_Class17"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens huurwaarborgen op flow van e-DEPO (de MyMinFin portlet) naar de applicatie SP 10B Caisses managed by E-depo"}, ]}, 
