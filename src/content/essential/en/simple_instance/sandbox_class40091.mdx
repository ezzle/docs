...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données  Objets  Synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétique des relations ou attributs principaux de chaque donnée objet"}, ]}, 
