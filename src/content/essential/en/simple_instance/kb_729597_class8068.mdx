...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application Development Environment Services"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Le groupe des services 'Application Development Environment' offre les fonctionnalités necessaires au développement d’applications IT à partir des exigences exprimées dans le cadre de la discipline FUP1.1 'D2  Requirement'."}, ]}, 
