...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_008868_Class54"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "authenticatiegegevens op flow van Properties on web naar IAM client managed by PropertiesOnWeb_Prod"}, ]}, 
