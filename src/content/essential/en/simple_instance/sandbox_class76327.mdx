...
{slot_reference: "name", value: [{value_type: "string", value_content: "données impôts des personnes sur le flux manuel de Taxi vers E Forms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données impôts des personnes sur le flux manuel de Taxi vers E Forms"}, ]}, 
