...
{slot_reference: "name", value: [{value_type: "string", value_content: "dettes sociales et fiscales sur le flux de E notaire2 vers E-fonctionnaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dettes sociales et fiscales sur le flux de E notaire2 vers E-fonctionnaire"}, ]}, 
