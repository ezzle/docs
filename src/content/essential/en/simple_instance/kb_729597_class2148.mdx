...
{slot_reference: "name", value: [{value_type: "string", value_content: "Belcotax  rédaction de la fiche recapitulative des fiches reçues par personne"}, ]}, 
