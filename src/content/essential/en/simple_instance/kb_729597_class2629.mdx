...
{slot_reference: "name", value: [{value_type: "string", value_content: "Feedback  consulter les feedbacks introduits par les fonctionnaires (feedback d'un MRN spécifique) (movement ref. number)"}, ]}, 
