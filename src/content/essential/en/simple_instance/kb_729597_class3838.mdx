...
{slot_reference: "name", value: [{value_type: "string", value_content: "RAM  Risk et audit management  cartographie des risques: pondération des risques résiduels"}, ]}, 
