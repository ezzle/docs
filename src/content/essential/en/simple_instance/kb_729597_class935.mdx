...
{slot_reference: "name", value: [{value_type: "string", value_content: "GRA  imprimer des noms et adresses des bureaux de recettes / services sur less lettres"}, ]}, 
