...
{slot_reference: "name", value: [{value_type: "string", value_content: "questions concernant messages électroniques quatrième voie (avis' 1,2,3 reçu de notaires) sur le flux de E notaire vers Stiron inv"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "questions concernant messages électroniques quatrième voie (avis' 1,2,3 reçu des notaires) sur le flux de E notaire vers Stiron inv"}, ]}, 
