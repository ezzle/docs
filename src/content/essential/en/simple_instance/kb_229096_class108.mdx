...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class109"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Geselecteerde PLDA aangiftes op flow van Seda naar CAP (voor Controle a posteriori van deze geselecteerde PLDA aangiftes) managed by SEDA"}, ]}, 
