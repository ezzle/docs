...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Formations Certifiées"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion des Formations certifiées pour les gestionnaires de dossier (consultation des résultats des tests effectués) OS: GCOS windows"}, ]}, 
