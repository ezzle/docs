...
{slot_reference: "name", value: [{value_type: "string", value_content: "Evaluation sur le flux de Crescendo vers Autp (lot)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Evaluation sur le flux de Crescendo vers Autp (batch)"}, ]}, 
