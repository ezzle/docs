...
{slot_reference: "name", value: [{value_type: "string", value_content: "MBM  formulaires pour la régistration du déroulement de certaines tâches de contrôle et des constatations spécifiques"}, ]}, 
