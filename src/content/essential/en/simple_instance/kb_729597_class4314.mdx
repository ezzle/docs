...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  Genereren ontvangstbevestiging Financiële Instellingen (reconciliëren)"}, ]}, 
