...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  module générique  actions de recouvrement  UC  31-46 attestation de cession de commerce"}, ]}, 
