...
{slot_reference: "name", value: [{value_type: "string", value_content: "First-recouvrement_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Module recouvrement de FIRST"}, ]}, 
