...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 604A: demande pour identification pour TVA (604A)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demande pour identification pour fins TVA au début d'une activité (604A). Important: ce formulaire doit être imprimé et rempli personnellement"}, ]}, 
