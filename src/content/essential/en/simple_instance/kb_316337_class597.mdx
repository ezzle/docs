...
{slot_reference: "name", value: [{value_type: "string", value_content: "Améliorer la qualité du système de mesure et poursuivre la professionnalisation du cycle de gestion"}, ]}, 
