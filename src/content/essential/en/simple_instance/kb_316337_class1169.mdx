...
{slot_reference: "name", value: [{value_type: "string", value_content: "service FINADA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion du fichier des infractions en matière de douanes et accises"}, ]}, 
