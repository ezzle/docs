...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  processus  catalogue par domaine métier"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation, par domaine métier, de chaque processus."}, ]}, 
