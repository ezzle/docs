...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire attestation tax shelter petite société en démarrage"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "attestation tax shelter pour le démarrage d'une petite entreprise"}, ]}, 
