...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 325 TI: relevé  feuille de titre"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Tableau récapitulatif de certaines données des déclarations 325 établies par le même débiteur de revenus soumis au précompte profesionnel"}, ]}, 
