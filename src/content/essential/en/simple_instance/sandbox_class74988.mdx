...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Confirm_paiement_NL"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Détails du paiement à effectuer (annexe à la facture)"}, ]}, 
