...
{slot_reference: "description", value: [{value_type: "string", value_content: "db Finelts  base de données taxe sur épargne à long terme (SP 03) 
...
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class78298"}, ]}, 
