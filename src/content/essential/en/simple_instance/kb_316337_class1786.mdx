...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Microfiches"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Microfiches. Remplacement des microfiches du cadastre
Contient des données cadastrales mais pas de données personnelles (AG Padoc MEOW)"}, ]}, 
