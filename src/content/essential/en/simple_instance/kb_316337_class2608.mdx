...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service TDOC (MF) (Système d'archivage et de récupération des déclarations chez l'AG D&amp;A)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Système d'archivage et de récupération des déclarations chez l'AG D&amp;A."}, ]}, 
