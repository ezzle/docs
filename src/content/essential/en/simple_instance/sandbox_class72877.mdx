...
{slot_reference: "name", value: [{value_type: "string", value_content: "Db SEED (maintenant : partie de EMCS / dans le futur : partie du db AEO)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Bientôt db Seed fera partie de db Aeo (exportation via un schéma dans db Aeo). Les semences resteront un service distinct."}, ]}, 
