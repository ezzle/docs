...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations de la dette sur service web: flux de First vers DAD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur: informations de la dette sur webservice: flux de First vers DAD"}, ]}, 
