...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module de gestion de dossiers  consultation de la liste 0: liste mensuelle des recettes PP 274w venant de BV Land"}, ]}, 
