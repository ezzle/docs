...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire lettre modèle crédit dormant"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire plus d'explication sur le service"}, ]}, 
