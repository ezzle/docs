...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Consultatie tariefcodes door externe firma's."}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "db tarprd (oracle databank) managed by TARWEB_PROD"}, ]}, 
