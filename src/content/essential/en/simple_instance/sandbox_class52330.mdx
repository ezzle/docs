...
{slot_reference: "name", value: [{value_type: "string", value_content: "PO_PORTAIL_PROD (n'existe plus)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PO_PORTAL n'existe plus, mais était, comme son nom l'indique, un portail qui rassemblait les différentes applications PenO."}, ]}, 
