...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA Dashboard  affichage des statistiques de selection, contrôle, et résultats de contrôle"}, ]}, 
