...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service belfirst"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application externe offrant des informations commerciales contre paiement ; par exemple, utilisée par AA D&amp;A."}, ]}, 
