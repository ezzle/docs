...
{slot_reference: "name", value: [{value_type: "string", value_content: "accords de collaboration et db PRO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "accords de collaboration dans db PRO"}, ]}, 
