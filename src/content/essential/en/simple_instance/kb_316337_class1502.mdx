...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Eurekad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Base de données des instructions de AG Padoc  MEOW mesures et évaluations (cadastre)."}, ]}, 
