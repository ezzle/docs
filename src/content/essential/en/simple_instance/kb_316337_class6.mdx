...
{slot_reference: "name", value: [{value_type: "string", value_content: "Optimiser les contrôles en élaborant une approche orientée « groupes-cibles »"}, ]}, 
