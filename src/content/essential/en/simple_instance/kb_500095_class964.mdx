...
{slot_reference: "name", value: [{value_type: "string", value_content: "liste papier état 204 sur le flux de First vers Penal Fines"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "état 204 (liste papier) sur le flux de First vers Penal Fines"}, ]}, 
