...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Calc-energy-plus"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les dépenses faites en vue d'économiser l'énergie pour plus d'une maison (voir Fedict)"}, ]}, 
