...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "CALC_IPP Database (RDC) managed by Calcul IPP  AanslagJaar 2016_PROD"}, ]}, 
