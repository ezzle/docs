...
{slot_reference: "name", value: [{value_type: "string", value_content: "Réaliser des actions ciblées pour des groupes cibles préalablement identifiés afin de maintenir l’effet dissuasif"}, ]}, 
