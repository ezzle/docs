...
{slot_reference: "name", value: [{value_type: "string", value_content: "données parcellaires sur le flux de Consultimmo vers institutionels (client chez Ovam / Eandis) (consultation Consultimmo par partie externe) (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données parcellaires sur le flux de Consultimmo vers les institutionels (client chez Ovam / Eandis) (consultation Consultimmo par parti externe) (flux vers application externe non SPF Finances)"}, ]}, 
