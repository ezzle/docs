...
{slot_reference: "name", value: [{value_type: "string", value_content: "Numéro registre national (NRN)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "numéro d'identification unique d'une personne physique attribuer par le Registre National"}, ]}, 
