...
{slot_reference: "name", value: [{value_type: "string", value_content: "Intégrer les informations analytiques et les introduire dans Activity Based Costing (ABC)"}, ]}, 
