...
{slot_reference: "name", value: [{value_type: "string", value_content: "PC Gestion des accises_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de l'AG Douane et Accises sur PC (local), qui n'existe plus."}, ]}, 
