...
{slot_reference: "name", value: [{value_type: "string", value_content: "données comptes particuliers sur le flux de Stiron BR vers db Stir TVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des comptes particuliers sur le flux de Stiron BR vers db Stir TVA"}, ]}, 
