...
{slot_reference: "name", value: [{value_type: "string", value_content: "Diesel Camions_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour envoyer les paiements concernant diesel camions à effectuer à terme à la Banque de la poste."}, ]}, 
