...
{slot_reference: "name", value: [{value_type: "string", value_content: "données consolidées de MASP-PLDA, SEDA et FEEDBACK sur le flux de monitoringtool vers Irma"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données consolidées de MASP-PLDA, SEDA et FEEDBACK sur le flux de monitoringtool vers irma"}, ]}, 
