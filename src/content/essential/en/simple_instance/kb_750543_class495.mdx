...
{slot_reference: "name", value: [{value_type: "string", value_content: "Déterminer l'approche de prestation de services (p33)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déterminer l'approche de prestation de services (p33)"}, ]}, 
