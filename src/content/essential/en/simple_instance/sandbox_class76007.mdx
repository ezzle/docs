...
{slot_reference: "name", value: [{value_type: "string", value_content: "données impôts directs sur des entreprises multinationales des pays différents (aussi bien européen que non-Européen) sur le flux de Stirint Beps vers Stirint ETR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données impôts directs sur des entreprises multinationales des pays différents (aussi bien Europees que non-Européen) sur le flux de Stirint Beps vers Stirint ETR"}, ]}, 
