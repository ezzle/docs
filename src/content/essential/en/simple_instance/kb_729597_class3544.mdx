...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs (GDD)  module retenues  consultation des retenues listing Vatrifund pour remboursement de TVA dans un dossier de l'étranger pour vérifier s'ils ont encore des dettes ouvertes par rapport au SPF Finances"}, ]}, 
