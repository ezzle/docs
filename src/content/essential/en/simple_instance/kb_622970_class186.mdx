...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_622970_Class187"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Landmetergegevens op flow van My MinfinPRO naar Stipad managed by MyMinFin Pro (Landmeters/ Géométres) portlet_prod"}, ]}, 
