...
{slot_reference: "name", value: [{value_type: "string", value_content: "First recovery  Cost management  enregistrer et gérer des coûts liés aux actions de recouvrement"}, ]}, 
