...
{slot_reference: "name", value: [{value_type: "string", value_content: "Documents sur le flux de Filenet ECM webservices (sur JSR170) vers Myscan"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Documents sur le flux de Filenet ECM Webservices (sur JSR170) à Myscan"}, ]}, 
