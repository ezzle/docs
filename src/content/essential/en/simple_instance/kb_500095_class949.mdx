...
{slot_reference: "name", value: [{value_type: "string", value_content: "dossiers papiers dont les données sont rentrées dans Regondes2  dossiers régions"}, ]}, 
