...
{slot_reference: "name", value: [{value_type: "string", value_content: "Duplicative capability is expensive and proliferates conflicting information."}, ]}, 
