...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire papier rempli par institution de crédit pour SC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire papier rempli par institution de crédit pour Saisie Cession"}, ]}, 
