...
{slot_reference: "name", value: [{value_type: "string", value_content: "document pdf plan de délimitation dans le Filenet object store Stipad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Document pdf du plan de délimitation dans le Filenet object store Stipad: vient du db plans de délimitation qui est une partie du db Patris qui est la db de Stipad."}, ]}, 
