...
{slot_reference: "name", value: [{value_type: "string", value_content: "STATIS  publicatie in vrije toegang van beslissingen, werknota's en verscheidene bestanden van de archieven"}, ]}, 
