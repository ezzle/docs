...
{slot_reference: "name", value: [{value_type: "string", value_content: "paiements traités du précompte professionel sur le flux de précompte professionel to belconet archive"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "paiements traités précompte professionel de précompte professionel vers belconet archiv"}, ]}, 
