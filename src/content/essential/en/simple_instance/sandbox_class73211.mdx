...
{slot_reference: "name", value: [{value_type: "string", value_content: "Procédures de l'AG de la Douane sur le flux de Dave vers le site Web Cdib"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux vers le site général service gestion de données de l'AG D&amp;A :  Opérateurs vers Procédures douanières  Opérateurs vers Fichier TVA vers Rapport complet"}, ]}, 
