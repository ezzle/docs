...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire lettre modèle légalisation signature"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire si la signature ne correspond pas à une carte d'identité"}, ]}, 
