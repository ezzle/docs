...
{slot_reference: "name", value: [{value_type: "string", value_content: "Capacités métiers : synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Synthèse des détails et des principales relations de chaque capacité métier"}, ]}, 
