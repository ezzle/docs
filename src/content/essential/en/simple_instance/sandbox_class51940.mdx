...
{slot_reference: "name", value: [{value_type: "string", value_content: "Douane Mobile (gestion des missions des Teams mobiles)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "MODA = Mobiel toezicht Douane, gestion des missions des Teams mobiles du département Operations."}, ]}, 
