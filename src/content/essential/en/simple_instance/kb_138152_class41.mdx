...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_603289_Class10"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "identificatiegegevens rechtspersonen op flow van KBO naar Esucc managed by CdAI KBO-BCE_PROD"}, ]}, 
