...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations statistiques sur le flux de SAS vers EANDIS (application externe)"}, ]}, 
