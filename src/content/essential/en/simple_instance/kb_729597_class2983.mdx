...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module debt Relationship Management  pour consulter l'info de la dette, qui peut être utile si on téléphone le contribuable"}, ]}, 
