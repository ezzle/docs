...
{slot_reference: "name", value: [{value_type: "string", value_content: "service VP-DOSSIER"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion des dossiers pour les services du président, windows oracle."}, ]}, 
