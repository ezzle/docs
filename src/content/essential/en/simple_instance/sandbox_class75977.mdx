...
{slot_reference: "name", value: [{value_type: "string", value_content: "données déclaration TVA sur le flux d'Intervat vers Websigna"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données de déclaration TVA sur le flux de Intervat vers websigna"}, ]}, 
