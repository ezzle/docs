...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module de gestion de dossiers  liste des recettes dans GDD : liste pour comparer les recettes PP avec les déclarations PP concernant les dossiers Précompte Professionel à traiter avant l'envoi du rappel"}, ]}, 
