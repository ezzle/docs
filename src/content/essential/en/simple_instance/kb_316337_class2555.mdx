...
{slot_reference: "name", value: [{value_type: "string", value_content: "service BicUpdateBatch"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "programme Batch du bic update"}, ]}, 
