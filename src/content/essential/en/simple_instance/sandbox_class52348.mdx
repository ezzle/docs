...
{slot_reference: "name", value: [{value_type: "string", value_content: "Postdoc_PROD (validation des factures)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Postdoc est une application pour la validation des factures."}, ]}, 
