...
{slot_reference: "name", value: [{value_type: "string", value_content: "INAMIAttribute_PROD (application avec des données de l'INAMI)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application avec des données de l'INAMI utilisée dans l'AG Fiscalité."}, ]}, 
