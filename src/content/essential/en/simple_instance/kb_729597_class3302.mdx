...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPR Follow-up de l'échange d'information concernant les fautes/problèmes concernant le plan (par inspecteur)"}, ]}, 
