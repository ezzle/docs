...
{slot_reference: "name", value: [{value_type: "string", value_content: "E-signature (signature électronique de documents pdf)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "webservice pour la signature électronique de documents pdf."}, ]}, 
