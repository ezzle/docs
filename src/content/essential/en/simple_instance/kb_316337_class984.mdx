...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Digital Access to Debt"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Développer une interface métier dette entre le bilan fiscal et les autres applications (ex : Crassus obligation de retenue / Telemarc)."}, ]}, 
