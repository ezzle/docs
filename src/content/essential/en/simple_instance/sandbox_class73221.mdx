...
{slot_reference: "name", value: [{value_type: "string", value_content: "dpisi Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dpisi Relational Database on MariaDB/MySQL Environment"}, ]}, 
