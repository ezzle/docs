...
{slot_reference: "name", value: [{value_type: "string", value_content: "AAPD_PRI_Prod (webservice)::chercher les droits réels de propriété via l'écran"}, ]}, 
