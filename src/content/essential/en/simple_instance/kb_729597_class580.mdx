...
{slot_reference: "name", value: [{value_type: "string", value_content: "MOSS  Vatreturn: een aangiftemodule, die in staat stelt om, eenmaal geregistreerd, BTW-aangiften te doen in het régime waarvan sprake"}, ]}, 
