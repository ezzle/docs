...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue alphabétique des capacités métiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des capacités d'affaire significatives pour l'organisation."}, ]}, 
