...
{slot_reference: "name", value: [{value_type: "string", value_content: "TC Automatisée  VBDIS1 introduction des clés de recherches (plaque d'immatriculation, numéro national, numéro d'invitation)"}, ]}, 
