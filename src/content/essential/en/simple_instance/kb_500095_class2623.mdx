...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros de référence des paquets envoyés internationale sur le flux de E Commerce vers SEDA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur: numéros de référence des paquets envoyés internationale sur le flux de E Commerce vers SEDA"}, ]}, 
