...
{slot_reference: "name", value: [{value_type: "string", value_content: "documents sur le flux de Filenet vers Doctran"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "documents sur le flux de Filenet vers Doctran"}, ]}, 
