...
{slot_reference: "name", value: [{value_type: "string", value_content: "MOSS  registratie: een registratiemodule, waarmee de belastingbetaler zich in het systeem kan laten registreren."}, ]}, 
