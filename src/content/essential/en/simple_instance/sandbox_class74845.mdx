...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande pour enregistrement comme exporteur enregistré (REX auto-certification)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application dans le cadre du système d'autocertification de l'origine préférentielle, REX"}, ]}, 
