...
{slot_reference: "name", value: [{value_type: "string", value_content: "STIPAD_PROD::livraison d'un certificat de patrimoine (titre trentenaire)"}, ]}, 
