...
{slot_reference: "name", value: [{value_type: "string", value_content: "P804 Certificats d'hérédité"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Certificats d'hérédité (P804)"}, ]}, 
