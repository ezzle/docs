...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_074792_Class72"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "namen en adressen van ontvangstkantoren op flow van GRA naar Bedrijfsvoorheffing managed by GRA_PROD"}, ]}, 
