...
{slot_reference: "name", value: [{value_type: "string", value_content: "Renseignements fiscaux sur les impôts directs des personnes morales sur le flux de Stirint Etr vers Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Informations fiscales Impôts directs personnes morales sur le flux de Stirint Etr à Stirint Bbi Stirint publie des signaux dès que quelque chose arrive de l'étranger."}, ]}, 
