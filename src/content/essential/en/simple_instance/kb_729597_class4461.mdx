...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  automatiquement calculer la date de livraison (fichier reçu des institutions financières)"}, ]}, 
