...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_761476_Class30"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens i.v.m. onroerende goederen in het buitenland op flow van Stirint naar Movables (human; to be: automatisch alleen voor onroerende goederen in het buitenland) managed by STIRint_Prod"}, ]}, 
