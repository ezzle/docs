...
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application permet de communiquer via xml vers Stirint beps cbc."}, ]}, 
