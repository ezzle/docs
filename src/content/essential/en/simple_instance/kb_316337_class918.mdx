...
{slot_reference: "name", value: [{value_type: "string", value_content: "service cifi"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de gestion et de publication de listes de personnes et d'embargos dans le cadre de la lutte contre le terrorisme."}, ]}, 
