...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_455519_Class35"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "XML documenten voor databank Vignetten 705 (voor vergunningshouders) managed by Vignettes 705_Prod"}, ]}, 
