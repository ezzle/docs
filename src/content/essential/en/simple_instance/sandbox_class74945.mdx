...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire attestation de regularisation fiscale (4ième regularisation fiscale)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire attestation de regularisation fiscale (4ième regularisation fiscale)"}, ]}, 
