...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers Domaines  Analyse des processus"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Vue analytique des processus métiers réalisés pour fournir les capacités métier d'un domaine donné."}, ]}, 
