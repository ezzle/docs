...
{slot_reference: "name", value: [{value_type: "string", value_content: "données signalétiques sur le flux de Sitran vers EMCS seed"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Sitran vers EMCS seed"}, ]}, 
