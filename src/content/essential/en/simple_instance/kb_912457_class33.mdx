...
{slot_reference: "name", value: [{value_type: "string", value_content: "Bureau d'enrégistrement"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Bureau d'enrégistrement"}, ]}, 
