...
{slot_reference: "name", value: [{value_type: "string", value_content: "DP-01 Data is an asset"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Information has value and is managed accordingly"}, ]}, 
