...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_472799_Class22"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Documenten huurcontracten op flow van Myrent naar Doctran managed by DOCTRAN consultation_PROD"}, ]}, 
