...
{slot_reference: "name", value: [{value_type: "string", value_content: "Feedback  raadplegen feedbacks ingebracht door de ambtenaren (feedbacks van een specifieke MRN) (movement ref. number)"}, ]}, 
