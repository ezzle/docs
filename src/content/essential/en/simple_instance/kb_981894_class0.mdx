...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_314045_Class56"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Kadastrale inkomens en oppervlakten van percelen, nodig voor het opmaken van de begroting van gemeentes op flow van Urbain naar Cadgis managed by URBAIN2"}, ]}, 
