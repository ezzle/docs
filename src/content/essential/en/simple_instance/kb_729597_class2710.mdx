...
{slot_reference: "name", value: [{value_type: "string", value_content: "EMCS new  statistiques par rapport aux mouvements et titulaires de licences concernant la circulation des biens soumis aux accises sous le régime de suspension des droits d'accise"}, ]}, 
