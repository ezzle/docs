...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class72"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Fiscale inlichtingen Directe Belastingen rechtspersonen op flow van Stirint Etr naar Stirint Bbi managed by STIRint  ETR_PROD"}, ]}, 
