...
{slot_reference: "name", value: [{value_type: "string", value_content: "P100 Gestion des projets et des programmes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Capacité à gérer des projets et des programmes selon la méthodologie PMFIN"}, ]}, 
