...
{slot_reference: "name", value: [{value_type: "string", value_content: "Fichier plat Xml avec des saisies de dettes de TVA sur le flux de Stiron Inv vers CBB"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flat file Xml avec saisies dettes TVA sur le flux de Stiron inv vers CBB"}, ]}, 
