...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service HERBRF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Rappels de non-déclaration de VENB, RPB, GNI-Ven"}, ]}, 
