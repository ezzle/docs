...
{slot_reference: "name", value: [{value_type: "string", value_content: "GRA  consulter  et modifier directement les adresses des bureaux de recettes et des services de perception dans la base de données GRA: question TP sur terminal (“RA BIJ”)."}, ]}, 
