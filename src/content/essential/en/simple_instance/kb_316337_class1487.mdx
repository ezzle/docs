...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Crescendo"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Exportation des données vers Crescendo (batch) Application électronique pour vos cercles de développement"}, ]}, 
