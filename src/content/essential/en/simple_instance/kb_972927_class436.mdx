...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_972927_Class434"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Onroerende voorheffing  vermindering / Réduction de Pr I pour les locataires (WAL) managed by Onroerende Voorheffing Précompte immobilier_PROD"}, ]}, 
