...
{slot_reference: "description", value: [{value_type: "string", value_content: "Un hyperviseur ou moniteur de machine virtuelle est une configuration informatique qui sert à exécuter plusieurs systèmes d'exploitation sur un ordinateur hôte en même temps. Le terme hyperviseur étend le terme précédent superviseur, qui était généralement appliqué aux noyaux du système d'exploitation. Un hyperviseur contrôle une forme de virtualisation."}, ]}, 
