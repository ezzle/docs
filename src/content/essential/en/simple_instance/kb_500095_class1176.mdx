...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclarations PLDA sur le flux de SEDA vers MODA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclarations PLDA sur le flux de SEDA vers MODA"}, ]}, 
