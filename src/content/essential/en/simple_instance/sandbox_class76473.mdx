...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclarations PLDA sélectionnées sur le flux de Seda vers CAP (pour contrôle à posteriori de ces déclarations PLDA sélectionnées)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclarations PLDA sélectionnées sur le flux de Seda vers CAP (pour contrôle a posteriori de ces déclarations PLDA sélectionnées)"}, ]}, 
