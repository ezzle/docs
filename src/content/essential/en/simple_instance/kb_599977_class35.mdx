...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_599977_Class36"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Statistieken i.v.m. controles en opsporingen door D&amp;A op manuele flow van Camada naar IPI Dashboard managed by Camada_PROD"}, ]}, 
