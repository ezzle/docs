...
{slot_reference: "name", value: [{value_type: "string", value_content: "Recueillir les informations nécessaires relatives à l'évolution des attentes des utilisateurs et aux éventuels dysfonctionnements pouvant survenir dans les services, afin de réagir rapidement par le biais d'actions correctrices"}, ]}, 
