...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_868794_Class21"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Openstaande schulden op flow van Stiron L2-CC (rekening courant BTW) naar Debiteurenbeheer voor maandelijkse verwerking, maandelijkse flow managed by STIRON-Lot2-CC_PROD"}, ]}, 
