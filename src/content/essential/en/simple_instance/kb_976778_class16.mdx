...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_976778_Class17"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "(na te gaan) statistieken Ac4 aangiftes op flow van ac4 g&amp;i naar informatieplan ? managed by AC4 (php  dienst gegevensbeheer AA D&amp;A)"}, ]}, 
