...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 275B: exonération des plus-values sur navires"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Exonération des plus-values sur les navires de mer."}, ]}, 
