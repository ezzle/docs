...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mijn kantoor  recouvrement06 : WF contrôle  suivi des tâches de contrôle des services de contrôle sur les services opérationnels de l'AGPR"}, ]}, 
