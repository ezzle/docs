...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class225"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_425693_Class80"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "persoongegevens op flow van Sitran naar CRT CRH (stroom naar externe niet Fod Fin applicatie) managed by SITRAN"}, ]}, 
