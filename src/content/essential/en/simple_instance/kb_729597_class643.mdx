...
{slot_reference: "name", value: [{value_type: "string", value_content: "Manu  enrôlement manuel uniquement des amendes administratives et de l'impôt sur le revenu des personnes physiques (Impôts directs  Recouvrement  ICPC)."}, ]}, 
