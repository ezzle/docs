...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs_Prod  module cellules des procédures collectifs  pour des procédures collectifs comme règlement collectif de dettes"}, ]}, 
