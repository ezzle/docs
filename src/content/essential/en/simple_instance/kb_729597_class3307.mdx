...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPR gérer les dossiers d'identification avec tous les documents connexes"}, ]}, 
