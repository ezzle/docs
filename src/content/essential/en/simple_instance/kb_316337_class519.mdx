...
{slot_reference: "name", value: [{value_type: "string", value_content: "Déployer des informations pertinentes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déployer les informations pertinentes pour nos parties prenantes."}, ]}, 
