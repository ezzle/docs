...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  gestion de dettes  UC 07-06-03 Modifier la date valeur d'un crédit"}, ]}, 
