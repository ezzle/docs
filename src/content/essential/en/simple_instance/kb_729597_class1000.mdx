...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  generieke module  schrapping invordering  UC 31-12 beslissing van toelating tot opschorting"}, ]}, 
