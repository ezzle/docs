...
{slot_reference: "name", value: [{value_type: "string", value_content: "données dettes non fiscales 180B-NFI sur le flux de 180B NFI vers ICPC pour bilan fiscal (chargement hebdomadaire)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Des données des dettes non fiscales 180B-NFI sur le flux de 180B NFI vers ICPC pour bilan fiscal (chargement hebdomadaire)"}, ]}, 
