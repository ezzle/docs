...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant des points de mesure (codes IPI) sur le flux de Plan d'information vers IPI Dashboard"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant les points de mesure (codes IPI) sur le flux de Plan d'information vers IPI Dashboard"}, ]}, 
