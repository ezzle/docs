...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI dashboard  afficher les détails d'un KPI sur la base, entre autres, des codes IPI sur lesquels un KPI a été construit / calculé"}, ]}, 
