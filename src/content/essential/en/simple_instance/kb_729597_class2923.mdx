...
{slot_reference: "name", value: [{value_type: "string", value_content: "Stiron lot2 INV  modifier l'ordre de recouvrement (compétence de l'AG Fisc, mais exécuté dans Stiron INV)"}, ]}, 
