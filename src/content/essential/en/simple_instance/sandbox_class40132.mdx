...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue des objectifs métiers   alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des objectifs d'affaire."}, ]}, 
