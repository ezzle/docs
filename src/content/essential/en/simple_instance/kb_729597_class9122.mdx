...
{slot_reference: "name", value: [{value_type: "string", value_content: "Serveurs Wintel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Description de l’environnement Serveurs Windows du SPF Finances."}, ]}, 
