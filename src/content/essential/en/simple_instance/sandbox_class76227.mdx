...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant des dettes sur le flux manuel de Gestion des Debiteurs vers E-Forms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant des dettes sur le flux manuel de Gestion Des Débiteurs vers E-Forms"}, ]}, 
