...
{slot_reference: "name", value: [{value_type: "string", value_content: "DP-05 Common Terminology and Data Definitions"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Data is defined coherently throughout the organization, and definitions are comprehensible and accessible by all users."}, ]}, 
