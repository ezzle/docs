...
{slot_reference: "name", value: [{value_type: "string", value_content: "service VADBART"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Composante de l'application Versements Anticipés_Prod (base de données Bull IDS II)"}, ]}, 
