...
{slot_reference: "name", value: [{value_type: "string", value_content: "données consolidées de MASP-PLDA, seda et FEEDBACK sur le flux de monitoringtool vers plan d'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données consolidées de MASP-PLDA, seda et FEEDBACK sur le flux de monitoringtool vers plan d'information"}, ]}, 
