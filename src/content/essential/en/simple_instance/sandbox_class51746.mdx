...
{slot_reference: "name", value: [{value_type: "string", value_content: "Intra-fisc (intranet AG Fisc)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application est l'intranet de l'AG Fiscalité"}, ]}, 
