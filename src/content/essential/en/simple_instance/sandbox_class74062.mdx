...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 151.1: relevé mensuel concernant le taxe annuel sur les opérations d'assurance (mesure final)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Taxe annuelle sur les opérations d'assurance."}, ]}, 
