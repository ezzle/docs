...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA dashboard  possibilité de trier les tableaux et d'y naviguer quand la taille est grande de manière rapide et transparente (vis à vis de la vitesse de connexion)"}, ]}, 
