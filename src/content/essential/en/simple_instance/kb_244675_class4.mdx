...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "rekeningnummers op flow van Calcul Ipp naar taxi (weggeschreven door Calculipp webservice in db TAXI) managed by Calcul IPP  Aanslagjaar 2022_PROD"}, ]}, 
