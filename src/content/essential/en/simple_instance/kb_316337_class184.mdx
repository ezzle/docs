...
{slot_reference: "name", value: [{value_type: "string", value_content: "Développer une signalisation unique pour les bâtiments du SPF Finances"}, ]}, 
