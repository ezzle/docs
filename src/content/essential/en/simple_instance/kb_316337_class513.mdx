...
{slot_reference: "name", value: [{value_type: "string", value_content: "Permettre la consultation d'un état de la situation de la cession tant par le contribuable que par les banques"}, ]}, 
