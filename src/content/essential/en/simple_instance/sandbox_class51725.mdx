...
{slot_reference: "name", value: [{value_type: "string", value_content: "Ingenico (paiements)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour les paiements par carte de debit."}, ]}, 
