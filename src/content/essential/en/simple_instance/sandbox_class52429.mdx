...
{slot_reference: "name", value: [{value_type: "string", value_content: "Régistre Trésorie (outil de gestion de projet)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Outil de gestion de projet utilisé à l'AG Trésorie (http://intrabda/appRegister/)"}, ]}, 
