...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool handhaving  mesurer l'effectivité des sélections automatiques par Dataflux à l'aide des résultats fournis des contrôles exécutés dans les application Feedback"}, ]}, 
