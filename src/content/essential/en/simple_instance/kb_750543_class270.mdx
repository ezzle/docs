...
{slot_reference: "name", value: [{value_type: "string", value_content: "Management de connaissances (p78)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Management de connaissances (p78)"}, ]}, 
