...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_972633_Class14"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "validatie AEO vergunning in Banaeos
Manuele flow tss AEO en Banaeos."}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "AEO vergunning op manuele Flow van AEO naar Banaeos managed by AEO_PROD (Belgische Douane)  MASP vergunningen"}, ]}, 
