...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_861561_Class3"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "In SAD ECS staat dat MODA diensten realiseert waarvan ECS en ICS zullen afhangen."}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Resultaat controle ECS aangiftes op flow van MODA naar ECS managed by MODA 2_PROD"}, ]}, 
