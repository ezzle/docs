...
{slot_reference: "name", value: [{value_type: "string", value_content: "données Risk Information Forms (CRMS) sur le flux de Rif vers Régistre 480"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données de Risk Information Forms (CRMS) sur le flux de Rif vers Régistre 480"}, ]}, 
