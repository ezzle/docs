...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion et la configuration des groupes VPN (IAM Security)."}, ]}, 
