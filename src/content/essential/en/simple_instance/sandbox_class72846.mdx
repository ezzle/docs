...
{slot_reference: "name", value: [{value_type: "string", value_content: "db PMEURO  fichier PM276ID"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db RVEURO  fichier RV276ID RV276ID  Ici sont enregistrées les données personnelles des bénéficiaires étrangers telles que le nom, l'adresse, le pays, le numéro de compte financier."}, ]}, 
