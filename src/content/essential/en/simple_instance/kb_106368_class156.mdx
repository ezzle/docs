...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class157"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info omtrent betaalde, oninbare, gerectificeerde en beslagen verschuldigde bedragen n.a.v. overtredingen op flow van Tax fraud reporting naar IPI informatieplan managed by TAX FRAUD REPORTING_Prod"}, ]}, 
