...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class116"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens omtrent inkomsten gegenereerd door een persoon in een land waar hij geen inwoner is, op flow van autodt naar stirint crs (via webservice stirint) managed by StirintAutoDT_Prod"}, ]}, 
