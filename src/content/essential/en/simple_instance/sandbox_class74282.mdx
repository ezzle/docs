...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 276 Div: Réduction conventionnelle  dividendes de source belges"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Demande de réduction du précompte mobilier sur les dividendes d'origine Belge en application de la convention préventive de double imposition entre la Belgique et …"}, ]}, 
