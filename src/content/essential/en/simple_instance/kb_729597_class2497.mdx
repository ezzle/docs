...
{slot_reference: "name", value: [{value_type: "string", value_content: "vignettes 705  3  envoi périodique au SPF Mobilité des données concernant les vignettes 705, pour soutenire la possibilité pour inscrire un véhicule via WebDIV"}, ]}, 
