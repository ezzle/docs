...
{slot_reference: "name", value: [{value_type: "string", value_content: "documents XML pour base de données Vignetten 705 (pour titulaires d’une autorisation)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Rentrée des documents XML qui sont téléchargés par le composante central de l'AG D&amp;A dans la base de données Vignettes 705 (pour les titulaires de licence) : XML est créé à partir d'un document pdf."}, ]}, 
