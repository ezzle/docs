...
{slot_reference: "name", value: [{value_type: "string", value_content: "données Quota sur le flux de PLDA quota vers ccn csi"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ils transmettent les données sur les quotas à l'Europe, qui les valide et puis les renvoie à Tarbel. Ces données sont envoyées à l'Europe via CCN CSI et l'Europe en confirme ensuite la réception à Plda et leurs comptes sont saisis dans Tarbel le lendemain."}, ]}, 
