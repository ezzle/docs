...
{slot_reference: "name", value: [{value_type: "string", value_content: "site web général cdib-aperçu de toutes les autorisations AEO accordées"}, ]}, 
