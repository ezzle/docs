...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Mail2"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Mail du SPF Finances pour tous les agents"}, ]}, 
