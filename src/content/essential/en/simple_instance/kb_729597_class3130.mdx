...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  allocation des paiements à un collaborateur (régistre d'attente)"}, ]}, 
