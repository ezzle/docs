...
{slot_reference: "name", value: [{value_type: "string", value_content: "cocy   statistiques des opérateurs, postes, code GN, le pays et la combinaison pour la filiale"}, ]}, 
