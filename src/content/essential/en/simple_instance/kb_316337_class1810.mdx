...
{slot_reference: "name", value: [{value_type: "string", value_content: "service VatVEE"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Traitement des fichiers de demandes d’exonération TVA (hors fuel) introduites par des Diplomates via des opérateurs économiques agréés."}, ]}, 
