...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant le transit des déclarations en TRansactions dans le cadre du transport douanier communautair et commun sur le flux de NCTS vers IPI plan d'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant des déclarations en transit et des transactions dans le cadre du transport douanier communautair et commun sur le flux de NCTS vers IPI plan d'information"}, ]}, 
