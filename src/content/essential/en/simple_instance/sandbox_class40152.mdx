...
{slot_reference: "name", value: [{value_type: "string", value_content: "Plate-forme technologique : catalogue tabulaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste tabulaire dynamique des données objets physiques significatives pour l'organisation"}, ]}, 
