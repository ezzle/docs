...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion de la durée et de la validité des oppositions aux saisies"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion de la durée et de la validité des oppositions aux saisies"}, ]}, 
