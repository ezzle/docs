...
{slot_reference: "name", value: [{value_type: "string", value_content: "référence autorisation AEO sur le flux Ncts RW vers AEO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "référence license AEO sur le flux Ncts RW vers AEO"}, ]}, 
