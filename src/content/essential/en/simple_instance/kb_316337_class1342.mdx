...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Camada"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Camada assure la gestion des dossiers électroniques pour les services des recherches de la douane"}, ]}, 
