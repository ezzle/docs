...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation par FIRST du rappel AP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation par FIRST du rappel AP"}, ]}, 
