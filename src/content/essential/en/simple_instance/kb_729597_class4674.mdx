...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  traitements des remboursements  UC 08-08  validations des interêts moratoires"}, ]}, 
