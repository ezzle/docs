...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class115"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "statistieken ivm aangiftes in het kader van de invoer en de weegcertificaten van bananen, de restituties en de substitutiecontroles op flow van Agristat4 naar IPI Informatieplan managed by AGRISTAT 4_Prod"}, ]}, 
