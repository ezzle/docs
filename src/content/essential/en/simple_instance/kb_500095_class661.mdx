...
{slot_reference: "name", value: [{value_type: "string", value_content: "status de libération de containers sur le flux manuel de CCRM vers S&amp;S (vérification manuelle par S&amp;S et CCRM)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "status de libération de containers sur le flux manuel de CCRM vers S&amp;S (vérification manuelle par S&amp;S et CCRM)"}, ]}, 
