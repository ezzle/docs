...
{slot_reference: "name", value: [{value_type: "string", value_content: "Statistiques Management Meow"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L'application de l'AG Documentation Patrimoniale (Direction Mesures et Evaluations) pour le traitement des données statistiques."}, ]}, 
