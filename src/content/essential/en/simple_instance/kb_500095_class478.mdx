...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation du project initiation document"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation du project initiation document"}, ]}, 
