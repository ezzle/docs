...
{slot_reference: "name", value: [{value_type: "string", value_content: "Client Consultimmo consultable par Ovam"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Il s'agit d'un client spécifique à consulter l'application Consultimmo par des institutionels (p.e. Ovam)."}, ]}, 
