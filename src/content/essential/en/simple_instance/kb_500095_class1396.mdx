...
{slot_reference: "name", value: [{value_type: "string", value_content: "powershell script pour accorder des droits sur ECL/shared pour batch feed locostat par flux de Locostat vers ADM expert"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Locostat vers ADM expert. Ca concerne l'usage du powershell script pour accorder des droits sur des fichiers avec des dossiers, pour toutes les personnes qui en ont besoin. ADM expert: droits sur ECL/shared pour batch feed locostat."}, ]}, 
