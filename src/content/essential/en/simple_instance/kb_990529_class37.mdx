...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_990529_Class38"}, ]}, 
{slot_reference: "app_pro_persists_info_rep", value: [{value_type: "boolean", value_content: "false"}, ]}, 
{slot_reference: "used_in_app_dependencies", value: [{value_type: "simple_instance", value_content: "KB_990529_Class7"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "dagelijks bestand belastingplichtigen die zich uitschrijven uit Zoomit (RR nrs. of BNI repertoriumnummers) op terugkerende flow van Fin Rek naar Isabel managed by Financiële rekeningnummers_PROD"}, ]}, 
