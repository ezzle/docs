...
{slot_reference: "name", value: [{value_type: "string", value_content: "db TC non automatisé  db 2 de 2  schéma TRUCK_SERVICEPUBLIC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db TC non automatisé  db 2 de 2  schéma TRUCK_SERVICEPUBLIC"}, ]}, 
