...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclarations PLDA sur le flux mensuel de PLDA vers plan d'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclarations PLDA sur le flux mensuel de PLDA vers plan d'information"}, ]}, 
