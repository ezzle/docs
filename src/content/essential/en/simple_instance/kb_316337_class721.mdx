...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service TargetGroupCalculationGE (calcul de l'impôt des sociétés pour les grandes entreprises)"}, ]}, 
