...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat volledige db-directement intervenir dans les données de l'application Agristat 4"}, ]}, 
