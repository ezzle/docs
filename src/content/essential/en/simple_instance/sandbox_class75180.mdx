...
{slot_reference: "description", value: [{value_type: "string", value_content: "formulier indien de handtekening niet overeenkomt met identiteitskaart"}, ]}, 
