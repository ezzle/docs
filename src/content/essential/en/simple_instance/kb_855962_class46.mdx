...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_855962_Class47"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Alimentatievorderingen op flow van secal php naar debiteurenbeheer managed by Secal-Davo PHP_Prod"}, ]}, 
