...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  supprimer le bénéficiaire de la demande (traiter des demandes des bénéficiaires)"}, ]}, 
