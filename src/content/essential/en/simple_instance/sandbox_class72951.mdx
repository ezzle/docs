...
{slot_reference: "name", value: [{value_type: "string", value_content: "db Vorst (VA)  situation antérieure"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db Frost (VA)  état antérieur Dossier Va-VORST : historique des remboursements (état antérieur)"}, ]}, 
