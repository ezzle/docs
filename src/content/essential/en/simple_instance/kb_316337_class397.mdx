...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mettre sur un pied un échange électronique de données avec la Région flamande à l'occasion de l'introduction d'une demande d'urbanisme digitale (DUD) par la Région flamande."}, ]}, 
