...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_476224_Class112"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "vraag om aanvulling identiteitsgegevens van een persoon met een faillissement op Flow van SP10b naar Sitran managed by SP 10B  Faillites_PROD"}, ]}, 
