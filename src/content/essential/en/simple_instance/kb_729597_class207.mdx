...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  GL-interface met het FEDCOM-programma en terugbetalingen aan de rechthebbenden"}, ]}, 
