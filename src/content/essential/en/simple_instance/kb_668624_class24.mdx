...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_668624_Class25"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Buitenlandse BTW inkomsten op flow van Stirint naar Vensoc (Stiron vensoc) managed by STIRint_Prod"}, ]}, 
