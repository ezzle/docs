...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  generieke module  schrapping invordering  UC  31-90 registratie van de beslissing van opschorting van invordering"}, ]}, 
