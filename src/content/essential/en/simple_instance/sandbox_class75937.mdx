...
{slot_reference: "name", value: [{value_type: "string", value_content: "données déclaration impôts des personnes sur le flux de Tax on web vers Calcul ipp"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données déclaration impôts des personnes sur le flux de Tax on web vers Calcul Ipp"}, ]}, 
