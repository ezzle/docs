...
{slot_reference: "name", value: [{value_type: "string", value_content: "service menu DMGC site web"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application développée pour soutenir la gestion indépendante de l'application  Risk Management (DMGC) de  AA D&amp;A"}, ]}, 
