...
{slot_reference: "name", value: [{value_type: "string", value_content: "First recovery  Condamnations  entrer et gérer des condamnations et des amendes pénales liées"}, ]}, 
