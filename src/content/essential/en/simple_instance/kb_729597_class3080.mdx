...
{slot_reference: "name", value: [{value_type: "string", value_content: "Emcs-créer un e-AD: opérateur économique: expéditeur; opérateur économique: destinataire initial"}, ]}, 
