...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Adobe Lifecycle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la signature de documents PDF."}, ]}, 
