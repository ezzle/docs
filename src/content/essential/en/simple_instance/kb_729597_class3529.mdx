...
{slot_reference: "name", value: [{value_type: "string", value_content: "MBM  statistiques pour des mesures de performance par rapport aux contrôles des teams mobiles"}, ]}, 
