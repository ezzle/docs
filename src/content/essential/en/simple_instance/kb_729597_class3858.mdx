...
{slot_reference: "name", value: [{value_type: "string", value_content: "Locoselect: importer et enrichir les données des transactions / des dossiers concernant des biens immobiliers de Patris"}, ]}, 
