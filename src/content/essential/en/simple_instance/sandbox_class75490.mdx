...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulier schatkist investeringsrekening  toevoegen fondsen"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "investeringsrekening   fondsen toevoegen"}, ]}, 
