...
{slot_reference: "name", value: [{value_type: "string", value_content: "VAT Refund  décisions belges pour dumandes étrangères  VAT Refund (workflow)"}, ]}, 
