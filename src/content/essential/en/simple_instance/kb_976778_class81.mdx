...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_976778_Class82"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "hyperlink op flow van vergunning alcohol naar CDIB website managed by Vergunning alcohol  autorisation alcool_Prod"}, ]}, 
