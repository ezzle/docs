...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  générer des étiquettes des  institutions financières (gérer des livraisons)"}, ]}, 
