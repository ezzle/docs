...
{slot_reference: "name", value: [{value_type: "string", value_content: "BV Land  envoi des rappels vers les secrétariats sociaux agrées sur base des adresses des mandataires qui sont mises à jour manuellement dans BV Land (pas de synchronisation avec Sitran)"}, ]}, 
