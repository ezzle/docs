...
{slot_reference: "name", value: [{value_type: "string", value_content: "Geaut VB  VBDIS1 Introductie van de opzoekingsleutels (nummerplaat, RR, nr. uitnodiging)"}, ]}, 
