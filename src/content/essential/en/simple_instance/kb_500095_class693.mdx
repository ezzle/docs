...
{slot_reference: "name", value: [{value_type: "string", value_content: "instructions de travail Eurekad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "instructions de travail Eurekad"}, ]}, 
