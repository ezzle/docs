...
{slot_reference: "name", value: [{value_type: "string", value_content: "recours administratifs  module de recherche, avec lequel par exemple des recherches peuvent être fait sur le nom du déposant du recours, le nom du représentant  et/ou sur le nom de la gestionnaire de dossiers"}, ]}, 
