...
{slot_reference: "name", value: [{value_type: "string", value_content: "Information Catalogue par domaine métier"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation, par domaine métiers, des vues ou concepts informationnels significatifs pour l'organisation."}, ]}, 
