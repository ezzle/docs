...
{slot_reference: "name", value: [{value_type: "string", value_content: "plan de précadastration sur le flux de IPR vers Stipad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de IPR vers Stipad quand le plan de précadastration est ok, encodé et uploadé dans Stipad"}, ]}, 
