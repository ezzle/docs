...
{slot_reference: "name", value: [{value_type: "string", value_content: "RAM  Risk et audit management  rentrée des résultats des tests opérationnels"}, ]}, 
