...
{slot_reference: "name", value: [{value_type: "string", value_content: "P134 Management de crises"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Management de crises (p134)"}, ]}, 
