...
{slot_reference: "name", value: [{value_type: "string", value_content: "service DB-org"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Base de données pour la description des tâches du personnel du SPF Finances."}, ]}, 
