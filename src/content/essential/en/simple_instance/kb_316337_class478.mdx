...
{slot_reference: "name", value: [{value_type: "string", value_content: "Améliorer le rapportage du processus 'scanning' pour un meilleur suivi de la production."}, ]}, 
