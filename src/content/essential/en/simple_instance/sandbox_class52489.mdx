...
{slot_reference: "name", value: [{value_type: "string", value_content: "RPBBEL  RPB 2013_PROD (enrôlements impots des sociétés)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application concernant les enrôlements impots des sociétés, exercice d'imposition 2013"}, ]}, 
