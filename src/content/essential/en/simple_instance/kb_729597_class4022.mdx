...
{slot_reference: "name", value: [{value_type: "string", value_content: "Rentrée des dossiers avec une proposition de contrôle par tous les agents AG Fisc / ISI"}, ]}, 
