...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service ServiceManager"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application HP Service Manager pour la gestion des tickets au Service desk et la gestion des incidents dans le département ICT."}, ]}, 
