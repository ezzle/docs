...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la validation de la configuration de la signature PDF sur le poste client."}, ]}, 
