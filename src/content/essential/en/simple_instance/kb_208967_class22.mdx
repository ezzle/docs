...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class23"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_208967_Class24"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens betalingen aan andere lidstaten op flow van Pay it naar MOSS managed by PayIt_PROD"}, ]}, 
