...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service DB Press / DB Pers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "DB Press / DB Press est une application qui interagit avec Taskmanager."}, ]}, 
