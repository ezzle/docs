...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  generieke module  invorderingsacties  UC  31-50  handlichting op verzoek van een belanghebbende"}, ]}, 
