...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_976778_Class131"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_692363_Class45"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info over ac4 aangiftes op flow van ac4 g&amp;i naar stats acc managed by AC4 (php  dienst gegevensbeheer AA D&amp;A)"}, ]}, 
