...
{slot_reference: "name", value: [{value_type: "string", value_content: "service JSF2 MVC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "application pour développer des patterns model viewer controller"}, ]}, 
