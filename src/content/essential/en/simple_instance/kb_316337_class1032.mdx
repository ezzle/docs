...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Easyval"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Documentation électronique d'estimation de bâtiments industriels et de bâtiments exceptionnels (voir aussi service Fotocol)"}, ]}, 
