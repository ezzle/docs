...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  module van opzoeking van gestopte geannuleerde en actieve acties"}, ]}, 
