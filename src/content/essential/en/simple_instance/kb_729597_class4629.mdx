...
{slot_reference: "name", value: [{value_type: "string", value_content: "un aperçu des opérations les plus récentes dans le dossier du contribuable TVA"}, ]}, 
