...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_882522_Class93"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "signaletiekgegevens op flow van KBO naar FED-IAM (stroom naar externe niet FOD Fin applicatie) managed by KBO Viewer_PROD"}, ]}, 
