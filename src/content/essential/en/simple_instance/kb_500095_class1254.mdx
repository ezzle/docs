...
{slot_reference: "name", value: [{value_type: "string", value_content: "PLDA_annulations_load Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PLDA_annulations_chargement Relational Database on MariaDB/MySQL Environment"}, ]}, 
