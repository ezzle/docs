...
{slot_reference: "name", value: [{value_type: "string", value_content: "Tax Fraud reporting  consultation de l'implication financière des différentes types des documents d'infraction"}, ]}, 
