...
{slot_reference: "name", value: [{value_type: "string", value_content: "Optimiser les contrôles en augmentant la portée pour la stratégie modifiée"}, ]}, 
