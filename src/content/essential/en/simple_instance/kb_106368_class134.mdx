...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class135"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "statistieken omtrent aangiftes van bewegingen tussen belastingsentrepots van goederen onder accijnsverband op flow van Emcs naar IPI informatieplan managed by EMCS-PROD (java masp)"}, ]}, 
