...
{slot_reference: "name", value: [{value_type: "string", value_content: "service PC gestion des Accises"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de la Douane et Accises sur PC (local), qui n'existe plus."}, ]}, 
