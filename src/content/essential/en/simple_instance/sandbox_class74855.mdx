...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande identification préalable (PRECAD)  autre"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire pour identification préalable d'information parcellaire  autre information"}, ]}, 
