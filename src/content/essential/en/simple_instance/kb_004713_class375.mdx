...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclarations PLDA sélectionnées pour contrôle (des fiches sps) sur le flux de SPS vers SEDA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclarations PLDA sélectionnées pour contrôle (venant des fiches SPS) sur le flux de SPS vers SEDA"}, ]}, 
