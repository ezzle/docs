...
{slot_reference: "name", value: [{value_type: "string", value_content: "Documents sur le flux de Filenet ECM webservices vers GDS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Documents sur le flux des webservices ECM de Filenet vers le GDS"}, ]}, 
