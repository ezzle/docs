...
{slot_reference: "name", value: [{value_type: "string", value_content: "HYPO-Webservices (pour DER)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce projet fournit le webservice pour HYPO qui est mis à la disposition du webservice DER-HYPO."}, ]}, 
