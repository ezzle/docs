...
{slot_reference: "name", value: [{value_type: "string", value_content: "Extraction des données de la dette sur le flux hebdomadaire de 180B AUT vers le Mississipi managementcockpit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Extraction de données de 180B AUT vers Mississipi managementscockpit Fréquence : flux hebdomadaire"}, ]}, 
