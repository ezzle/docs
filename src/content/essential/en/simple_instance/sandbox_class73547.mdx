...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros Eori sur le flux d'Eori vers Seda Dashboard"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Numéros Eori sur le flux du tableau de bord de l'Eori à la seda"}, ]}, 
