...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application des frais de poursuite, reprenant des frais par mois, par montant, par débiteur et des totaux par année civile ou par période ( service Listings)."}, ]}, 
