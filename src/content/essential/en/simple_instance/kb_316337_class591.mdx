...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mettre en oeuvre le cycle de gestion jusqu'au niveau le plus bas utile"}, ]}, 
