...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation des dettes et crédits par application comptable document comptable"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation des dettes et crédits par application comptable document comptable"}, ]}, 
