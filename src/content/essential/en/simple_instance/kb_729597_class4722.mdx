...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  opname saldo van de openstaande vorderingen (vastgesteld recht) op 31 december 2017 in SAP/FEDCOM."}, ]}, 
