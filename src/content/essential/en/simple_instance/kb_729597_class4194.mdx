...
{slot_reference: "name", value: [{value_type: "string", value_content: "First recovery  Recovery acties common screens  gemeenschappelijke functionaliteiten en visuele componenten voor het raadplegen en opvolgen van invorderingsacties"}, ]}, 
