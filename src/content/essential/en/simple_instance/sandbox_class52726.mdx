...
{slot_reference: "description", value: [{value_type: "string", value_content: "Identique à outputservices de l'AG Documentation Patrimoniale, mais concerne les pièces internes attachées à l'application interne Stipad."}, ]}, 
