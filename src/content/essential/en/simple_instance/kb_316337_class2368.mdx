...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Frontaliers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "base de données de toutes les personnes qui en 2011 avaient le statut d'ouvrier frontalier"}, ]}, 
