...
{slot_reference: "name", value: [{value_type: "string", value_content: "SurveyorPlan old_chercher un droit réel de propriété  transaction7: via parcelle"}, ]}, 
