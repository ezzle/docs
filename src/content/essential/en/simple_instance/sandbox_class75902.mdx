...
{slot_reference: "name", value: [{value_type: "string", value_content: "données GDPR (données signalétiques) sur le flux de Stipad vers Easyval"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux GDPR données de Stipad vers Easyval"}, ]}, 
