...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_290787_Class88"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Feedback vergelijking douane-aangifte Plda vs. accijnsaangifte Emcs op flow van PLDA cross check naar PLDA managed by PLDA  crosscheck PLDA-EMCS uitvoer"}, ]}, 
