...
{slot_reference: "description", value: [{value_type: "string", value_content: "Toekomstige flow Ariba naar Fedcom (nu eind 2018 nog Clm naar Fedcom)"}, ]}, 
