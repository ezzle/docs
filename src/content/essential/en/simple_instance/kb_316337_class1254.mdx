...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Finform"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application fournit tous les formulaires du SFP Finances en format électronique."}, ]}, 
