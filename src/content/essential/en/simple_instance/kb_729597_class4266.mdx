...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  traiter les demandes des bénéficiaires pour réserver des coffres-fort"}, ]}, 
