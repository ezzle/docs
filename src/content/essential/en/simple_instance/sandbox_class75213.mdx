...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire signature modèle Ordonnateurs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "des signatures modèle des ordonnateurs pour signer des relevés des modifications"}, ]}, 
