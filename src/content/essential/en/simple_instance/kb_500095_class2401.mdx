...
{slot_reference: "name", value: [{value_type: "string", value_content: "données tarifaires sur le flux de Dds2 vers Tarbel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Dds2 à Tarbel. DDS2 Data Dissimenation System permet de saisir les données directement depuis l'Europe dans Tarbel."}, ]}, 
