...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire architecte (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulaire architecte (AG DocPat)"}, ]}, 
