...
{slot_reference: "name", value: [{value_type: "string", value_content: "L'architecture d'entreprise (Pxx)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion de l'architecture d'entreprise"}, ]}, 
