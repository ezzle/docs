...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Numéros de comptes personnes physiques"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application dans laquelle les numéros de compte des personnes physiques sont enregistrés"}, ]}, 
