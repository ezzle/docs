...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire de mainlevée d'une opposition sur titres au porteur (une version française et une version néerlandaise)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données didentification de lopposant, références du dossier et données didentification des titres faisant lobjet le la mainlevée"}, ]}, 
