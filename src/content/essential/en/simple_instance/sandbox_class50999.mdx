...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le calcul du prix du développement ou de la maintenance d'une application. L'application est utilisée par le département ICT-DEV."}, ]}, 
