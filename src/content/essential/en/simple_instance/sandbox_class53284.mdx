...
{slot_reference: "name", value: [{value_type: "string", value_content: "Vérification des numéros de TVA_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la validation des numéros de TVA."}, ]}, 
