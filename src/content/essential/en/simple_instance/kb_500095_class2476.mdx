...
{slot_reference: "name", value: [{value_type: "string", value_content: "sommations à imprimer dans un fichier sur le flux d'ICPC vers Fedopress"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "sommations à imprimer dans un fichier sur le flux d'ICPC vers Fedopress"}, ]}, 
