...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mieux suivre les dépenses via le monitoring périodique et via l'exécution du projet 'économiser de manière intelligente' pour contrôler les coûts"}, ]}, 
