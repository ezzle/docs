...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 273C: déclaration de cotisation supplémentaire sur des revenus mobiliers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déclaration du prélèvement supplémentaire sur les revenus mobiliers."}, ]}, 
