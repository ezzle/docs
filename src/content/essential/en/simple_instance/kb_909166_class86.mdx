...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class87"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Taxatie-informatie Directe Belastingen voor niet inwoners op flow van Stirint DLO naar Stirint Autodt managed by STIRint  DLO_PROD"}, ]}, 
