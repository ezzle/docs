...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_189126_Class40"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens omtrent niet fiscale schulden op flow van First niet fiscaal naar eforms managed by First nfi module niet fiscale invorderingen"}, ]}, 
