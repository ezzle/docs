...
{slot_reference: "name", value: [{value_type: "string", value_content: "E705db  consulter l'aperçu de toutes les régistrations dans les application Vignettes 705 et des aperçus partiels des régistrations actives,  abrogées et remplacées"}, ]}, 
