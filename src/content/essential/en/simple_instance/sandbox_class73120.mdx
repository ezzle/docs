...
{slot_reference: "name", value: [{value_type: "string", value_content: "documenten voor identificatie van percelen (Padoc)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "documenten voor identificatie van percelen (Padoc)"}, ]}, 
