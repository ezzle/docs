...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données  Objets  Fournisseurs de données"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Description graphique des échanges entre applications pour chaque donnée objet"}, ]}, 
