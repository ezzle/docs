...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification des contrevenants sur le flux de Sitran vers ANPR DEV"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données d'identification des contrevenants sur le flux de Sitran vers ANPR DEV"}, ]}, 
