...
{slot_reference: "name", value: [{value_type: "string", value_content: "données statistiques de Taxe de circulation sur le flux de SAS vers DB Taxe de circulation (application externe SPF Mobilité)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données statistiques de Taxe de circulation sur le flux de SAS vers DB Taxe de circulation (application externe SPF Mobilité)"}, ]}, 
