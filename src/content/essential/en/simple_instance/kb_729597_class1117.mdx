...
{slot_reference: "name", value: [{value_type: "string", value_content: "TC Automatisée  gestion données des véhicules en vue de la collecte et/ou le remboursement du Geaut. VB, AVB, BIV"}, ]}, 
