...
{slot_reference: "name", value: [{value_type: "string", value_content: "Calcul IPP  exercice d'imposition 2021_PROD (impôts des personnes physiques)"}, ]}, 
