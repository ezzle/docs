...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Inami attribute"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "application avec des données INAMI utilisée dans AA Fisc"}, ]}, 
