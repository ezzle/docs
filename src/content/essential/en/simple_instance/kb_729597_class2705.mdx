...
{slot_reference: "name", value: [{value_type: "string", value_content: "EuVID  Autocrim  consultation information EuVID (European Vehicle Identification Database)"}, ]}, 
