...
{slot_reference: "name", value: [{value_type: "string", value_content: "service vpn"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion et configuration des groupes VPN (IAM Security)"}, ]}, 
