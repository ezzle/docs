...
{slot_reference: "description", value: [{value_type: "string", value_content: "Entité Master est une partie générique des entités de tous les types (utilise SITRAN), comme Entité BizTax, Entité IPP, Entité Specific BTW, Entité-NP."}, ]}, 
