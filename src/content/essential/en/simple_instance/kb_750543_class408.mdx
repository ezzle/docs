...
{slot_reference: "name", value: [{value_type: "string", value_content: "P047 Suivi"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Suivi (p47)"}, ]}, 
