...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class107"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Taxatie info BTW niet inwoners op flow van Stirint Bbi naar Stir Tva managed by STIRint  BBI_PROD"}, ]}, 
