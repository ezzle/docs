...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  Service  Synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétiques des principaux attributs ou relations d'un service métier donné"}, ]}, 
