...
{slot_reference: "name", value: [{value_type: "string", value_content: "P083 Contrats d'achat"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Contrats d'achat (p83)"}, ]}, 
