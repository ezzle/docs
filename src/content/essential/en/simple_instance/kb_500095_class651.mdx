...
{slot_reference: "name", value: [{value_type: "string", value_content: "questions d'autres états membre pour remboursement TVA (aussi bien questions des Belges que des non Belges) sur le flux de Vatrefund vers Stirint"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "questions d'autres états membre pour remboursement TVA: aussi bien des questions des Belges que des non Belges. Ce flux ne contient pas des informations sur les personnes assujetis au TVA."}, ]}, 
