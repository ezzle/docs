...
{slot_reference: "name", value: [{value_type: "string", value_content: "P133 Traiter des infractions"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Traiter des infractions (p133)"}, ]}, 
