...
{slot_reference: "name", value: [{value_type: "string", value_content: "signalétique transversale « Personnes » pour TVA sur le flux de Stiron Signalétique vers Stiron CC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "signalétique transversale des assujettis à la TVA sur le flux de Stiron signalétique vers Stiron CC"}, ]}, 
