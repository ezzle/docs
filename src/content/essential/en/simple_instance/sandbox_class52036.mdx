...
{slot_reference: "name", value: [{value_type: "string", value_content: "NET4_PROD (contrôle d’accès)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le contrôle d’accès :  6900 MARCHE EN FAMENN ALLEE DU MONUMENT 25"}, ]}, 
