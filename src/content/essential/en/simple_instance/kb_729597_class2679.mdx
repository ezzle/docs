...
{slot_reference: "name", value: [{value_type: "string", value_content: "FACO  télécharger l'aperçu de toutes les faillites et concordats judiciaires, publiés pendant l'année en cours ou l'année précédente"}, ]}, 
