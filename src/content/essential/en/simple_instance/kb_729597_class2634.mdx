...
{slot_reference: "name", value: [{value_type: "string", value_content: "FACO  lire les extraits de données de Graydon dans les bases de données du service de gestion de données par rapport aux faillites des opérateurs spécifiques qui étaient titulaire d'une licence valable des établissements d'accises, AEO…"}, ]}, 
