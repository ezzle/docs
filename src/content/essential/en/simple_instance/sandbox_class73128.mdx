...
{slot_reference: "name", value: [{value_type: "string", value_content: "Documents de baux sur les fluxs de Myrent vers Doctran"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "documents Contrats de bail sur le flux de Myrent vers Doctran"}, ]}, 
