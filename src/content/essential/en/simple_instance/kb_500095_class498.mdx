...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de remboursement par application d'établissement penal fines (component restitutions)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de remboursement par application d'établissement penal fines (component restitutions)"}, ]}, 
