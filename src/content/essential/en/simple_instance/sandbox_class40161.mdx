...
{slot_reference: "name", value: [{value_type: "string", value_content: "Capacités applicatives  Synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit une vue synthétique des principales caractéristiques ou relations d'une capacité applicative"}, ]}, 
