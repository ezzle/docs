...
{slot_reference: "description", value: [{value_type: "string", value_content: "Ensemble d'applications directement liées au framework CCFF (CLSAdmin, etc.)"}, ]}, 
