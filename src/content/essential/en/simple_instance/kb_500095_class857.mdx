...
{slot_reference: "name", value: [{value_type: "string", value_content: "messages xml signatures électroniques sur messages ICS sur le flux de E Signature masp vers Ics"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Messages xml avec des signatures électroniques sur des messages ICS. Des messages xml avec des signatures électroniques seront remplacé par le développement Européen dans le cadre de UU &amp; MDS."}, ]}, 
