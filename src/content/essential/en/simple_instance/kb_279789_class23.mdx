...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_279789_Class24"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "betaalinformatie op flow van Tax on web naar Sepa service over ESB managed by Tax-on-Web_PROD"}, ]}, 
