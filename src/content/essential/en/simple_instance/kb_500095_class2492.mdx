...
{slot_reference: "name", value: [{value_type: "string", value_content: "des sous-estimations sur le flux de Esucc vers Stipad (interface humaine)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Sousestimations sur le flux d'Esucc vers Stipad (interface humaine) : après que l'héritier ait déposé une déclaration, AG Docpat SJ demandera dans Stipad  à AG DocPat MEOW une demande de contrôle de sousestimation. MEOW transmettra leur évaluation à SJ."}, ]}, 
