...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application d'envoi de signaux Sitran à des applications abonnées sur les services web de Sitran."}, ]}, 
