...
{slot_reference: "name", value: [{value_type: "string", value_content: "db PMEURO  fichier PM276REG"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Stockage des demandes de remboursement PM en db RV 276REG  ce fichier contient toutes les données relatives à la demande de remboursement, tant pour les intérêts que pour les dividendes."}, ]}, 
