...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_857290_Class3"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Lijst van de toegekende Aeo's per regio zichtbaar in Gi consult"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "visualisatie AEO's per regio op toekomstige flow van Banaeos naar GI consult managed by BANAEOS_Prod"}, ]}, 
