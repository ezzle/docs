...
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application permet de stocker et de gérer de manière sécurisée l’archivage légal des documents du SPF au moyen de la application IBM Filenet P8."}, ]}, 
