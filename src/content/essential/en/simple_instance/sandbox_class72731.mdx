...
{slot_reference: "name", value: [{value_type: "string", value_content: "db plan d' information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db plan d'information"}, ]}, 
