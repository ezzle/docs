...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Stir DU"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Livraison des données pour le programme STIRint (marchandises d'origine étrangère)"}, ]}, 
