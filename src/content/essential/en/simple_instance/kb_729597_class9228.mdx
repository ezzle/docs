...
{slot_reference: "name", value: [{value_type: "string", value_content: "java-pas de CCFF-DB2"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "java-pas de CCFF-DB2"}, ]}, 
