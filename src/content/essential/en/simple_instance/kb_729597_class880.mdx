...
{slot_reference: "name", value: [{value_type: "string", value_content: "VIES  Consulter les données d'identification des assujettis à la TVA de tous les États membres"}, ]}, 
