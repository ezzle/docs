...
{slot_reference: "name", value: [{value_type: "string", value_content: "données signalétiques sur le flux de BCE vers FED-IAM (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données signalétiques sur le flux de BCE vers FED-IAM (flux vers application externe non SPF Finances)"}, ]}, 
