...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application permettant de définir les rôles et les conditions à remplir pour pouvoir exécuter une transaction dans une application."}, ]}, 
