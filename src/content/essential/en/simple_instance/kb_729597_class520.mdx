...
{slot_reference: "name", value: [{value_type: "string", value_content: "ICPC  Pcfrms  listing manuelle des coûts de poursuite des huissiers  php Service Listings"}, ]}, 
