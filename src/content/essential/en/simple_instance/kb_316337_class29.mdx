...
{slot_reference: "name", value: [{value_type: "string", value_content: "Élaboration d'un plan stratégique de sécurité de l'information valable pendant trois ans et élaboration d'un système périodique pour la révision de ce plan"}, ]}, 
