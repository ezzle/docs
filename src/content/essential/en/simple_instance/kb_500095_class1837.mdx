...
{slot_reference: "description", value: [{value_type: "string", value_content: "Selectie PDF documenten uit DER op flow van Stipad naar Filenet"}, ]}, 
