...
{slot_reference: "name", value: [{value_type: "string", value_content: "service numéros comptes bancaires"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Service de l'AG Fiscalité pour la gestion des numéros de compte sur lesquels les remboursements d'impôts directs sont versés."}, ]}, 
