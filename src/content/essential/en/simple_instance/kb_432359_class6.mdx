...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_432359_Class7"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Identificatiegegevens overtreders op flow van Sitran naar ANPR DEV managed by SITRAN"}, ]}, 
