...
{slot_reference: "name", value: [{value_type: "string", value_content: "Geaut VB  Beheer gegevens van de voertuigen met het oog op de inning en/of de terugbetaling van de Geaut. VB, AVB, BIV (behalve  Ecomalus (Wallonië) en Acob)."}, ]}, 
