...
{slot_reference: "name", value: [{value_type: "string", value_content: "SitranDS_PROD ('data services' de Sitran)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour les 'data services' de Sitran (groupe SOA_ESB)"}, ]}, 
