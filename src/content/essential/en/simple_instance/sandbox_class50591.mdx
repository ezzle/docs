...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la configuration des messages d'aide, appel du composant browser support et configuration des blacklist SEPA."}, ]}, 
