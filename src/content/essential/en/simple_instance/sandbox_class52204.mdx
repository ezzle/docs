...
{slot_reference: "name", value: [{value_type: "string", value_content: "PC Infractions transport routier_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Overtredingen wegvervoer était une Application sur PC (local), n'est plus utilisé."}, ]}, 
