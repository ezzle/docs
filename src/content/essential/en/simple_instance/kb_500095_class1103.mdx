...
{slot_reference: "name", value: [{value_type: "string", value_content: "les données de personnes impliquées chez hypothèques sur le flux de Hypo vers Hypo webservice"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "les données de personnes impliquées chez des hypothèques sur le flux de Hypo vers Hypo webservices"}, ]}, 
