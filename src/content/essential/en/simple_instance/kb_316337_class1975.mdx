...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PropositionDeclarationsSimplifiees"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour réaliser la génération du groupe cible qui recevra une proposition de déclaration d'impôts simplifiée"}, ]}, 
