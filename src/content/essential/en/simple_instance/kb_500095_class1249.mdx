...
{slot_reference: "name", value: [{value_type: "string", value_content: "PLDA_annulations Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PLDA_annulations Relational Database on MariaDB/MySQL Environment"}, ]}, 
