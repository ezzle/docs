...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  transversaal  Automatische validatie van AP-vonissen (amendes pénales)"}, ]}, 
