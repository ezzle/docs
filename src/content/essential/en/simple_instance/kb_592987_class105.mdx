...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_592987_Class106"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Boekhoudkundige gegevens vr vestiging registratie en successierechten en gegevens m.b.t. patrimonium van de staat op Flow van Comfor Java naar Comfor (php) managed by COMFOR_JAVA _Prod"}, ]}, 
