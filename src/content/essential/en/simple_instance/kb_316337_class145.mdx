...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formuler des propositions, en collaboration avec les différentes administrations générales afin d'harmoniser et de simplifier la législation et la réglementation"}, ]}, 
