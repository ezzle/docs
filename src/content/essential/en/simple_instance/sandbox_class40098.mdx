...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  Service  Catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des différents services métiers (types de produits) significatifs pour l'organisation."}, ]}, 
