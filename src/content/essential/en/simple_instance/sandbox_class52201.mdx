...
{slot_reference: "name", value: [{value_type: "string", value_content: "PC Certification d'origine_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Oorsprongscertificatie est une application sur PC (local)"}, ]}, 
