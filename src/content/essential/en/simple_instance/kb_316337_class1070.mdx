...
{slot_reference: "name", value: [{value_type: "string", value_content: "service BCE"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Selon Yoeri Huyssen = pas connu, mais était quand même découvert dans uCMDB"}, ]}, 
