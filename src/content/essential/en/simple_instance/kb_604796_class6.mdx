...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_604796_Class5"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flux de SAS vers DB Taxe de circulation (Application Externe)"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Statistische gegevens verkeersbelasting op flow van SAS naar DB Taxe de circulation (externe applicatie Fod Mobiliteit) managed by SAS"}, ]}, 
