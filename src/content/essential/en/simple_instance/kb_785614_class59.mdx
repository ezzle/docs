...
{slot_reference: "name", value: [{value_type: "string", value_content: "Chef de la Cellule Gestion des Clients (Division Délivrance dInformations)"}, ]}, 
