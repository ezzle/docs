...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation dossier de comptabilité par PE (unité de personne) par application accounting"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation dossier de comptabilité par PE (unité de personne) par application accounting"}, ]}, 
