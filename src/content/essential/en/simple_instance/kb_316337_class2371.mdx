...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service MenusICTAPPS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Point d'entrée aux différentes applications intranet en fonction des droits des utilisateurs. 
