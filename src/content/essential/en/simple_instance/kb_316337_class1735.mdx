...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PressReview"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "programme où les articles de presse pré sélectionné sont chargés (retired)"}, ]}, 
