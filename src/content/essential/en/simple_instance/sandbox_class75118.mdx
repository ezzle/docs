...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire notification d'autres sortes de types de tabac à fumer"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "notification d'autres sortes de types de tabac à fumer"}, ]}, 
