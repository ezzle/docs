...
{slot_reference: "name", value: [{value_type: "string", value_content: "Participer aux initiatives internationales, européennes ou fédérales : loi bancaire, taxe sur les transactions financières ..."}, ]}, 
