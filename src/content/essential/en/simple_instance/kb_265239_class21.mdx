...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_625881_Class18"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Authenticatie-informatie op flow van Scriptura naar CCFF (Printmanager) managed by Scriptura_PROD"}, ]}, 
