...
{slot_reference: "description", value: [{value_type: "string", value_content: "StipadTRN est un composant de STIPAD, qui est une application de l'AG Documentation Patrimoniale"}, ]}, 
