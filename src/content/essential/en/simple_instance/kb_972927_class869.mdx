...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_972927_Class867"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "PDF info venant d'un autre Etat-membre(Directive epargne) managed by Stirint Save Directive et OCDE_PROD"}, ]}, 
