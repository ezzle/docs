...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_242815_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "hyperlink op flow van Agristat4 naar GI-Consult (= nieuwe naam voor CDIB_SCGI_Prod) (consultatie van gegevens in GI-Consult) managed by AGRISTAT 4_Prod"}, ]}, 
