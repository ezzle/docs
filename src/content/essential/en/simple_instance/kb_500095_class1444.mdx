...
{slot_reference: "name", value: [{value_type: "string", value_content: "pseudo article sur le flux de pow vers consultimmo"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "AAPD-PRI est l'application pour faire la  transformation suivante: Patris Stipad vers article vers pseudo article pour Pow vers view Consultimmo vers AG Fisc."}, ]}, 
