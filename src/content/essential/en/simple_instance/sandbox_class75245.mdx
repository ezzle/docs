...
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulier ter herinnering aan de schuldenaar van verschuldigde betalingen"}, ]}, 
