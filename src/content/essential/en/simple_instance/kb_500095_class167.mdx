...
{slot_reference: "name", value: [{value_type: "string", value_content: "coûts de poursuite des huissiers par mois, par montant, par débiteur et des totaux par année calendrier ou par période sur le flux d'ICPC vers PCFURE"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "coûts de poursuite des huissiers par mois, par montant, par débiteur et des totaux par année calendrier ou par période sur le flux d'ICPC vers PCFURE"}, ]}, 
