...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class97"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens Dir Belastingen over Multinationale Ondernemingen van verschillende landen (zowel Europees als niet-Europees) op flow van stirint beps cbc naar stirint bbi managed by Stirint BEPS / CBC"}, ]}, 
