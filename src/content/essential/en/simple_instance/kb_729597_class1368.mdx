...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  automatische toerekening  UC 07-30 schuld berekenen (verwijlintresten)"}, ]}, 
