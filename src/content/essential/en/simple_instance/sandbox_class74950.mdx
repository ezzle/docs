...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire attestation_bonification d'intérêt"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données relatives aux travaux effectués"}, ]}, 
