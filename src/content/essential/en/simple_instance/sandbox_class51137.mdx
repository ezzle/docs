...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour identifier la configuration d'une application dans un environnement, la vérifier et faciliter la diagnosis d'un problème."}, ]}, 
