...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service comités d'acquisition"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "application locale, langage de programmation = windev"}, ]}, 
