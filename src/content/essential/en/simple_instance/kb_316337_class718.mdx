...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Dour"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Collecte d'informations sur des dossiers par screen scraping et impression de formulaires"}, ]}, 
