...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PC infractions transport routier"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Overtredingen wegvervoer. Application sur PC (local)
retired, n'est plus utilisé."}, ]}, 
