...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  vérifier quelles déclarations PP n'étaient pas payés par l'employeur (vue d'ensemble complète des paiements, peut-être provisoirement à l'exception des paiements enrôlés)"}, ]}, 
