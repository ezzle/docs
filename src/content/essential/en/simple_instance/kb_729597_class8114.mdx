...
{slot_reference: "name", value: [{value_type: "string", value_content: "Tijdsynchronisatie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Deze service verzekert de tijdsynchronisatie van de interne systemen met een centrale atoomklok."}, ]}, 
