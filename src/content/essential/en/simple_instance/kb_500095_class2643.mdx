...
{slot_reference: "name", value: [{value_type: "string", value_content: "flux CLM / Ariba vers Fedcom"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux CLM / Ariba vers Fedcom"}, ]}, 
