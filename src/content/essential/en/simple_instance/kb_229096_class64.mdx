...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class65"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "aanpassingen aan lijsten betreffende de invoer en de weegcertificaten van bananen op flow van agristat volledige db naar agristat4 managed by Agristat  volledige db Prod"}, ]}, 
