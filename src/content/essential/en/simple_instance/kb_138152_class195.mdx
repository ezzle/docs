...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_138152_Class196"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Documenten op flow van Filenet ECM Webservices (op JSR170) naar Myscan managed by Filenet  ECM Webservices (sur JSR170)_PROD"}, ]}, 
