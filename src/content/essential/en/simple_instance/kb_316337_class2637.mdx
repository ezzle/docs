...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Belconet calcul_isoc_ipm"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "remplacé par Calcisoc à partir de l'année d'exercise 2013 (retired)"}, ]}, 
