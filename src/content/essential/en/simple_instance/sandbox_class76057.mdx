...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant biens immobiliers à l'étranger sur le flux de Stirint vers Movables (human; to be: automatique uniquement pour biens immobiliers à l'étranger)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les données relatives aux biens immobiliers à l'étranger sur le flux de Stirint à Movables (automatiquement). Movables récupérera les données des biens immobiliers à l'étranger de Stirint via le webservice Stirint."}, ]}, 
