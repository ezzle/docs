...
{slot_reference: "name", value: [{value_type: "string", value_content: "CDERIT Database (RDC)"}, ]}, 
...
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class81454"}, ]}, 
