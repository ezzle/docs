...
{slot_reference: "name", value: [{value_type: "string", value_content: "P121 Analyse et surveillance de la qualité des données"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Analyse et surveillance de la qualité des données (P121)"}, ]}, 
