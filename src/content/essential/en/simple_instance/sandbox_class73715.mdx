...
{slot_reference: "name", value: [{value_type: "string", value_content: "Feedback de la comparaison de la déclaration douanière PLDA vs. déclaration d'accise Emcs sur le flux de PLDA cross check vers PLDA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Feedback comparaison déclaration douane PLDA vs. déclaration d'accise Emcs sur le flux de PLDA cross check vers PLDA"}, ]}, 
