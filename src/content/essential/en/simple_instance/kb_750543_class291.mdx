...
{slot_reference: "name", value: [{value_type: "string", value_content: "P086 Gestion de données"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion de données (P86)"}, ]}, 
