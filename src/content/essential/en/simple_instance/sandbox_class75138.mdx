...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire modèle 3  demande numéros matricule réservation en masse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demande de numéros de matricule de réservation en masse"}, ]}, 
