...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant recouvrement des dettes TVA sur le flux manuel de Stiron inv vers eforms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant des recouvrement des dettes TVA sur le flux manuel de Stiron inv vers E-Forms"}, ]}, 
