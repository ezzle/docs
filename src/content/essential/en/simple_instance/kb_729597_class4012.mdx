...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool Handhaving  extractions des données de l'importation ou de l'exportation (à partir de 2016 incl. les données de Dataflux et Feedback)"}, ]}, 
