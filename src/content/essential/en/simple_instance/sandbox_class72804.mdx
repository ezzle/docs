...
{slot_reference: "name", value: [{value_type: "string", value_content: "db pc remboursements (sql db)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db pc remboursements (sql db)"}, ]}, 
