...
{slot_reference: "name", value: [{value_type: "string", value_content: "données statistiques pour le management cockpit en matière de l'évolution budgettaire sur le flux de VA vers TBT / Missisipi management cockpit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données statistiques pour le management cockpit en matière de l'évolution budgettaire sur le flux de VA vers TBT / Missisipi management cockpit"}, ]}, 
