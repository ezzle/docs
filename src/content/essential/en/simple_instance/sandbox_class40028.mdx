...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue applicatif-par famille"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente, par famille d'application, la liste des applications utilisés dans l'organisation."}, ]}, 
