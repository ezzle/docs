...
{slot_reference: "name", value: [{value_type: "string", value_content: "DMGC (data mgt. system)  consulter et exporter des rapports des fiches SPS"}, ]}, 
