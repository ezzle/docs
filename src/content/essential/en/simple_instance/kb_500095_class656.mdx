...
{slot_reference: "name", value: [{value_type: "string", value_content: "questions d'autres états membre pour remboursement TVA sur le flux de Moss vers Stirint"}, ]}, 
