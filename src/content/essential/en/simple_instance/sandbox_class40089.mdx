...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données  sujets  Catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique  des données sujets conceptuelles."}, ]}, 
