...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 325An:relevé 325 annexe"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Tableau de correspondance entre les déclarations 325 et les déclarations au précompte professionnel"}, ]}, 
