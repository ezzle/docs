...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations de la dette à archiver sur flux annuel de 180b to belconet archive"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "informations de la dette à archiver sur flux annuel de 180b vers belconet archive"}, ]}, 
