...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des uniformes douaniers. L'application Kledingfonds a définitivement cessé en 2017  et a été remplacé par DA Outfit."}, ]}, 
