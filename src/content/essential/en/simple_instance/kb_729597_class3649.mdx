...
{slot_reference: "name", value: [{value_type: "string", value_content: "E705db  attribuer des droits d'accès à l'application Vignettes 705 aux fonctionnaires des filiales"}, ]}, 
