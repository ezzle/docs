...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_189126_Class37"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Load van schulden (NFI afsluiting) op maandelijkse flow van first-NFI naar FEDCOM (nog niet in productie) managed by First nfi module niet fiscale invorderingen"}, ]}, 
