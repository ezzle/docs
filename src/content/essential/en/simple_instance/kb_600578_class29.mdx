...
{slot_reference: "name", value: [{value_type: "string", value_content: "Une solution basée sur une évaluation des frais, risques et avantages doit être sélectionnée."}, ]}, 
