...
{slot_reference: "name", value: [{value_type: "string", value_content: "Déployer et fournir rapidement des données de qualité relatives à la situation du patrimoine des citoyens/professionnels de sorte qu'ils puissent accomplir leurs différentes formalités"}, ]}, 
