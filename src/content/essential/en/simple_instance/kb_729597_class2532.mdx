...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI  plan d'information  consulter les données de l'application IPI  plan d'information"}, ]}, 
