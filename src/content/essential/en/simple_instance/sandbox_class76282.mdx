...
{slot_reference: "name", value: [{value_type: "string", value_content: "données des propriétaires de parcelles sur le flux de Sitran vers Urbain"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Sitran vers Urbain (données des propriétaires)"}, ]}, 
