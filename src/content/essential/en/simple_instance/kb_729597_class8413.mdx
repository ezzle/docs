...
{slot_reference: "description", value: [{value_type: "string", value_content: "CICS Transaction Server (TS) est un serveur transactionnel et une passerelle de services Web utilisés pour la gestion transactionnelle de l’application CADNET (Documentation Patrimoniale) et pour les services de la Trésorerie."}, ]}, 
