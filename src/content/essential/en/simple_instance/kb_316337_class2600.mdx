...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Télémarc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Certificat fiscal sur les marchés publics, à obtenir via Digiflow (service web)."}, ]}, 
