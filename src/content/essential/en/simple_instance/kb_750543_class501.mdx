...
{slot_reference: "name", value: [{value_type: "string", value_content: "P035 Stratégie et développement des modèles de services"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Stratégie et développement des modèles de services (P35)"}, ]}, 
