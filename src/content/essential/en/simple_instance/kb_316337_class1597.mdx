...
{slot_reference: "name", value: [{value_type: "string", value_content: "service DAFV"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion des déclarations de harcèlement et de comportements indésirables au travail."}, ]}, 
