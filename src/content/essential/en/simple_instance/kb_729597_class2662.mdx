...
{slot_reference: "name", value: [{value_type: "string", value_content: "PAYMENT : een betalingenmodule, die toelaat betalingen gelinkt aan aangiftes te beheren"}, ]}, 
