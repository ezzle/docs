...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class53"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Controleresultaten van de uitgevoerde aangiftegebonden controles op flow van Feedback naar FCP audit managed by FEEDBACK_Prod"}, ]}, 
