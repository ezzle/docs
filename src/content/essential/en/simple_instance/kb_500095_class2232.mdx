...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations statistiques sur le flux de SAS vers DNB (application externe)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "informations statistiques sur le flux de SAS vers DNB (application externe)"}, ]}, 
