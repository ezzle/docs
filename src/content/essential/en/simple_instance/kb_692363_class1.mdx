...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "referential Database (MariaDB/MySQL) managed by Organis  structuur-Organis  Structure_Prod"}, ]}, 
