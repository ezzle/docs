...
{slot_reference: "name", value: [{value_type: "string", value_content: "données obligation de retenue sur le flux de OpenICPC vers MyMinFin-Crassus"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de données de OpenICPC vers MyMinFin-Crassus pour obligation de retenue"}, ]}, 
