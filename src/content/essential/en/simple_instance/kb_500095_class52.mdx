...
{slot_reference: "name", value: [{value_type: "string", value_content: "invitations pour paiement sur le flux mensuel de taxe de circulation automatisée vers Fedopress"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux mensuel avec envoi d'invitations de paiement de Geaut VB à Fedopress pour envoyer des invitations de paiement à des personnes physiques au moins deux fois par mois"}, ]}, 
