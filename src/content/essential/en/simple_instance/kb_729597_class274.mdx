...
{slot_reference: "name", value: [{value_type: "string", value_content: "plda  gérer le dossier de litige et la (les) dette(s) associée(s) dans la base de données dettes"}, ]}, 
