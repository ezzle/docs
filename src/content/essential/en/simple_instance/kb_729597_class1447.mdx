...
{slot_reference: "name", value: [{value_type: "string", value_content: "S&amp;S module de recherche  vérifier quelles RIF’s peuvent être importants pour des  analyses futures"}, ]}, 
