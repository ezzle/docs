...
{slot_reference: "name", value: [{value_type: "string", value_content: "pourcentage TVA applicable dans un état membre spécifique sur le flux de TIC (Taxation information et communication) vers MOSS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Pourcentage de TVA applicable dans un État membre donné pour passer du TIC (Taxation information and communication) au MOSS"}, ]}, 
