...
{slot_reference: "name", value: [{value_type: "string", value_content: "Banques d'information : catalogue tabulaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit, dans un tableau interactif, la liste des banques d'informations significatives de l'organisation"}, ]}, 
