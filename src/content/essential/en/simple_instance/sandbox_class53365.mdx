...
{slot_reference: "name", value: [{value_type: "string", value_content: "VLAM.be (Application externe de l'Office Flamand d'Agro-Marketing)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application du VLAM. Le VLAM est l'Office Flamand d'Agro-Marketing, une ASBL qui assure la promotion, en Belgique et à l'étranger, des ventes, de la valeur ajoutée, de la consommation et de l'image des produits et services issus de l'agriculture, de l'horticulture, de la pêche et du secteur agro-alimentaire flamands. Le VLAM opère à la demande des entreprises et autorités flamandes, en collaboration active avec un maximum de maillons de la chaîne."}, ]}, 
