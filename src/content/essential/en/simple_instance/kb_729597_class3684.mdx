...
{slot_reference: "name", value: [{value_type: "string", value_content: "IRMA 2ième module  consulter les demandes d'information enregistrées, puis les confier à un gestionnaire de dossiers et les traiter"}, ]}, 
