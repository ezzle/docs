...
{slot_reference: "name", value: [{value_type: "string", value_content: "Livecycle (Adobe) (signer des documents pdf)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application utilisée pour signer des documents pdf."}, ]}, 
