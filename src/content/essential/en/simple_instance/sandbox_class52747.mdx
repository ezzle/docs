...
{slot_reference: "name", value: [{value_type: "string", value_content: "STIR-DU_PROD (biens des étrangers)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour fournir des données pour le programme STIRint concernant des biens des étrangers."}, ]}, 
