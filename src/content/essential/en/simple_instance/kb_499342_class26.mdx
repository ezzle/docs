...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_499342_Class27"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Bestand met opcentiemen verkeersbelasting voor gemeenten op maandelijkse flow van Geautomatiseerde VB naar GEMB (stroom naar externe niet Fod Fin applicatie) managed by Geautomatiseerde VB   TC Automatisé_PROD"}, ]}, 
