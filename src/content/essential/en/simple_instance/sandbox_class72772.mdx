...
{slot_reference: "name", value: [{value_type: "string", value_content: "db répertoire NP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db NP db répertoire"}, ]}, 
