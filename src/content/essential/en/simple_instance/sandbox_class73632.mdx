...
{slot_reference: "name", value: [{value_type: "string", value_content: "Extraction des données du véhicule (propriétaires, données du véhicule) sur le flux de TC automatisée vers DWH Mercurius, flux annuel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Extraction des données du véhicule (propriétaires, données du véhicule) de Taxe de circulation automatisée vers DWH Mercurius, flux annuel de TC Automatisé vers l'équipe dwh qui cherche les données dans Taxe de circulation automatisée"}, ]}, 
