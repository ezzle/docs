...
{slot_reference: "name", value: [{value_type: "string", value_content: "service AgentSearch (IP telephony directory)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Rechercher le numéro de téléphone et l'adresse mail des fonctionnaires dans les directories de téléphonie IP."}, ]}, 
