...
{slot_reference: "name", value: [{value_type: "string", value_content: "Applications  Distribution"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les applications, leur lieux d'utilisation ainsi que leurs interfaces."}, ]}, 
