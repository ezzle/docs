...
{slot_reference: "name", value: [{value_type: "string", value_content: "cap  gestion de l'offre de travail concernant des contrôles a posteriori (CAP) des teams CABC/SBC de l'AG D&amp;A"}, ]}, 
