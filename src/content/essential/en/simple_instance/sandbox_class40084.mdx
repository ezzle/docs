...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue des principes de l'architecture"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Énumération, par couche architecturale, des principes guidant les évolutions de l'architecture."}, ]}, 
