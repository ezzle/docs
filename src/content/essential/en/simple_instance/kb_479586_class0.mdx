...
{slot_reference: "name", value: [{value_type: "string", value_content: "Portail principal Essential Viewer"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Le portail principal pour Essential Viewer qui configure la page d'accueil. Doit être défini comme NON activé. Ne supprimez pas ce portail."}, ]}, 
