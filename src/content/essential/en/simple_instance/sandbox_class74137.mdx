...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 201:liste des biens du décédé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste des montants, titres et valeurs payables, détenus ou enregistrés, en fonction d'une succession."}, ]}, 
