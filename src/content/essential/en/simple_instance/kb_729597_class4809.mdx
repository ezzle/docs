...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  demander les rapports des coffres-fort (recherches et reporting)"}, ]}, 
