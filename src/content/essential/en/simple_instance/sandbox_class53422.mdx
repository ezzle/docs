...
{slot_reference: "description", value: [{value_type: "string", value_content: "WSO2 est du middleware SOA (Service Oriented Architecture) open source. WSO2 est remplacé par une nouvelle application, CCFF E-registry."}, ]}, 
