...
{slot_reference: "name", value: [{value_type: "string", value_content: "MOSS  reporting: un module de statistiques et reporting, qui permet de visualiser les statistiques d’utilisation du régime particulier du TVA"}, ]}, 
