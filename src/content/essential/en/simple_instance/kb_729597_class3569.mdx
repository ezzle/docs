...
{slot_reference: "name", value: [{value_type: "string", value_content: "module pour générer des statistiques des données comptables Comfor PHP"}, ]}, 
