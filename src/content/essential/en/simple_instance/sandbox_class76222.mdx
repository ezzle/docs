...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données concernant des dettes vieilles sur le flux manuel de 180b Aut vers E-forms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant des dettes vieilles sur le flux manuel de 180b Aut vers E-forms"}, ]}, 
