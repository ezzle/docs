...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  processus  catalogue par service métiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation de chaque processus selon les services métier qu'il permettent de délivrer."}, ]}, 
