...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application Java Iam, toujours en cours d'utilisation, avec Iam à la fois pour l'authentification et l'autorisation."}, ]}, 
