...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données résultats de contrôle sur des déclarations sélectionnées par SEDA pour contrôle sur le flux de Moda2 vers Monitoringtool Handhaving"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des résultats de contrôle sur des déclarations sélectionnées par SEDA pour contrôle sur le flux de Moda2 vers Monitoringtool Handhaving"}, ]}, 
