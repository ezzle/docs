...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire informations service de population"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "renseignements service de population"}, ]}, 
