...
{slot_reference: "name", value: [{value_type: "string", value_content: "données de la dette sur le flux de open icpc vers zacheus"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données de la dette sur le flux de open icpc vers zacheus"}, ]}, 
