...
{slot_reference: "name", value: [{value_type: "string", value_content: "paiements traités en ICPC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "paiements traités en ICPC"}, ]}, 
