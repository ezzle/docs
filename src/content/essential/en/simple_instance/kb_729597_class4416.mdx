...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting-outgoing payments   la gestion et l'exécution des remboursements"}, ]}, 
