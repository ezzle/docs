...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class119"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Statistieken i.v.m. geselecteerde PLDA aangiftes op flow van Seda naar Ipi Informatieplan managed by SEDA"}, ]}, 
