...
{slot_reference: "name", value: [{value_type: "string", value_content: "Dataconnectiviteit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "De service voor dataconnectiviteit verzekert de beschikbaarheid van bekabelde netwerktoegang tot het interne netwerk van de FOD Financiën vanuit een gebouw van de FOD Financiën. Deze service stoelt op de diverse netwerkcomponenten die aanwezig zijn bij de FOD Financiën, zoals Ethernet-verbindingen."}, ]}, 
