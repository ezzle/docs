...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire consolidation des actifs financiers de l'état"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fichier Excel + lettres de motivation (NL+FR)"}, ]}, 
