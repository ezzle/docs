...
{slot_reference: "name", value: [{value_type: "string", value_content: "MinfinEA : le portail public EA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L'architecture d'Entreprise aide à comprendre l'organisation globale, à identifier les opportunités et à communiquer l'architecture"}, ]}, 
