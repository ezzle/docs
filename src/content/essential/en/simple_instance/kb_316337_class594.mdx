...
{slot_reference: "name", value: [{value_type: "string", value_content: "Continuer à bâtir une organisation orientée « processus »"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Amélioration du Business Process Management (BPM) par une gestion active des processus."}, ]}, 
