...
{slot_reference: "description", value: [{value_type: "string", value_content: "TARBEL2 Relational Database on RDC's DB2 Environment tarbel2 : db2 base de données pour nouvelle version tarbel2, pas pour tarbel1"}, ]}, 
