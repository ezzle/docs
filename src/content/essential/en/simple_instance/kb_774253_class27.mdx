...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_774253_Class28"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_746088_Class1"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Lijst invoeraangiftes mbt vergunde operatoren op flow van plda naar sasp managed by PLDA"}, ]}, 
