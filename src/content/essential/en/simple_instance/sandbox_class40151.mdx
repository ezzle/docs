...
{slot_reference: "name", value: [{value_type: "string", value_content: "Domaine technologique : résumé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit une vue synthétique des  principales relations d'un domaine technologique"}, ]}, 
