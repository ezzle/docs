...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résumé d'étape de l'évolution applicative"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les détails des principales relations de l'étape applicative sélectionnée."}, ]}, 
