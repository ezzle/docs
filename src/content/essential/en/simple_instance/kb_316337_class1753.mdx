...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Versements anticipés"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de gestion des versements anticipés; application des versements anticipés au mainframe gcos8."}, ]}, 
