...
{slot_reference: "name", value: [{value_type: "string", value_content: "service CVVEN"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de l' AG Fisc pour la validation centrale des supports de données (VENB, RPB, BNI-Ven)."}, ]}, 
