...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue applicatif  tableau"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des applications utilisées dans l'organisation."}, ]}, 
