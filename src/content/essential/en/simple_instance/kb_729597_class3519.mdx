...
{slot_reference: "name", value: [{value_type: "string", value_content: "180B AUT  suivi des vieilles dettes et des dettes enrôlées d'une manière non automatique (voir ICPC)"}, ]}, 
