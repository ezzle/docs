...
{slot_reference: "name", value: [{value_type: "string", value_content: "Flux Bilan fiscal"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux Bilan fiscal"}, ]}, 
