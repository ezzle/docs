...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class81"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens over Multinationale Ondernemingen (MNE’s) i.v.m. Dir. Belastingen op flow van ccn1 naar Stirint CBC managed by CCN gateway 1"}, ]}, 
