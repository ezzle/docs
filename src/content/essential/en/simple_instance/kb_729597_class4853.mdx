...
{slot_reference: "name", value: [{value_type: "string", value_content: "STATIS  Publication en libre accès des décisions, des notes de travail et des fichiers d'archives divers"}, ]}, 
