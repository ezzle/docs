...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résumé d'une étape métiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les principales relations de l'étape stratégique d'affaire sélectionnée."}, ]}, 
