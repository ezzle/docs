...
{slot_reference: "name", value: [{value_type: "string", value_content: "STATIS  beheer van een volledige historische documentatie over het notariaat"}, ]}, 
