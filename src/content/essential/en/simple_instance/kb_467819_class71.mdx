...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_467819_Class72"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Intracommunautaire gegevens ontvangen van andere landen op flow van Viesclient naar Stir TVA managed by VIESClient_PROD"}, ]}, 
