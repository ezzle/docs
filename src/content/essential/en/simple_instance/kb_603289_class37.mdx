...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_603289_Class38"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "authenticatiegegevens op flow van Locostat naar Ldap managed by CADNET LOCOSTAT _PROD"}, ]}, 
