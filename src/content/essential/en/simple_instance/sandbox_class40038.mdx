...
{slot_reference: "name", value: [{value_type: "string", value_content: "Technologie  Feuille de route"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation graphique du déroulement d'un évolution à partir d'une architecture de départ vers une architecture cible."}, ]}, 
