...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Dêpot de la déclaration"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Service applicatif permettant de rentrer une ou plusieures déclarations au SPF Finances"}, ]}, 
