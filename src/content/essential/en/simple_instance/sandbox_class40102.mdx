...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  processus  synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétisée des attributs et principales relations pour chaque processus d'affaire"}, ]}, 
