...
{slot_reference: "name", value: [{value_type: "string", value_content: "Reprendre la coordination transversale de la gestion des connaissances pour le SPF Finances."}, ]}, 
