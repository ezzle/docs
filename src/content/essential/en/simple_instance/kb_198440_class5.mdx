...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_198440_Class6"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info validatie Ncts aangifte via check in Goodsflow op flow van PLDA Goodsflow naar NCTS (toekomst naar Ncts RW) managed by PLDA GOODSFLOW_PROD"}, ]}, 
