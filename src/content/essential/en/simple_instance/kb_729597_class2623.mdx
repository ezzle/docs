...
{slot_reference: "name", value: [{value_type: "string", value_content: "Feedback  formulaire de feedback pour le reporting sur les résultats de contrôle des contrôles exécutés pour les types suivants des déclarations: le document unique à l'importation (IM, EU, CO) et à l'exportation (EX, EU, CO), la déclaration sommaire à l'entrée (ENS) et à la sortie (EXS), transit communautaire externe (T1),  transit communautaire interne (T2) et le manifeste de frêt maritime ou aérien"}, ]}, 
