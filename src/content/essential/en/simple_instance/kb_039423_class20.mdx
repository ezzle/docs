...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "taric is naam van de europese databank Tarbel"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "taric Database (MariaDB/MySQL) managed by TARBEL_PROD"}, ]}, 
