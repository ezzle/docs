...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class135"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "identificatiegegevens rond buitenlandse adressen op flow van Sitran naar Stirint BEPS CBC managed by SITRAN"}, ]}, 
