...
{slot_reference: "name", value: [{value_type: "string", value_content: "Développer la gestion coordonnée des frontières avec les autres organisations de controle"}, ]}, 
