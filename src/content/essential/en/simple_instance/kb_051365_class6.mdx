...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application, construite sur la plateforme ACM, pour la gestion des contacts clients. Synonyme de workflow de gestion client ACM. Remplace l'application CRM."}, ]}, 
