...
{slot_reference: "name", value: [{value_type: "string", value_content: "NCTS-la gestion des garanties électroniques qui peuvent être utilisé dans NCTS"}, ]}, 
