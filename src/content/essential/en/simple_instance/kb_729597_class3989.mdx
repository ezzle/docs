...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool Handhaving  calcul des points de mesure (codes IPI) concernant la gestion de maintien de l’ordre sur base des données de l'application Monitoringtool Handhaving"}, ]}, 
