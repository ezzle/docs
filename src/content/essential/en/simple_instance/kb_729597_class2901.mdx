...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  Raadpleging door ESS van volledige situatie BV m.b.t. aangesloten werkgevers: niet alleen BV-aangiftes raadplegen die het ESS zelf indiende, maar ook BV-aangiftes ingediend door de werkgever zelf"}, ]}, 
