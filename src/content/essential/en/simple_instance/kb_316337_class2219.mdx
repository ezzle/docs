...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PCIWECC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PCIWECC est une application de la Douane et Accises: application sur PC (local)."}, ]}, 
