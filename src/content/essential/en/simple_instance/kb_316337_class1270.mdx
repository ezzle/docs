...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Calcul IPP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Calcul et enrôlement de l'impôt des personnes physiques (y compris les non résidents)"}, ]}, 
