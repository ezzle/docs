...
{slot_reference: "name", value: [{value_type: "string", value_content: "P051 Services internes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "?? Services internes (P51)"}, ]}, 
