...
{slot_reference: "name", value: [{value_type: "string", value_content: "service CONTACT"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste de téléphone 'intranet' pour la recherche des coordonnées d’un collègue."}, ]}, 
