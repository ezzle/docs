...
{slot_reference: "description", value: [{value_type: "string", value_content: "Encodage dans la base de données sur la base de la preuve d'ouverture du compte garantie locative fournie par le locataire."}, ]}, 
