...
{slot_reference: "name", value: [{value_type: "string", value_content: "Prendre des initiatives pour garantir la sécurisation des bâtiments via la poursuite de l’installation des contrôles d’accès"}, ]}, 
