...
{slot_reference: "name", value: [{value_type: "string", value_content: "Bi Portail_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Portail pour afficher les rapports Microsoft BI (Business Intelligence). Ce n'est plus utilisé."}, ]}, 
