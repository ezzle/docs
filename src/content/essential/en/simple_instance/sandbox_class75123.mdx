...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire modèle 1  fiche de renseignements avec les données d'addresse, échelle le traitement, situation fiscale…lors d'une entrée en service d'un membre du personnel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "fiche de renseignements avec les données d'addresse, échelle de traitement, situation fiscale lors d'une entrée en service d'un membre du personnel."}, ]}, 
