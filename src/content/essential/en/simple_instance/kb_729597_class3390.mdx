...
{slot_reference: "name", value: [{value_type: "string", value_content: "cash  consultation du détail des formulaires de déclaration de l'argent et de constatations connexes éventuels"}, ]}, 
