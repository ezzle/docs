...
{slot_reference: "name", value: [{value_type: "string", value_content: "site web général cdib  module de recherches pour retrouver les licence des établissement d'accises"}, ]}, 
