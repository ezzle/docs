...
{slot_reference: "name", value: [{value_type: "string", value_content: "documents sur le flux de VAT Refund vers Filenet document store Stirint"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "documents sur le flux de VAT Refund vers Filenet document store Stirint"}, ]}, 
