...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros de comptes financiers sur le flux de BTM vers Codamerger"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de BTM vers Codamerger (numéros de comptes financiers)"}, ]}, 
