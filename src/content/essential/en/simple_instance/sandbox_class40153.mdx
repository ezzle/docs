...
{slot_reference: "name", value: [{value_type: "string", value_content: "Bibliothèque des vues"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Explorer, par domaine architectural, l'ensemble des vues disponibles."}, ]}, 
