...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_149316_Class1"}, ]}, 
{slot_reference: "app_pro_persists_info_rep", value: [{value_type: "boolean", value_content: "false"}, ]}, 
{slot_reference: "used_in_app_dependencies", value: [{value_type: "simple_instance", value_content: "KB_149316_Class11"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flux de SAS vers EANDIS (Application Externe)"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Statistische informatie op flow van SAS naar EANDIS (externe applicatie) managed by SAS"}, ]}, 
