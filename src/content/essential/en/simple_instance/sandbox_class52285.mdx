...
{slot_reference: "description", value: [{value_type: "string", value_content: "composant financial de l'application PLDA après la Composantisation de PLDA."}, ]}, 
