...
{slot_reference: "name", value: [{value_type: "string", value_content: "site web général cdib  module de recherche pour les données Belges SEED"}, ]}, 
