...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant des autorisations mentionnées sur des déclarations d'importation ICS sur le flux de ICS vers AEO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de ICS vers Aeo via le webservice AEO sur Datapower Esb pour vérifier les autorisations AEO figurant sur la déclaration d'importation (ICS_UC012  validate and Régistre diversion request)"}, ]}, 
