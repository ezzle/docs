...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant les numéros des pseudo-articles sur le flux de PRI vers DXSI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant pseudo-numéro d'articles sur le flux de PRI vers DXSI"}, ]}, 
