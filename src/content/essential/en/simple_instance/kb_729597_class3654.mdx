...
{slot_reference: "name", value: [{value_type: "string", value_content: "IRMA 1er module  faire des demandes d'information au Service gestion de données incl. consulter l'historique des demandes et des réponses"}, ]}, 
