...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_774253_Class61"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Plda aangiftes geselecteerd voor controle (uit sps fiches) op flow van consultatie sps naar plda managed by CONSULTATIE SPS FICHES-CONSULTATION FICHES SPS_Prod"}, ]}, 
