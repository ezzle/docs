...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs_Prod  module listing général  consultation listing Bic = dettes par type d'impôt"}, ]}, 
