...
{slot_reference: "name", value: [{value_type: "string", value_content: "données des déclarations PLDA sur le flux de PLDA vers MOSS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur données des déclarations PLDA sur le flux de PLDA vers MOSS"}, ]}, 
