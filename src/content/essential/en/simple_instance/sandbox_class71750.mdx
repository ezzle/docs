...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données comptables (sur la base desquelles les statistiques sont générées par Comfor Java) sur le flux de Comfor PHP vers Comfor java"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données comptables (sur la base desquelles les statistiques sont générées par Comfor Java) sur le flux de Comfor PHP à Comfor java"}, ]}, 
{slot_reference: "system_content_lifecycle_status", value: [{value_type: "simple_instance", value_content: "KB_229567_Class67"}, ]}, 
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class81090"}, ]}, 
