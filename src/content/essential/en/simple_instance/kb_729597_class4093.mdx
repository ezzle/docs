...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  manuellement modifier la date de restitution (gérer les restitutions)"}, ]}, 
