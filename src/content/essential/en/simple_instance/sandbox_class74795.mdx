...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande d'une autorisation européenne chez AG D&amp;A"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Demande d'autorisation d'utiliser la déclaration de transit avec un ensemble restreint de données : article 233, paragraphe 4, point d), du code"}, ]}, 
