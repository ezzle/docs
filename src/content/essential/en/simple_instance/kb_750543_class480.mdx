...
{slot_reference: "name", value: [{value_type: "string", value_content: "P038 Expertise opérationnelle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Expertise opérationnelle (P38)"}, ]}, 
