...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclaration périodique TVA et relevés intracommunautaires sur le flux de STIR  TVA vers Viesclient"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de STIR  TVA vers Viesclient inclut:  déclarations périodiques de TVA  les déclarations intracommunautaires sont envoyées par lots par STIR-TVA vers VIES (les déclarations intracommunautaires sont déposées dans Intervat, puis transmises à STIR-TVA et ensuite à VIES)."}, ]}, 
