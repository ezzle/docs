...
{slot_reference: "name", value: [{value_type: "string", value_content: "service EPO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "McAfee ePolicy Orchestrator ( security management software) Gestion et configuration de l'antirvirus."}, ]}, 
