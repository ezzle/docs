...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données déclarations TVA sur le flux d'Intervat vers Entité Spécifique TVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données de déclaration TVA sur le flux d'Intervat vers Entité Spécifique TVA"}, ]}, 
