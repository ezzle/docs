...
{slot_reference: "name", value: [{value_type: "string", value_content: "Processus physique  catalogue par domaine"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation par domaine de chaque processus métiers."}, ]}, 
