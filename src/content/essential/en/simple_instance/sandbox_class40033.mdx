...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application Service applicatif Interaction parties intéressées"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les interaction entre les services applicatifs et les rôles métiers."}, ]}, 
