...
{slot_reference: "name", value: [{value_type: "string", value_content: "TC Automatisée  VBDIS9  transaction qui donne lieu à une taxation d'ecomalus"}, ]}, 
