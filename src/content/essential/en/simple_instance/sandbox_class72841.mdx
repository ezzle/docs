...
{slot_reference: "name", value: [{value_type: "string", value_content: "db précompte mobilier EURO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db précompte mobilier EURO"}, ]}, 
