...
{slot_reference: "name", value: [{value_type: "string", value_content: "service web Tax on web: flux de TAX on WEB vers Stirint Autodt"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "webservice Tax on web: flux de TAX on WEB vers Stirint Autodt"}, ]}, 
