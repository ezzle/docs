...
{slot_reference: "name", value: [{value_type: "string", value_content: "données dettes sur le flux de Open Icpc vers My Minfin"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données dettes sur le flux de Open Icpc vers My Minfin"}, ]}, 
