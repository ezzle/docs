...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "332terB demande de renseignement à un tiers bancaire managed by BizTaxBO_PROD"}, ]}, 
