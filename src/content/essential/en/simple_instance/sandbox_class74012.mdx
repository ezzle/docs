...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire autorisation /EORI/A2: identification de l'opérateur économique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulaire d'admission à la publication sur le site EORI de TAXUD des données relatives aux sociétés ou personnes auxquelles un numéro EORI a déjà été attribué."}, ]}, 
