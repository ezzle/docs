...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_612043_Class70"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Nrs. van percelen betrokken in de contentieux van AG Fisc op flow van Regondes 2 naar Contentieux over ESB managed by Regondes2_Prod"}, ]}, 
