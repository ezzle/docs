...
{slot_reference: "name", value: [{value_type: "string", value_content: "forprou Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "forprou Relational Database on MariaDB/MySQL Environment"}, ]}, 
