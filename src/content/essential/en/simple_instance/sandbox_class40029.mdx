...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application  synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit une vue synthétique des relations principales d'une capacité applicative."}, ]}, 
