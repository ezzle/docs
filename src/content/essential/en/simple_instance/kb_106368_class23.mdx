...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class24"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info geldige vergunningen accijnsinrichtingen op Flow van Accijnsinrichtingen naar Faco updater managed by Accijnsinrichtingen-Etablissements d'accises_Prod"}, ]}, 
