...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service CDIS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application centrale pour le stockage de documents, fournissant des solutions pour les requêtes de documents, la sécurité et la gestion des archives."}, ]}, 
