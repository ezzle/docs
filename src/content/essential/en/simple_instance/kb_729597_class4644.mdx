...
{slot_reference: "name", value: [{value_type: "string", value_content: "VAT Board : aperçu de l'information concernant la signalétique du contribuable TVA (Stir TVA et Stiron TVA)"}, ]}, 
