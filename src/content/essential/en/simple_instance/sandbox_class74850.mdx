...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande pour modification du numéro de compte"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demande pour modification du numéro de compte"}, ]}, 
