...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire pour demande d’une révision spéciale (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulaire pour demande d’une révision spéciale (AG DocPat)"}, ]}, 
