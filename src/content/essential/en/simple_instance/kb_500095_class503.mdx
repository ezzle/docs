...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de l'historique des remboursements des versements anticipés par application VA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de l'historique des remboursements des versements anticipés par application VA"}, ]}, 
