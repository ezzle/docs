...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations concernant les frontières sur le flux de Cadgis vers Euroboundaries (manuel)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Cadgis vers  Euroboundaries (manuel):  une partie des données de l'annuaire Euroboundaries est utilisée par CadGis pour définir les frontières de la Belgique."}, ]}, 
