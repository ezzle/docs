...
{slot_reference: "name", value: [{value_type: "string", value_content: "information de taxation impôts directs pour non résidents sur le flux de Stirint OCDE vers Stirint DLO (et alors à partir de DLO vers CCN)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "information de taxation impôts directs pour non résidents sur le flux de Stirint OCDE vers Stirint DLO (et alors à partir de DLO vers CCN). OCDE n'a pas de lien direct avec le CCN, seulement indirectement via DLO"}, ]}, 
