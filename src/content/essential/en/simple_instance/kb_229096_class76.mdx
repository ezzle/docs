...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class77"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "hyperlink op flow van Informatieplan naar Website G&amp;I managed by IPI Informatieplan-Plan d'information_Prod"}, ]}, 
