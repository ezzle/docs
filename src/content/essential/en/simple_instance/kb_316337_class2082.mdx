...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Management Meow"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L'application de AA Padoc Direction MEOW pour le traitement des données statistiques 
