...
{slot_reference: "name", value: [{value_type: "string", value_content: "service horaires des travailleurs postés"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Nouvelle application développée par AA D&amp;A pour les horaires des travailleurs postés"}, ]}, 
