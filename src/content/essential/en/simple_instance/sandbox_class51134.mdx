...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application Dexia"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Dexia : dans cette application, les données de fraude sont conservées, elles ne sont plus mis à jour (retired)."}, ]}, 
