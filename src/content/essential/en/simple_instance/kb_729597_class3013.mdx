...
{slot_reference: "name", value: [{value_type: "string", value_content: "Hypo index  sauvegarder des pdf's des actes et/ou des analyses dans Filenet, à partir d'un dossier au choix de l'utilisateur"}, ]}, 
