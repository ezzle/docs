...
{slot_reference: "name", value: [{value_type: "string", value_content: "service DAVE"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour les enregistrations des autorisations à la Douane."}, ]}, 
