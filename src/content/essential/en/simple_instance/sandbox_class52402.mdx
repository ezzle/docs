...
{slot_reference: "name", value: [{value_type: "string", value_content: "Quadrox_Prod (système de surveillance video)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application concernant les serveurs Quadrox : pour un système de surveillance video (5 serveurs)."}, ]}, 
