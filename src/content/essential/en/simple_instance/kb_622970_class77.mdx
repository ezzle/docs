...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_622970_Class78"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Venale waarden op Flow van Locostat Expert Archive naar Locostat managed by Locostat expert archive"}, ]}, 
