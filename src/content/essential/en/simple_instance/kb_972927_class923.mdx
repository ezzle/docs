...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "FI  Envoi du feedback à l'Etranger managed by STIRint  DLO_PROD"}, ]}, 
