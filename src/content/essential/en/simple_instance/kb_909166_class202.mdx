...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class203"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "notificaties, aanslagbiljetten niet inwoners (voor de directe belastingen) op flow van stirint DLO naar Myscan managed by STIRint  DLO_PROD"}, ]}, 
