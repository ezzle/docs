...
{slot_reference: "name", value: [{value_type: "string", value_content: "Augmenter l'efficacité des contrôles basés sur le modèle mathématique"}, ]}, 
