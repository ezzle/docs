...
{slot_reference: "name", value: [{value_type: "string", value_content: "dettes ouvertes sur le flux de Stiron L2-CC (compte courant TVA) vers Gestion Des Debiteurs pour traitement mensuel, flux mensuel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Dettes TVA ouvertes Compte courant sur flux mensuel de Stiron L2-CC vers Gestion des Débiteurs pour traitement, fichier plat mensuel"}, ]}, 
{slot_reference: "system_content_lifecycle_status", value: [{value_type: "simple_instance", value_content: "KB_229567_Class67"}, ]}, 
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class78828"}, ]}, 
