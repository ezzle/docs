...
{slot_reference: "name", value: [{value_type: "string", value_content: "service IPMAF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Création fichiers pour l'INAMI. Application Standalone Java + Cobol."}, ]}, 
