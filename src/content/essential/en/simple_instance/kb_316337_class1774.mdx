...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Licenses D&amp;A"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Base de données de référence pour les licences délivrées par les autorités douanières. DB2."}, ]}, 
