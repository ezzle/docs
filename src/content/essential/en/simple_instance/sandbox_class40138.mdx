...
{slot_reference: "name", value: [{value_type: "string", value_content: "Donnée sujet : modèle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation graphique des attributs ou relations d'une donnée sujet conceptuelle"}, ]}, 
