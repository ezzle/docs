...
{slot_reference: "name", value: [{value_type: "string", value_content: "scans sur le flux de MyScan vers Filenet"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de MyScan vers Filenet Les scans sont placés directement dans Filenet (dans les datastores) à l'aide de l'application myscan."}, ]}, 
