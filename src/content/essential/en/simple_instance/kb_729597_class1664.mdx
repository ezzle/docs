...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  generieke module  beheer kosten  UC  31-62 behandeling verschuldigde kosten door de staat"}, ]}, 
