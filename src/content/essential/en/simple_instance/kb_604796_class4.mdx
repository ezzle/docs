...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_149316_Class16"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flux de SAS vers DNB (Application Externe)"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Statistische informatie op flow van SAS naar DNB (externe applicatie) managed by SAS"}, ]}, 
