...
{slot_reference: "name", value: [{value_type: "string", value_content: "dossier de succession"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dossier de succession"}, ]}, 
