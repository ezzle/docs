...
{slot_reference: "name", value: [{value_type: "string", value_content: "Ecoboni  consulter les données de la licence pour les emballages réutilisables (avec consignes)"}, ]}, 
