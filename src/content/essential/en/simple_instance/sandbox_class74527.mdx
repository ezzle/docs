...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 325.25TU:relevé récapitulatif"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "État récapitulatif des attestations 281.25 établies par le même service."}, ]}, 
