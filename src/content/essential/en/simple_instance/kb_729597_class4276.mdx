...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  créer une demande pour restitution (traiter les demandes des bénéficiaires)"}, ]}, 
