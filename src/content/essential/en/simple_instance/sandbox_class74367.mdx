...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 281.00: compagnies d'assurance"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fiche individuelle relative à diverses informations spécifiques à fournir par les compagnies d'assurance."}, ]}, 
