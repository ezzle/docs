...
{slot_reference: "name", value: [{value_type: "string", value_content: "Numéros de compte financier_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des numéros de compte sur lesquels sont versés les remboursements d'impôts directs."}, ]}, 
