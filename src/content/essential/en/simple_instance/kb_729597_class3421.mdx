...
{slot_reference: "name", value: [{value_type: "string", value_content: "Niet Geaut VB  informatieve rappels die de houder van een voertuig erop attent maken dat voertuig aangegeven moet worden vanaf inverkeerstelling"}, ]}, 
