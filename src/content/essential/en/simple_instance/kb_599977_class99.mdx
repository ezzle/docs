...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_599977_Class100"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "vrijgave-status van containers op manuele flow van ccrm naar s&amp;s (manuele check via s&amp;s in ccrm) managed by CCRM_PROD"}, ]}, 
