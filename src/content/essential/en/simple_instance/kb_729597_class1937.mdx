...
{slot_reference: "name", value: [{value_type: "string", value_content: "ESB_PROD mettre à disposition des services, couche de sécurité, log d'audit"}, ]}, 
