...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_425693_Class100"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Notarislijst op flow van Statis naar DER (via human interface) managed by STATIS_Prod"}, ]}, 
