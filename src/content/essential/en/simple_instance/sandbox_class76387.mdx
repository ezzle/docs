...
{slot_reference: "name", value: [{value_type: "string", value_content: "données des déclarations périodiques TVA venant de Intervat sur le flux de STIR-TVA_PROD vers VLAM.be (Externe)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des déclarations périodiques TVA venant de Intervat sur le flux de STIR-TVA_PROD vers VLAM.be (Externe)"}, ]}, 
