...
{slot_reference: "name", value: [{value_type: "string", value_content: "données des véhicules sur le flux de DIV SPF Mobilité vers Mobivis (et alors vers Sitran?) (service web Mobivis) (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "webservice Mobivis : données des véhicules sur le flux de DIV SPF Mobilité vers Mobivis et alors vers Sitran  (flux vers application externe non SPF Finances)"}, ]}, 
