...
{slot_reference: "name", value: [{value_type: "string", value_content: "données Risk Information Forms sur le flux de RIF vers module de recherche S&amp;S"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données Risk Information Forms sur le flux de RIF vers module de recherche S&amp;S"}, ]}, 
