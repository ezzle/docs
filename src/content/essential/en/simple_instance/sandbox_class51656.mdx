...
{slot_reference: "name", value: [{value_type: "string", value_content: "Hypo_filenet_WS (service web de l' objectstore filenet de hypo)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Filenet object store de l'application Hypo"}, ]}, 
