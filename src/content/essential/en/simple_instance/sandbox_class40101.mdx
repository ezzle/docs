...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  Modèle de référence"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Modèle de référence général des capacités métiers significatives pour l'organisation."}, ]}, 
