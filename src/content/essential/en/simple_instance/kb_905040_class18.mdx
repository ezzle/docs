...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Inkohieringen PersonenBelasting op flow van icpc naar calcul ipp managed by ICPC_PROD"}, ]}, 
