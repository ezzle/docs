...
{slot_reference: "name", value: [{value_type: "string", value_content: "Obtenir l'accès à la Banque de données nationale générale (BDN) de la Police"}, ]}, 
