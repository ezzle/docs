...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de la fiche de solvabilité par application de recouvrement solvency file"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de la fiche de solvabilité par application de recouvrement solvency file"}, ]}, 
