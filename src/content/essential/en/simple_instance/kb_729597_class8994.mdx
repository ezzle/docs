...
{slot_reference: "description", value: [{value_type: "string", value_content: "Le Process Management Service Filenet offre des fonctionnalités pour la gestion électronique des processus business, définition et exécution de workflows, pour l’application STIPAD."}, ]}, 
