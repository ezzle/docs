...
{slot_reference: "name", value: [{value_type: "string", value_content: "Analyser les processus et répertorier les risques et les mesures de contrôle"}, ]}, 
