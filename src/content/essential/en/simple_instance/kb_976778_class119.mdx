...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_976778_Class120"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "nformatie betreffende de controleresultaten van de uitgevoerde aangiftegebonden controles op flow van feedback naar informatieplan managed by FEEDBACK_Prod"}, ]}, 
