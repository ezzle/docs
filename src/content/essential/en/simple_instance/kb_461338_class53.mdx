...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_461338_Class54"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Taken op flow van Moss naar Taskmgr. managed by Mini One Stop Shop Back Office_prod (MOSS)"}, ]}, 
