...
{slot_reference: "name", value: [{value_type: "string", value_content: "fichier xml pour traitement en lot des voitures importées sur le flux de Geaut VB vers application Vignetten 705"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "fichier xml pour traitement en lot des voitures importées sur le flux de TC automatisée vers application Vignetten 705"}, ]}, 
