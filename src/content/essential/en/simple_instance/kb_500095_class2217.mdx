...
{slot_reference: "name", value: [{value_type: "string", value_content: "données statistiques sur le flux de Shape vers Statis"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données statistiques sur le flux de Shape vers Statis"}, ]}, 
