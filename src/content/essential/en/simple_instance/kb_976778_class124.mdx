...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_976778_Class125"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info voor statistieken D&amp;A op flow van informatieplan naar cognos managed by IPI Informatieplan-Plan d'information_Prod"}, ]}, 
