...
{slot_reference: "name", value: [{value_type: "string", value_content: "statistiques concernant déclarations de mouvements entre entrepôts fiscaux des biens sous accises sur le flux de Emcs vers IPI plan d'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "statistiques concernant des déclarations de mouvements entre entrepôts fiscaux des biens sous accises sur le flux de Emcs vers IPI plan d'information"}, ]}, 
