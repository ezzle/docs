...
{slot_reference: "name", value: [{value_type: "string", value_content: "données personnelles sur le flux de Sitran vers CRT CRH (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Sitran vers CRT CRH (flux vers application externe non SPF Finances)"}, ]}, 
