...
{slot_reference: "name", value: [{value_type: "string", value_content: "fichier xml avec missions et coûts des actes assignés sur le flux de First Recovery vers First"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "fichier xml avec missions et coûts des actes assignés sur le flux de First Recouvrement vers First"}, ]}, 
