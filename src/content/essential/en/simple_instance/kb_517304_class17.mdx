...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_517304_Class18"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_517304_Class33"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie op flow van Euroboundaries naar Cadgis (human interface) managed by Euroboundaries_PROD"}, ]}, 
