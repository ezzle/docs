...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification concernant des addresses étrangères sur le flux de Sitran vers Fatca"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données d'identification concernant des addresses étrangères sur le flux de Sitran vers Fatca"}, ]}, 
