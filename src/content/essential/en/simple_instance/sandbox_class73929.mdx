...
{slot_reference: "name", value: [{value_type: "string", value_content: "inschrijvingsformulier garantieregister"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Inschrijvingsformulieren voor garantieregisters EN_NL"}, ]}, 
