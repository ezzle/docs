...
{slot_reference: "name", value: [{value_type: "string", value_content: "Jugements de faillite sur le flux de Fail manager (application externe du SPF Justice) vers SP10B"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Jugements de faillite sur le flux du failmanager (application externe non SPF Fin, Justice) vers SP10B"}, ]}, 
