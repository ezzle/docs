...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Trésorie compte courant  Ajouter des fonds sur un compte propre ou dans un dossier ouvert sur un compte de tiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "compte courant  Ajouter des fonds sur un compte propre ou dans un dossier ouvert sur un compte de tiers"}, ]}, 
