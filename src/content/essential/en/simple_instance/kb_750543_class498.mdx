...
{slot_reference: "name", value: [{value_type: "string", value_content: "Compréhension des clients (p32)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette capability intervient dans des domaines tels que les Taxes, les Douanes et les Accises et les Services du Président."}, ]}, 
