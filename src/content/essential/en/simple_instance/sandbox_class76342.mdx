...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données diesel professionel sur le flux manuel de PDIE vers E-forms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données Professionele diesel sur le flux manuel de PDIE vers E-Forms"}, ]}, 
