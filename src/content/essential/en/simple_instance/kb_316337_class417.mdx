...
{slot_reference: "name", value: [{value_type: "string", value_content: "Elaborer un datawarehouse central afin de pouvoir utiliser, de manière optimale et la plus efficace possible, les données et l'analyse de données lors de la détection des risques de fraude"}, ]}, 
