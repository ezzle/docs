...
{slot_reference: "name", value: [{value_type: "string", value_content: "données bureaux de recette sur le flux de GRA vers Taxe de Circulation automatisée"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux pour chercher les données des bureaux de recette de GRA vers Taxe de Circulation Automatisée (nom, adresse, numéro de compte)"}, ]}, 
