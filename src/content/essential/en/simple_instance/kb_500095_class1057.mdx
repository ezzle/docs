...
{slot_reference: "name", value: [{value_type: "string", value_content: "information parcellaire sur le flux de Cadgis vers Intranet"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "information parcellaire sur le flux de Cadgis vers Intranet"}, ]}, 
