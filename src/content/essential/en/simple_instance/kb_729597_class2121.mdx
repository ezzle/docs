...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA dashboard  bewaren van commentaren voor een operator en een aantal andere criteria voor het overmaken van info tussen leden van eenzelfde CRC of tussen CRC's."}, ]}, 
