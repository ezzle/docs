...
{slot_reference: "name", value: [{value_type: "string", value_content: "Lancer un benchmarking comparatif externe avec nos partenaires (Pays-Bas, Allemagne et France)"}, ]}, 
