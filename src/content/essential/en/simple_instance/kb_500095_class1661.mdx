...
{slot_reference: "name", value: [{value_type: "string", value_content: "soldes coûts de poursuite huissiers sur le flux d'ICPC vers PC-FRMS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "soldes coûts de poursuite huissiers sur le flux d'ICPC vers PC-FRMS"}, ]}, 
