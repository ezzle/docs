...
{slot_reference: "name", value: [{value_type: "string", value_content: "Étape stratégique : résumé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Synthèse des principales relation d'une étape stratégique."}, ]}, 
