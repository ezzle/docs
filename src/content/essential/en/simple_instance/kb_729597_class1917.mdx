...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat volledige db attribuer des droits d'accès inférieurs à l'application Agristat 4"}, ]}, 
