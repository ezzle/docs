...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service listes de gestion CRN Personnes Physiques"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Listes de gestion permettant un suivi détaillé de l'évolution des travaux d'évaluation"}, ]}, 
