...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  traitements des remboursements  UC 08-20 suivi des débits de comptes bancaires"}, ]}, 
