...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données GDPR (données signalétiques) sur le flux de IAM2015 vers Easyval"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux GDPR données de IAM2015 vers Easyval"}, ]}, 
