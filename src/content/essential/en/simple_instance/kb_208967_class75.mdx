...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class76"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "financiële inlichtingen Directe Belastingen op flow van stirint crs naar stirint bbi managed by STIRint  CRS_PROD"}, ]}, 
