...
{slot_reference: "name", value: [{value_type: "string", value_content: "Evaluer l’organisation interne pour le traitement de la lutte contre le blanchiment et le financement du terrorisme et la prolifération des armes de destruction massive"}, ]}, 
