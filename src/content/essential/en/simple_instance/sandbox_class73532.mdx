...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros Eori  sur le flux d'EORI vers EMCS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux entre EORI et EMCS pour verification des numéros EORI"}, ]}, 
