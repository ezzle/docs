...
{slot_reference: "name", value: [{value_type: "string", value_content: "Inventorier les différentes applications ICT qui sont actuellement utilisées dans les différents services et harmoniser ces applications"}, ]}, 
