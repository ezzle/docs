...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire récupérer les fonds si héritier connu de la CDC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Récupérer les fonds si héritiers sont connus de la CDC"}, ]}, 
