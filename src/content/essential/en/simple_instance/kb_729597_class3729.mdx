...
{slot_reference: "name", value: [{value_type: "string", value_content: "TC Automatisée  “VBTPU” fichier pour le calcul des totaux imputés journaliers et mensuels"}, ]}, 
