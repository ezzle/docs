...
{slot_reference: "name", value: [{value_type: "string", value_content: "service ingenico"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Solution de paiement par carte de debit pour petits clients"}, ]}, 
