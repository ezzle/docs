...
{slot_reference: "name", value: [{value_type: "string", value_content: "flux de Doctran vers Vatboard"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de doctran vers VAT Board VATboard est une application, faite en angulaire, qui permet de consulter un aperçu de la situation fiscale d'un contribuable TVA. Incluant une liste de documents dans filenet/doctran."}, ]}, 
