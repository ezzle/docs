...
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulier sterkmaking waarin de erfgenaam verklaart in te staan voor de verdeling"}, ]}, 
