...
{slot_reference: "description", value: [{value_type: "string", value_content: "Module transversal permettant de déterminer chez quelle administration une personne travaille."}, ]}, 
