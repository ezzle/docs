...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  Isabel  interpréter des relevés des comptes numériques (Coda) et générer des missions pour paiements sortants (Unifi)"}, ]}, 
