...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI dashboard  aperçu du nombre de KPI's atteints/ non atteints (= points de mesure)"}, ]}, 
