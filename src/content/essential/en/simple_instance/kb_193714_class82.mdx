...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Berekend bedrag personenbelasting en rekeningnummer op flow van Calcul ipp naar Towsimul (webservice) managed by Calcul IPP  Aanslagjaar 2020_PROD"}, ]}, 
