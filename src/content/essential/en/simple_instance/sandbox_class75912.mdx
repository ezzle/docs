...
{slot_reference: "name", value: [{value_type: "string", value_content: "extraits automatisées sur le flux de Respo vers STATIS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Respo vers Statis Interface Statis : extraits automatisées livrées"}, ]}, 
