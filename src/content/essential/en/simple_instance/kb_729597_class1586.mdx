...
{slot_reference: "name", value: [{value_type: "string", value_content: "cap  possibilité pour actualiser le status de l'offre du travail, pour une ou plusieurs déclarations sélectionnées, d'une manière intuitive"}, ]}, 
