...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_308871_Class89"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Authenticatie-informatie op flow van Dir services oracle naar Doctran managed by DirectoryServicesOracle"}, ]}, 
