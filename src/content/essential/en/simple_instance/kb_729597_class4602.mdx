...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  Status BV-aangifte aangevuld in de db (bv. als vergissing in aangifte rechtgezet)."}, ]}, 
