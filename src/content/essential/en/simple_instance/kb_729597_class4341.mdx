...
{slot_reference: "name", value: [{value_type: "string", value_content: "First PPWT-TPW  Common declaration  précompte mobilier sur les recettes des biens mobiliers et des capitaux"}, ]}, 
