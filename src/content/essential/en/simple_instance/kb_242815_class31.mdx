...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_242815_Class32"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Info omtrent juridische of administratieve betwistingen op flow van workflow contentieux naar My Minfin contentieux portlet managed by Workflow Contentieux Client_PROD"}, ]}, 
