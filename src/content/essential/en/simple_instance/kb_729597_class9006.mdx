...
{slot_reference: "description", value: [{value_type: "string", value_content: "L’Application Server est un framework logiciel qui fournit les services de base supportant le développement efficace des application métier écrit en JAVA™. Il agit en tant que conteneur de ces applications."}, ]}, 
