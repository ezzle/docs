...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résumé de l'implémentation de fonction applicative"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Résumé de l'implémentation de fonction applicative."}, ]}, 
