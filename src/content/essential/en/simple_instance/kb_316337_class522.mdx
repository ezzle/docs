...
{slot_reference: "name", value: [{value_type: "string", value_content: "Délivrer des certificats de dépôts à la Caisse des Dépôts et Consignations (CDC)"}, ]}, 
