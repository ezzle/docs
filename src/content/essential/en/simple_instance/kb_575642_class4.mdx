...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_575642_Class5"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "uitwisseling informatie G-nummerplaten op flow van Energie naar Vignetten 705 (bij Fod Mobiliteit) (stroom naar externe niet Fod Fin applicatie) managed by Energie_Prod"}, ]}, 
