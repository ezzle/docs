...
{slot_reference: "description", value: [{value_type: "string", value_content: "Fisconet contient toute la législation fiscale et comptable. KMportal et KMweb sont synonymes de Fisconet+"}, ]}, 
