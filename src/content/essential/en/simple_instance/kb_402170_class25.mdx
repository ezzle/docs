...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_402170_Class26"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "informatie accounts payable op Flow van First Accounting naar Fedcom via interface First AP (accounts payable) (stroom naar externe niet Fod Fin applicatie) managed by First Accounting_PROD"}, ]}, 
