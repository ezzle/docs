...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_194003_Class51"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Info omtrent persoon die handtekening zet, in bestand op flow van Myrent / CFM naar Lifecycle managed by SP17  Huurcontracten  Contrats de location_PROD  MyRent  BAUX"}, ]}, 
