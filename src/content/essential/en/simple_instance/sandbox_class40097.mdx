...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  Service  Modèle des interactions"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation graphique des dépendances entre services métiers pour un service donné."}, ]}, 
