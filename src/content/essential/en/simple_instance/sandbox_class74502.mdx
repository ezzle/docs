...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 325.16:relevé récapitulatif 325.16"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fiche intermédiaire destinée à résumer les données contenues dans les fiches individuelles 281.16 établies par le même débiteur de revenus soumis au précompte profesionnel."}, ]}, 
