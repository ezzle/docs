...
{slot_reference: "name", value: [{value_type: "string", value_content: "données de la dette sur le flux d'ICPC vers BCSS (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux d'ICPC vers BCSS (flux vers application externe non SPF Finances)"}, ]}, 
