...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_871734_Class4"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "aangifte op plda bevat verwijzing nr ncts rw: check of ncts aangifte bestaat en of er op vermelde hoeveelheden wel kunnen / mogelijk zijn"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Verwijzing naar Ncts aangifte op Plda aangifte op toekomstige flow van Plda naar Ncts RW managed by PLDA"}, ]}, 
