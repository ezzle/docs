...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données Catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des données objets logiques significatives pour l'organisation."}, ]}, 
