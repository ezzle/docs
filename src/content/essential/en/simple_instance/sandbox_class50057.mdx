...
{slot_reference: "description", value: [{value_type: "string", value_content: "C'est l'application Active Directory interne au SPF Finances (Microsoft)."}, ]}, 
