...
{slot_reference: "name", value: [{value_type: "string", value_content: "tâches sur le flux de Stirint ISI vers taskmanager"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "tâches sur le flux de Stirint isi vers taskmanager"}, ]}, 
