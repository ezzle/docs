...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résultats contrôles a posteriori déclarations PLDA sur le flux de CAP vers SPS consultation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Résultats des contrôles a posteriori des déclarations PLDA sur le flux de CAP vers SPS consultation"}, ]}, 
