...
{slot_reference: "name", value: [{value_type: "string", value_content: "P088 Analyse quantitative"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Analyse quantitative (p88)"}, ]}, 
