...
{slot_reference: "name", value: [{value_type: "string", value_content: "Projectmaster_PROD (gestion des projets)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Outil pour la gestion des projets."}, ]}, 
