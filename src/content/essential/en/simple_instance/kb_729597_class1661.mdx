...
{slot_reference: "name", value: [{value_type: "string", value_content: "consulter des quota ATV accordés (pour des achats des véhicules avec une exonération (temporaire) des droits de douane et/ou TVA) et l'utilisation, par ambassade ou par diplomate"}, ]}, 
