...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Fedorest"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application utilisée par le restaurant du personnel Fedorest"}, ]}, 
