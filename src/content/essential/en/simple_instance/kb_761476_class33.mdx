...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_761476_Class34"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Info verificatie successierechten op flow van Respo naar Movables (human) managed by Respo"}, ]}, 
