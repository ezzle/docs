...
{slot_reference: "name", value: [{value_type: "string", value_content: "les données de personnes et des données des véhicules sur le flux de Mobivis vers Camada"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Camada reçoit des données personnelles de Sitran et de Mobivis. Camada appelle directement le webservice Mobivis sans client."}, ]}, 
