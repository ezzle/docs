...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Finbadge"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "outil dans lequel les badges des membres du personnel sont créés, contiennent également des images"}, ]}, 
