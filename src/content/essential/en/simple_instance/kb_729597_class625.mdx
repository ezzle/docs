...
{slot_reference: "name", value: [{value_type: "string", value_content: "VIES  Consulter les détails des données sur les ventes européennes aux contribuables belges"}, ]}, 
