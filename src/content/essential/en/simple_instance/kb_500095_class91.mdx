...
{slot_reference: "name", value: [{value_type: "string", value_content: "droits fixés et article de rôles sur le flux d'ICPC to belconet archiv"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "droits et articles de rôle constatés sur le flux d'ICPC vers belconet archiv"}, ]}, 
