...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résultats contrôles a posteriori déclarations PLDA sur le flux de CAP vers IPI plan d'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Résultats des contrôles a posteriori des déclarations PLDA sur le flux de CAP vers IPI plan d'information"}, ]}, 
