...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pseudo articles de matrice cadastrale sur le flux de PRI vers Regondes 2 (via l'ESB)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Pseudo articles de matrice cadastrale sur le flux de PRI vers Regondes 2 (via l'ESB)"}, ]}, 
