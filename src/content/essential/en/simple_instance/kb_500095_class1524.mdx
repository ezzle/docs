...
{slot_reference: "name", value: [{value_type: "string", value_content: "Recapitulation fiches 281 sur le flux de Belcotax on web 2017 vers PDS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Recapitulation fiches 281 sur le flux de BelcoTax on Web 2017 vers PDS"}, ]}, 
