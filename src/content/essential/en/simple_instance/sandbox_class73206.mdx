...
{slot_reference: "name", value: [{value_type: "string", value_content: "fichier transaction sur le flux de Myrent vers Doctran"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux Myrent vers Doctran : dossier transaction"}, ]}, 
