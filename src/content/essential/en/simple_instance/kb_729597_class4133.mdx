...
{slot_reference: "name", value: [{value_type: "string", value_content: "DMGC (data mgt. system)  des fiches SPS donnent une explication concernant le contenu d'une ligne de sélection dans Dataflux"}, ]}, 
