...
{slot_reference: "name", value: [{value_type: "string", value_content: "Système Fermax_PROD (contrôle d’accès)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le contrôle d’accès : 6480 NEUFCHATEAU CLOS DES SEIGNEURS 2"}, ]}, 
