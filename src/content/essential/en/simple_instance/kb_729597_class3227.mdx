...
{slot_reference: "name", value: [{value_type: "string", value_content: "180B AUT  liste des postes ouverts par code de non-recouvrement pour la coördination des activités de recouvrement"}, ]}, 
