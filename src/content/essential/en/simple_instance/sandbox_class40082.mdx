...
{slot_reference: "name", value: [{value_type: "string", value_content: "Information Catalogue par information conceptuelle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des concepts, vues et représentations informationnelles significatives pour l'organisation."}, ]}, 
