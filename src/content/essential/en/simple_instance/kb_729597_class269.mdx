...
{slot_reference: "name", value: [{value_type: "string", value_content: "CALCINT RNinstitutions financières  calcul des intérêts légaux dans le cas des recouvrements non fiscaux"}, ]}, 
