...
{slot_reference: "name", value: [{value_type: "string", value_content: "service BRUSSEL TABAC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "gestion des bandes de tabac (MySQL, Delphi) DB2"}, ]}, 
