...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class99"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Plda aangiftes geselecteerd voor controle (uit sps fiches) op flow van SPS consultatie naar GI consult managed by CONSULTATIE SPS FICHES-CONSULTATION FICHES SPS_Prod"}, ]}, 
