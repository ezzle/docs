...
{slot_reference: "name", value: [{value_type: "string", value_content: "P046 Gestion des impulsions"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "?? Gestion des impulsions (P46)"}, ]}, 
