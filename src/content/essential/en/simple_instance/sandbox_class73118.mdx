...
{slot_reference: "name", value: [{value_type: "string", value_content: "Document d’identification de parcelles (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Document d’identification de parcelles (AG DocPat)"}, ]}, 
