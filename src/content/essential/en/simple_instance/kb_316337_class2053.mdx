...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Codinet"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Base de données juridiques P et O. Gestion et consultation des textes juridiques consolidés relatifs aux questions de personnel"}, ]}, 
