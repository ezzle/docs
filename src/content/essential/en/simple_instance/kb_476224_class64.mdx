...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_476224_Class65"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Boekhouding Sepa betalingen op flow van Sepa naar Fedcom (stroom naar externe niet Fod Fin applicatie) managed by SepaService_PROD"}, ]}, 
