...
{slot_reference: "name", value: [{value_type: "string", value_content: "signalétique personne physique propriétaire biens immobiliers sur le flux de BCSS vers Consultimmo sur ESB (flux entrant de l'application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "signalétique personne physique propriétaire biens immobiliers sur le flux de BCSS vers Consultimmo sur ESB (flux entrant de l'application externe non SPF Finances)"}, ]}, 
