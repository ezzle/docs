...
{slot_reference: "name", value: [{value_type: "string", value_content: "Collaborer avec le SPF Justice en ce qui concerne les fonds de faillites gérés par la Caisse des Dépôts et Consignations (CDC)"}, ]}, 
