...
{slot_reference: "description", value: [{value_type: "string", value_content: "Selectie percelen uit Cadgis in XML op flow van Cadgis naar Stipad"}, ]}, 
