...
{slot_reference: "name", value: [{value_type: "string", value_content: "IRMA 1er module  rentrer des demandes d'information uniformes et structurées concernant les flux des biens et des opérateurs"}, ]}, 
