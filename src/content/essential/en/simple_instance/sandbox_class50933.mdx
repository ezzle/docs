...
{slot_reference: "description", value: [{value_type: "string", value_content: "L'application Contract lifecyle management était remplacée par Ariba, qui fait partie de Fedcom."}, ]}, 
