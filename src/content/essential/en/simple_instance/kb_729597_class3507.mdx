...
{slot_reference: "name", value: [{value_type: "string", value_content: "MBM  maandelijkse en jaarlijkse aantallen en totalen in functie van de meetpunten van het strategisch plan"}, ]}, 
