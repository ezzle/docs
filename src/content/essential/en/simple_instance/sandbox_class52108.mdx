...
{slot_reference: "name", value: [{value_type: "string", value_content: "Olympia (environnement de travail collaboratif)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la mise en place d'un environnement de travail collaboratif pour l'ensemble du SPF Finances."}, ]}, 
