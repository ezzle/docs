...
{slot_reference: "name", value: [{value_type: "string", value_content: "P122 SECAL Suivi des fonds d'alimentation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "? DAVO Suivi des fonds d'alimentation (P122)"}, ]}, 
