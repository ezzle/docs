...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class64"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_688041_Class6"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Verwerkte akte (ruilverkavelingen, basisaktes...) / verwerkt patrimoniumcertificaat / status van verwerking in Stipad van akte, patrimoniumcertificaat op flow van Stipad naar DER (webservice over ESB) managed by STIPAD"}, ]}, 
