...
{slot_reference: "name", value: [{value_type: "string", value_content: "les données de personnes sur le flux de First vers Sitran"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "des données de personnes sur le flux de First vers Sitran"}, ]}, 
