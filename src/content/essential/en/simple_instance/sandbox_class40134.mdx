...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données objets : catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique, par données sujets, des données Objets conceptuelles."}, ]}, 
