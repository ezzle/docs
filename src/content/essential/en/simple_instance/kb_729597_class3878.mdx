...
{slot_reference: "name", value: [{value_type: "string", value_content: "Locoselect: fournir la possibilité de sélection pour import manuel dans Locostat"}, ]}, 
