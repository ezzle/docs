...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_692363_Class93"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "controleresultaten van de uitgevoerde aangiftegebonden controles op flow van feedback naar cocy managed by FEEDBACK_Prod"}, ]}, 
