...
{slot_reference: "name", value: [{value_type: "string", value_content: "Emcs-créer une annulation: opérateur économique: expéditeur, opérateur économique: destinataire initial"}, ]}, 
