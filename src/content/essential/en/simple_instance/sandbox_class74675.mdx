...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 604C:cessation d'une activité (604C)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclaration pour cessation d'une activité. Important: ce formulaire doit être imprimé et rempli personnellement (604C)."}, ]}, 
