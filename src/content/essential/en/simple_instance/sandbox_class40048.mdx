...
{slot_reference: "name", value: [{value_type: "string", value_content: "Technologie  Nœud technique  Catalogue par produit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste, par produit, des nœuds technologiques significatifs pour l'organisation."}, ]}, 
