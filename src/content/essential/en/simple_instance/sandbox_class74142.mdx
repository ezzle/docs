...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 204.3:état"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Etat des réductions de valeur pour pertes probables et des provisions pour risques et charges."}, ]}, 
