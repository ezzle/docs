...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module de gestion de dossiers  consultation de la liste des recettes hebdomadaires dans GDD autres impôts que PP"}, ]}, 
