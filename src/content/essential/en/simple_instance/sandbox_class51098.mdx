...
{slot_reference: "name", value: [{value_type: "string", value_content: "DBM6000 VLV_PROD (contrôle d'acces)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "contrôle d'acces aux bâtiments ( 1370 JODOIGNE AV.COMMANDANT BORLEE 42)"}, ]}, 
