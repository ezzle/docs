...
{slot_reference: "name", value: [{value_type: "string", value_content: "Cocy  pour la filiale: application §121 de l'instruction valeur: une liste des déclarations non régularisées avec valeur douane provisoire"}, ]}, 
