...
{slot_reference: "name", value: [{value_type: "string", value_content: "Technologie  Nœud technique  Catalogue pat vendeur"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente la liste, par fournisseurs, des plates-formes (nœuds) technologiques significatives pour l'organisation."}, ]}, 
