...
{slot_reference: "name", value: [{value_type: "string", value_content: "Aligner la politique du personnel par rapport aux besoins de l’organisation et avec un maximum de prise en compte des attentes des membres du personnel"}, ]}, 
