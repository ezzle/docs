...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résultats analyse de risque déclarations PLDA sur le flux de Seda vers Monitoringtool handhaving"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Résultats de l'analyse de risque des déclarations PLDA sur le flux de Seda vers Monitoringtool handhaving"}, ]}, 
