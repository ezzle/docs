...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service LCFB"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "LCFB-Base. La gestion de certains signaux, la gestion des affaires et des dossiers. Application qui sera remplacée par STIR Fraude."}, ]}, 
