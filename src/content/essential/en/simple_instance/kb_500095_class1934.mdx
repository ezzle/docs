...
{slot_reference: "name", value: [{value_type: "string", value_content: "signal dès que des données fiscales entrent de l'étranger sur le flux de Stirint Dlo vers Taxi (selon document SAD Stirint)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Stirint Dlo vers Taxi (selon document SAD Stirint) Stirint publie des signaux dès que des données arrivent de l'étranger."}, ]}, 
