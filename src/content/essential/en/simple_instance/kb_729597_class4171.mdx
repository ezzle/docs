...
{slot_reference: "name", value: [{value_type: "string", value_content: "First recovery  delegation ou sommes  suivre le clausule ‘délégation des sommen’ (créances d'alimentation)"}, ]}, 
