...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_802895_Class4"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Formulier Aangifte voor fiscale regulatie (2e fiscale regularisatie) managed by DLU bis"}, ]}, 
