...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de la demande des données pour remboursement / imputation / versement sur un autre numéro de compte bancaire (pas de formulaire standard) par application VA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de la demande des données pour remboursement / imputation / versement sur un autre numéro de compte bancaire (pas de formulaire standard) par application VA"}, ]}, 
