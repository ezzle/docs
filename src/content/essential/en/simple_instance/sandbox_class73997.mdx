...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire pour la contestation d’un RC notifié (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulaire pour la contestation d’un RC notifié (AG DocPat)"}, ]}, 
