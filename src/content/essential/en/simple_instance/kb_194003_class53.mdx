...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_625881_Class4"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "authenticatie-informatie op flow van Pandregister naar Lifecycle managed by Pandregister"}, ]}, 
