...
{slot_reference: "name", value: [{value_type: "string", value_content: "Conclure des accords de coopération avec d'autres organisations de contrôle dans le cadre de la stratégie de contrôle commune et la capacité de contrôle à octroyer"}, ]}, 
