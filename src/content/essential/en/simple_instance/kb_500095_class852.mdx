...
{slot_reference: "name", value: [{value_type: "string", value_content: "messages xml signatures électroniques sur le flux de Esignature vers PLDA"}, ]}, 
