...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  invordering  hoofdelijke aansprakelijkheid : splitsen van een schuld"}, ]}, 
