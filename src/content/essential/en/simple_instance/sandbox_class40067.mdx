...
{slot_reference: "name", value: [{value_type: "string", value_content: "Programme synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les détails et des principales relations de chacun des programmes"}, ]}, 
