...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_813503_Class16"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Schuldgegevens op flow van open icpc naar zacheus managed by Open ICPC_PROD"}, ]}, 
