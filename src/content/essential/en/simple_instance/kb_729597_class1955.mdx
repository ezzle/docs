...
{slot_reference: "name", value: [{value_type: "string", value_content: "AEO  annulations et regularisations-démarrer des mesures d'assistance sur base des chiffres AEO  annulations et regularisations"}, ]}, 
