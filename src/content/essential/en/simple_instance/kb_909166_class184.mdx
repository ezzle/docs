...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class185"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Internationale fiscale inlichtingen m.b.t. de Ruling i.v.m. Directe Belastingen rechtspersonen op flow van CCN1 naar Stirint ETR managed by CCN gateway 1"}, ]}, 
