...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class250"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Authenticatiegegevens op flow van Myrent naar Minfinpro managed by SP17  Huurcontracten  Contrats de location_PROD  MyRent  BAUX"}, ]}, 
