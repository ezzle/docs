...
{slot_reference: "name", value: [{value_type: "string", value_content: "P700 Création d'un pool de partenaires"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Création d'un pool de partenaires (P700)"}, ]}, 
