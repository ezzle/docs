...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_074457_Class15"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Consolidatiegegevens inningsteams op flow van Cloaf naar Fedcom managed by Cloaf_PROD"}, ]}, 
