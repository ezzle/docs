...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_496149_Class20"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_496149_Class22"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Info schuldvgl. (fiscale balans) op flow van First naar open ICPC managed by FIRST"}, ]}, 
