...
{slot_reference: "name", value: [{value_type: "string", value_content: "Biocarburants_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des quotas de biocarburants (retired)"}, ]}, 
