...
{slot_reference: "name", value: [{value_type: "string", value_content: "dossiers papiers dont les données sont rentrées dans Regondes2  dossiers SPF Finances"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Import dans Regondes2 sur la base des données communiquées par les Régions (pour les dossiers qu'ils nous transmettent) ou encodage manuel de l'adresse mentionnée par le réclamant (pour les dossiers du SPF Finances)"}, ]}, 
