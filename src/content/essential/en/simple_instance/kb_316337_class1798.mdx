...
{slot_reference: "name", value: [{value_type: "string", value_content: "service PO_Ticketing"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "C'est une application Java pour la gestion des demandes d'informations PenO."}, ]}, 
