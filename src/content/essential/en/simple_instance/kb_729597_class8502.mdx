...
{slot_reference: "name", value: [{value_type: "string", value_content: "Dubbele redundante laag"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "De architectuur van de oplossing is gebaseerd op een configuratie van Firewalls in twee lagen"}, ]}, 
