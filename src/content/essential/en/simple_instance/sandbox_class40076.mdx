...
{slot_reference: "name", value: [{value_type: "string", value_content: "Information  Concept  Synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétiques des principaux attributs ou relations de chaque concept informationnel"}, ]}, 
