...
{slot_reference: "description", value: [{value_type: "string", value_content: "Plate-forme d'application basée sur Windows, Apache (serveur d'application), MySQL ou MariaDB (base de données) et PHP (langage de programmation). Pas d'intégration avec IAM ou IAM LDAP."}, ]}, 
