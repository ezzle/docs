...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 276R: réduction conventionnelle  redevances de source belge"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Demande de réduction ou d'exonération du précompte mobilier ou du précompte professionel sur les redevances d'origine Belge en application de la convention préventive de double imposition entre la Belgique et …"}, ]}, 
