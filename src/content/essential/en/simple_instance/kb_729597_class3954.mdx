...
{slot_reference: "name", value: [{value_type: "string", value_content: "Niet fiscale documenten  raadplegen digitale kopie van relevante nota's omtrent niet fiscale documenten AA D&amp;A m.b.t. Veiligheid, Gezondheid, Economie en Milieu"}, ]}, 
