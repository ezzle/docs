...
{slot_reference: "name", value: [{value_type: "string", value_content: "Dépenses (P8.1)  AG PR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Dépenses chez l' AGPR (Perception et Recouvrement)"}, ]}, 
