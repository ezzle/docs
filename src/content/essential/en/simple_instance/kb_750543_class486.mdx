...
{slot_reference: "name", value: [{value_type: "string", value_content: "P044 Information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Information (p44)"}, ]}, 
