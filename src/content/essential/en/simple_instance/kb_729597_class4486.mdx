...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  traitement des déclarations fiscales PP par le mainframe (contrôles de validation)"}, ]}, 
