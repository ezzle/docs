...
{slot_reference: "name", value: [{value_type: "string", value_content: "tâches sur le flux de First vers Taskmanager"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "tâches sur le flux de First vers Taskmanager"}, ]}, 
