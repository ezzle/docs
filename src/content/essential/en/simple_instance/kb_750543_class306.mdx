...
{slot_reference: "name", value: [{value_type: "string", value_content: "P132 audit interne"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "audit interne (p132)"}, ]}, 
