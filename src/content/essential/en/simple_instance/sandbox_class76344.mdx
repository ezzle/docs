...
{slot_reference: "description", value: [{value_type: "string", value_content: "Gegevens Professionele diesel op manuele flow van PDIE naar E-Forms"}, ]}, 
