...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat volledige db-faire un appel direct aux données de l'application Agristat 4"}, ]}, 
