...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation sur base de First de l'avis de règlement collectif des dettes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation sur la base de First de l'avis de règlement collectif des dettes"}, ]}, 
