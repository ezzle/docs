...
{slot_reference: "name", value: [{value_type: "string", value_content: "First recovery  Recovery actions common screens  fonctionalités communes et composants visuels pour consulter et suivre les actions de recouvrement"}, ]}, 
