...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Trésorie compte courant  Récupérer les fonds et clôturer le compte courant ou le dossier sur un compte de tiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "compte courant  Récupérer les fonds et clôturer le compte courant ou le dossier sur un compte de tiers"}, ]}, 
