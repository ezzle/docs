...
{slot_reference: "name", value: [{value_type: "string", value_content: "Optimiser les contrôles en utilisant plus efficacement les ressources limitées"}, ]}, 
