...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour rechercher le numéro de téléphone et l'adresse mail des fonctionnaires dans les directories de téléphonie IP."}, ]}, 
