...
{slot_reference: "name", value: [{value_type: "string", value_content: "données descriptions de processus sur le flux de Aris Desiger vers Aris dashboard"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des descriptions de processus sur le flux de Aris Desiger vers Aris dashboard"}, ]}, 
