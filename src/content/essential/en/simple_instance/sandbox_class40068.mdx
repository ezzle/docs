...
{slot_reference: "name", value: [{value_type: "string", value_content: "Programme  planification"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Chronologies envisagées pour les différents projets d'un programme donné."}, ]}, 
