...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class256"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Authenticatiegegevens externen op flow van Myrent naar FEDIam (stroom naar externe niet Fod Fin applicatie) managed by SP17  Huurcontracten  Contrats de location_PROD  MyRent  BAUX"}, ]}, 
