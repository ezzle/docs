...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Statistiques Fiscales"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application  concernant des statistiques fiscales."}, ]}, 
