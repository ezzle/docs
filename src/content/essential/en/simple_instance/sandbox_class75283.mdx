...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire PM3  erreur de calcul"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire PM3  erreur de calcul"}, ]}, 
