...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI dashboard  possibilité pour regarder les KPI’s et les résultats associés de l'année passée"}, ]}, 
