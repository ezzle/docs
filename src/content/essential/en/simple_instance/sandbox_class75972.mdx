...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données déclaration TVA sur le flux d'Intervat vers Sitran"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données déclaration TVA sur le flux d'Intervat vers Sitran"}, ]}, 
