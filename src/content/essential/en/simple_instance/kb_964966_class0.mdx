...
{slot_reference: "name", value: [{value_type: "string", value_content: "BCE-convert_prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application destinée à VTOM, qui convertit des fichiers xml en fichier plat."}, ]}, 
