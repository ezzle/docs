...
{slot_reference: "description", value: [{value_type: "string", value_content: "Dematerialisatie van effecten. Aanvraag tot registratie van de elektronische dematerialisatie van aandelen aan toonder
