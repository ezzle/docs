...
{slot_reference: "name", value: [{value_type: "string", value_content: "db Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db Stirint ISI"}, ]}, 
