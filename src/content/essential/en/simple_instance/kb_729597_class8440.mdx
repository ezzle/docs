...
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce service permet la dématerialisation et la capture de documents par scanning paramètrable. Pas de limitation de volume, supporte de gros scanners de type KODAK"}, ]}, 
