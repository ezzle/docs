...
{slot_reference: "name", value: [{value_type: "string", value_content: "Investir dans des appareils de détection high tech afin de pouvoir continuer à exécuter des contrôles de qualité"}, ]}, 
