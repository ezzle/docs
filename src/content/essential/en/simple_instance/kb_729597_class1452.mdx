...
{slot_reference: "name", value: [{value_type: "string", value_content: "Module de recherche S&amp;S  vérifier combien de fois un certain opérateur a envoyé ou recu des envois impliquant la Belgique dans une certaine période de temps, (pour les déclarations sommaires d'entrée (ENS), pour les déclarations sommaires de sortie (EXS) et pour la déclaration d'exportation (document unique))"}, ]}, 
