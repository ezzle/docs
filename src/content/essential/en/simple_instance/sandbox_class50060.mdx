...
{slot_reference: "name", value: [{value_type: "string", value_content: "Adhemar (application mail)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application Mail pour le formulaire de contact du site web Finimmoweb: sera bientôt remplacé par l'application Measure mail"}, ]}, 
