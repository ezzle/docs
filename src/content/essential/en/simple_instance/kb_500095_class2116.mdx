...
{slot_reference: "name", value: [{value_type: "string", value_content: "dettes sociales sur le flux de BCSS vers 4ième voie (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dettes sociales sur le flux de BCSS vers 4ième voie (flux vers application externe non SPF Finances)"}, ]}, 
