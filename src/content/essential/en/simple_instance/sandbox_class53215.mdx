...
{slot_reference: "description", value: [{value_type: "string", value_content: "Fichier central Concessions  recouvrement annuel, va être repris dans FIRST"}, ]}, 
