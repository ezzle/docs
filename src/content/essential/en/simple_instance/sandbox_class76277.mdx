...
{slot_reference: "name", value: [{value_type: "string", value_content: "données infractions sur le flux de Camada vers Régistre 480"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données des infractions sur le flux de Camada vers Régistre 480 gestion électronique de dossiers pour les services de recherches de l'AG Douane et Accises (case mgt. AG D&amp;A)"}, ]}, 
