...
{slot_reference: "name", value: [{value_type: "string", value_content: "Identificatiegegevens op flow van sitran naar belcotax on web"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Identificatiegegevens op flow van Sitran naar belcotax on web"}, ]}, 
