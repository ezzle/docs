...
{slot_reference: "name", value: [{value_type: "string", value_content: "autorisations valables des établissements d'accises sur le flux d' établissements d'accises vers le site web Cdib"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les opérateurs consultent Etablissements d'accises (module pour des autorisations valables établissements d'accises à consulter)
Les opérateurs consultent le Fichier TVA (consultation des details de l'opérateur)"}, ]}, 
