...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation des AEO's par region sur le flux de Banaeos vers GI consult"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur flux de Banaeos vers GI consult (visualisation AEO's par regio)"}, ]}, 
