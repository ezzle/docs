...
{slot_reference: "name", value: [{value_type: "string", value_content: "NCTS-au “départ”: de nouveau libérer le montant écrit quand l'envoi peut être considéré comme compensé"}, ]}, 
