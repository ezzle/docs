...
{slot_reference: "name", value: [{value_type: "string", value_content: "DBM 5000-Dinec Building Management_PROD (contrôle d'acces)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Contrôle d'acces aux bâtiments : 5590 CINEY RUE COURTEJOIE 17"}, ]}, 
