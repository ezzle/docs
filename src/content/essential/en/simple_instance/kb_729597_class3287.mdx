...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module de gestion de dossiers  aperçu pour team DRM (remplace le module Belcel) des dossiers pour lesquels le team DRM doit prendre des contats téléfoniques (dossiers PP / amendes pénales / TVA)"}, ]}, 
