...
{slot_reference: "name", value: [{value_type: "string", value_content: "Introduire/ créer un nouveau cadre linguistique pour l'AGD&amp;A, indépendamment du SPF Finances"}, ]}, 
