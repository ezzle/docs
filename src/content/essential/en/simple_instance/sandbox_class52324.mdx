...
{slot_reference: "name", value: [{value_type: "string", value_content: "PO_accidents du travail_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des accidents de travail"}, ]}, 
