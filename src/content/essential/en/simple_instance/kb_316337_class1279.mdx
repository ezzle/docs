...
{slot_reference: "name", value: [{value_type: "string", value_content: "service CALCISOC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Calcul impôt des sociétés pour les personnes physiques et les non-résidents et impôt des personnes morales."}, ]}, 
