...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA dashboard  mogelijkheid om de tabel te sorteren en erheen te navigeren op een snelle en transparante wijze"}, ]}, 
