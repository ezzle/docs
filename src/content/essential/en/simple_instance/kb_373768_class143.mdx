...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_373768_Class141"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "604A:Aanvraag tot identificatie voor BTW (604A) managed by STIRON lot 2  TR (track rekeningen)"}, ]}, 
