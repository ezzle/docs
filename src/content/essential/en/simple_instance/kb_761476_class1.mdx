...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_761476_Class2"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "kadastraal plan obv een kadastrale code en een volgnummer op flow van Surveyorplan naar My Minfin Pro (over ESB) managed by SurveyorPlan_PROD"}, ]}, 
