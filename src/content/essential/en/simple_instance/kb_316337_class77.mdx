...
{slot_reference: "name", value: [{value_type: "string", value_content: "Organiser une concertation structurée avec les différentes parties prenantes"}, ]}, 
