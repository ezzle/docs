...
{slot_reference: "name", value: [{value_type: "string", value_content: "Calcul IPM 2005_PROD (taxe sur les personnes morales)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application sur l'intranet pour le calcul de la taxe sur les personnes morales, exercice d'imposition 2005"}, ]}, 
