...
{slot_reference: "name", value: [{value_type: "string", value_content: "extraits cadastraux sur le flux de Cadex vers My Minfin"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur: extraits cadastraux sur le flux de Cadex vers My Minfin"}, ]}, 
