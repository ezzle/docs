...
{slot_reference: "name", value: [{value_type: "string", value_content: "notifications, avertissements-extrait de rôle des non résidents (pour les impôts directs) sur le flux de Stirint dlo vers Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Stirint publie des signaux dès que des données arrivent de l'étranger."}, ]}, 
{slot_reference: "system_content_lifecycle_status", value: [{value_type: "simple_instance", value_content: "KB_229567_Class67"}, ]}, 
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class78666"}, ]}, 
