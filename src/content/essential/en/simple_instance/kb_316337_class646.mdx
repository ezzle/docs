...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mettre en place des descriptions de fonction spécifiques à tous les niveaux"}, ]}, 
