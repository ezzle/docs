...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "PDF dossier Mainperson consultable par d'autres applications managed by STIRint  ETR_PROD"}, ]}, 
