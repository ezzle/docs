...
{slot_reference: "name", value: [{value_type: "string", value_content: "P045 Consultation externe et collaboration"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Consultation externe et collaboration (p45)"}, ]}, 
