...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_774253_Class9"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Info omtrent niet aangezuiverde T-documenten op flow van Transit (PC Nadoss) naar Register 480 managed by TRANSIT_PROD (pc nadoss)"}, ]}, 
