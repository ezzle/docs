...
{slot_reference: "name", value: [{value_type: "string", value_content: "Banque d'information : résumé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les principales relations d'une banque de donnée."}, ]}, 
