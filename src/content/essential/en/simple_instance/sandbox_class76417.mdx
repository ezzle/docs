...
{slot_reference: "name", value: [{value_type: "string", value_content: "données taxe de circulation sur le flux de BV Land vers Open PPL"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données taxe de circulation sur le flux de BVLand vers Open BVL"}, ]}, 
