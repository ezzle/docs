...
{slot_reference: "name", value: [{value_type: "string", value_content: "180B-Ninstitutions financières  recouvrement annuel dettes non fiscales via fichier central des concessions"}, ]}, 
