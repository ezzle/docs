...
{slot_reference: "name", value: [{value_type: "string", value_content: "FIRST Amendes Pénales_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Partie de FIRST (application globale du recouvrement et perception) pour le recouvrement des amendes pénales"}, ]}, 
