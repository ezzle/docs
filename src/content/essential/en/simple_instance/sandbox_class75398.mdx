...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire template à remplir dans le cas d'envoi de fonds appartenant à de nombreux tiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Template à remplir dans le cas d'envoi de fonds appartenant à de nombreux tiers"}, ]}, 
