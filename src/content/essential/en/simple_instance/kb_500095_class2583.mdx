...
{slot_reference: "name", value: [{value_type: "string", value_content: "flux de Archibus vers Echopark mais ne contient pas des données de personnes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur: flux de Archibus vers Echopark mais ne contient pas des données de personnes"}, ]}, 
