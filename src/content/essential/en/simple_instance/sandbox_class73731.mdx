...
{slot_reference: "name", value: [{value_type: "string", value_content: "Fiches d'expertise 23 E (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fiches d'expertise 23 E (AG DocPat)"}, ]}, 
