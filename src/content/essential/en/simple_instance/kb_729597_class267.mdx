...
{slot_reference: "name", value: [{value_type: "string", value_content: "CALCINT RNFI  berekening wettelijke intresten bij niet-fiscale invorderingen"}, ]}, 
