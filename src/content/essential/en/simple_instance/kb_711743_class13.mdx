...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_711743_Class14"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_711743_Class15"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Opbrengst mathematisch model op flow van Respo naar SAS (interface  SAS mathematisch model  Respo) managed by Respo"}, ]}, 
