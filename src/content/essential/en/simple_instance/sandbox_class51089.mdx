...
{slot_reference: "name", value: [{value_type: "string", value_content: "DB Press / DB Pers (interaction avec Taskmgr)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "DB Press / DB Pers est une application qui interagit avec Taskmanager."}, ]}, 
