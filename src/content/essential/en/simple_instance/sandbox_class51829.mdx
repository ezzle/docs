...
{slot_reference: "name", value: [{value_type: "string", value_content: "LIBERALITE (dons déductibles d'impôt)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Module pour le traitement des dons déductibles d'impôt."}, ]}, 
