...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Mantis"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Mantis est un outil pour la gestion de projet chez AA Fisc: impôts des personnes physiques."}, ]}, 
