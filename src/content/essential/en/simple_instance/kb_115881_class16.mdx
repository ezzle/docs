...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "TAXI Database (RDC) managed by Calcul IPP  Aanslagjaar 2022_PROD"}, ]}, 
