...
{slot_reference: "name", value: [{value_type: "string", value_content: "amendes pénales dans un fichier sur le flux de SPF Justice vers First"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "amendes pénales dans un fichier sur le flux de SPF Justice vers First"}, ]}, 
