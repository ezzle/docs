...
{slot_reference: "name", value: [{value_type: "string", value_content: "Workflow ACM dossiers dépenses_prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Avec ACM des applications de workflow sont construites sur la plate-forme IBM ACM."}, ]}, 
