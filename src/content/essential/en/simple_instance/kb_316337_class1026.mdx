...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Calcul IPP/INR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "calcul de l'impôt des particuliers non-résidents"}, ]}, 
