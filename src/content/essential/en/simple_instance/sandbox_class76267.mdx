...
{slot_reference: "name", value: [{value_type: "string", value_content: "données sur les revenus cadastraux pour enrôlement du précompte immobilier sur le flux de l'interface de AAPD-PRI vers Précompte Immobilier"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de données sur les revenus cadastraux pour enrôlement du précompte immobilier de l'interface AAPD-PRI vers Précompte immobilier"}, ]}, 
