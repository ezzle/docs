...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class61"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Brieven landmeters 43B (aangifte ingebruikneming onroerend goed) en dossiernummer voor Prodocs op flow van Urbain naar Stipad (human interface) managed by URBAIN2"}, ]}, 
