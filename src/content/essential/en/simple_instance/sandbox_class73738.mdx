...
{slot_reference: "name", value: [{value_type: "string", value_content: "bestand betalingsorder Demat"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "bestand betalingsorder Demat"}, ]}, 
