...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_402170_Class5"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie op Flow van E notaire2 naar ICPC (zou moeten gewist worden volgens Guido Tieleman dd 05-07-17) managed by E_Notaire2"}, ]}, 
