...
{slot_reference: "name", value: [{value_type: "string", value_content: "Solutions de sécurité"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation  les solutions de sécurité qui *devraient* être appliquées dans l'architecture."}, ]}, 
