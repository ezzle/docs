...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion du chargement de la db Cddb via l' interface VTOM de consultation de db."}, ]}, 
