...
{slot_reference: "description", value: [{value_type: "string", value_content: "Base de données juridique du service P&amp;O. Gestion et consultation des textes juridiques consolidés relatifs aux questions de personnel."}, ]}, 
