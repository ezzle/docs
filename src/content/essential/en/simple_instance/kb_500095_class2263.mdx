...
{slot_reference: "name", value: [{value_type: "string", value_content: "STIR_TVA Database (RDC)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "STIR_TVA Relational Database on RDC's DB2 Environment"}, ]}, 
