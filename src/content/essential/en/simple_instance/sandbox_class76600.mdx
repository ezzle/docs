...
{slot_reference: "name", value: [{value_type: "string", value_content: "rendement locatif dans l'application Calcus (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "rendements locatif dans l'application Calcus (AG DocPat)"}, ]}, 
