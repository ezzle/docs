...
{slot_reference: "name", value: [{value_type: "string", value_content: "payit bloquer des remboursement pourqu'ils ne puissent pas être exécutées"}, ]}, 
