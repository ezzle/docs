...
{slot_reference: "name", value: [{value_type: "string", value_content: "données POW nécessaire pour préparer l'inscription hypothecaire sur le flux manuel de Properties on web vers Gestion Des Debiteurs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données Properties on web nécessaire pour préparer l'inscription hypothecaire sur le flux manuel de Pow vers Gestion Des Débiteurs"}, ]}, 
