...
{slot_reference: "name", value: [{value_type: "string", value_content: "DMGC  Website menu  gestion du contenu des pages web de l'application gestion des risques (DMGC)"}, ]}, 
