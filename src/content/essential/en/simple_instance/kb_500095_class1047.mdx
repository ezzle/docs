...
{slot_reference: "name", value: [{value_type: "string", value_content: "données parcellaires sur le flux de Consultimmo vers SAS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données parcellaires sur le flux de Consultimmo vers SAS; il y en a 2 flux entre Consultimmo et SAS: 1 Stipad vers SAS vers Consultimmo et 2 Consultimmo vers SAS."}, ]}, 
