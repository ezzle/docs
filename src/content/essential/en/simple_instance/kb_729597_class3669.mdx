...
{slot_reference: "name", value: [{value_type: "string", value_content: "IRMA 1er module  rentrer des demandes d'information non standardisés concernant des flux de biens et des opérateurs"}, ]}, 
