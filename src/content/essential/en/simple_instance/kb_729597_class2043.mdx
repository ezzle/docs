...
{slot_reference: "name", value: [{value_type: "string", value_content: "recours administratifs  donne une vue sur quels dossiers sont ouverts"}, ]}, 
