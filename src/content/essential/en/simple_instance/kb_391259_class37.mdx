...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_391259_Class38"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "informatie of een bepaalde Economische operator een actieve vergunning voor het bestelde product heeft op flow van EMCS SEED naar EMCS managed by EMCS  SEED_PROD"}, ]}, 
