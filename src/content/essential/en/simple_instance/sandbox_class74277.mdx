...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 276Conv: attestation de domicile fiscale"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Attestation délivrée aux résidents de la Belgique pour l'application des conventions préventives de la double imposition"}, ]}, 
