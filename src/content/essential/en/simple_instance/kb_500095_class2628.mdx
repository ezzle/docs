...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations de la dette sur le flux de First vers E-Notaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur: informations de la dette sur le flux de First vers E-Notaire"}, ]}, 
