...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_774253_Class44"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "controleresultaten van de uitgevoerde aangiftegebonden controles op flow van feedback naar seda dashboard managed by FEEDBACK_Prod"}, ]}, 
