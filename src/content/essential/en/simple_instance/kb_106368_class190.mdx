...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class191"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens controleresultaten op door SEDA voor controle geselecteerde aangiftes op flow van Moda2 naar Monitoringtool Handhaving managed by MODA 2_PROD"}, ]}, 
