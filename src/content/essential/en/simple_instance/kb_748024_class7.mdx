...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_748024_Class8"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_966739_Class18"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Pseudo artikels van kadastrale matrix op flow van PRI naar Workflow contentieux (over ESB) managed by AAPD_PRI_Prod (webservice)"}, ]}, 
