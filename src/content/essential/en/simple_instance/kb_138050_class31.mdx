...
{slot_reference: "name", value: [{value_type: "string", value_content: "On doit éviter les demandes superflues d'informations déjà connues et disponibles pour éviter de contrarier les utilisateurs et le public. La cohérence des données est améliorée."}, ]}, 
