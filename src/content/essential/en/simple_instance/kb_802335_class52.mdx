...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_802335_Class53"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "betalingsbestanden voor betalingen aan andere lidstaten op flow van Moss naar Btm managed by Mini One Stop Shop Back Office_prod (MOSS)"}, ]}, 
