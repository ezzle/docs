...
{slot_reference: "name", value: [{value_type: "string", value_content: "tâches à faire sur le flux de Der vers Taskmanager (archivé interface)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Tâches à exécuter sur le flux de Der vers Taskmanager ( interface archivé)"}, ]}, 
