...
{slot_reference: "name", value: [{value_type: "string", value_content: "signal dès que des données fiscales entrent de l'étranger sur le flux de Stirint Dlo to belconet (selon document SAD Stirint)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Stirint Dlo vers Belconet (selon le doc. SAD Stirint) Stirint publie des signaux lorsqu'un renseignement arrive de l'étranger."}, ]}, 
