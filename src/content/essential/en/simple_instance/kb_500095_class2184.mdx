...
{slot_reference: "name", value: [{value_type: "string", value_content: "statistiques concernant contrôles et recherches par D&amp;A sur le flux manuel de Camada vers IPI Dashboard"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Statistiques concernant des contrôles et recherches par AG D&amp;A sur le flux manuel de Camada vers IPI Dashboard, pas par stored procédures, mais rentré manuel après calcul par team gestion de données de l'AG D&amp;A"}, ]}, 
