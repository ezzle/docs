...
{slot_reference: "name", value: [{value_type: "string", value_content: "Tâches à faire sur le flux de Stiron-TR vers CCFF taskmanager"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "tâches de Stiron-TR vers CCFF taskmanager"}, ]}, 
