...
{slot_reference: "name", value: [{value_type: "string", value_content: "MASP_MessageStore_PROD (messages concernant les déclarations PLDA)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "File system dans lequel sont sauvegardés des messages concernant les déclarations PLDA."}, ]}, 
