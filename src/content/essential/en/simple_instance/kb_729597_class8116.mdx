...
{slot_reference: "name", value: [{value_type: "string", value_content: "Synchronisation temporelle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce service assure la synchronisation des systèmes internes d’enregistrement horaire avec une horloge atomique centrale."}, ]}, 
