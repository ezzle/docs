...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification opérateur économique AEO sur le flux de Sitran vers AEO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données d'identification de l'opérateur économique AEO sur le flux de Sitran vers AEO"}, ]}, 
