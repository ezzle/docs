...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_592987_Class43"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Boekhoudkundige gegevens (op basis waarvan statistieken gegenereerd worden door Comfor Java) op flow van Comfor PHP naar Comfor java managed by COMFOR_PROD"}, ]}, 
