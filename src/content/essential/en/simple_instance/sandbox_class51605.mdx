...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des demandes de LID’s (= identifiant sur le mainframe BULL Autp)"}, ]}, 
