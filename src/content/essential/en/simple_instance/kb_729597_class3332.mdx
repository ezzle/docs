...
{slot_reference: "name", value: [{value_type: "string", value_content: "communication entre d'une part Comfor PHP et d'autre part des applications Java (DER, STIPAD, FEDCOM, BTM et MYRENT)"}, ]}, 
