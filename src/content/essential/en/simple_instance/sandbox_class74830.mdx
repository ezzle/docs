...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande remboursement précompte mobilier dans le cadre de convention préventive de la double imposition"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire demande remboursement précompte mobilier dans le cadre de convention préventive de la double imposition"}, ]}, 
