...
{slot_reference: "name", value: [{value_type: "string", value_content: "db TC automatisée"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db Taxe de circulation automatisée DBTC"}, ]}, 
