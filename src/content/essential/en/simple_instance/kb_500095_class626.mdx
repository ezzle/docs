...
{slot_reference: "name", value: [{value_type: "string", value_content: "liste de frêt"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des listes de frêt des ports maritimes dans Zaventem aéroport (airwaybill): la liste de frêt est le nom générique utilisé par des ports maritimes et des aéroports : ne contient pas de données personnelles."}, ]}, 
