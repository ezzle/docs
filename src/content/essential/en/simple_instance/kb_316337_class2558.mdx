...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Zoomit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Service qui permet de vérifier si un numéro de compte et un no. IBAN supportent ZoomIt"}, ]}, 
