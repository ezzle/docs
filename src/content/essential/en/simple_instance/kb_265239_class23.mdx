...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_324466_Class12"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie op flow van webapplicatie Pandregister naar webservice Pandregister managed by Pandregister"}, ]}, 
