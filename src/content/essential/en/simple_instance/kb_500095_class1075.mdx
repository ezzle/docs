...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclaration périodique TVA sur le flux de STIR TVA vers STIRON CC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déclarations périodiques TVA sur le flux de STIR TVA vers STIRON CC"}, ]}, 
