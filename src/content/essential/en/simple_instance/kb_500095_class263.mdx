...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation common declaration précompte mobilier par application d'établissement PPWT-TPW (=pour précompte mobilier)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation common declaration précompte mobilier par application d'établissement PPWT-TPW (=pour précompte mobilier)"}, ]}, 
