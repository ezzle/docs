...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_153205_Class4"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flow van Sigma naar SAS (met box in box : interface Sigma / Stipad Patris)"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "(old interface) statistische informatie op flow van Sigma naar Stipad (db Patris) (over SAS) managed by Sigma_Prod"}, ]}, 
