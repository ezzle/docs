...
{slot_reference: "name", value: [{value_type: "string", value_content: "cash  régistration des (nouveaux) formulaires de d��claration de l'argent et constatations éventuels dans le cadre de l'obligation de déclaration"}, ]}, 
