...
{slot_reference: "name", value: [{value_type: "string", value_content: "VERGUN_PROD (licences délivrées par les autorités douanières)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Base de données de référence pour les licences délivrées par les autorités douanières."}, ]}, 
