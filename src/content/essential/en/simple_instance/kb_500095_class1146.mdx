...
{slot_reference: "name", value: [{value_type: "string", value_content: "déclarations PLDA sélectionné pour contrôle (des fiches sps) sur le flux de consultation SPS fiches vers Seda"}, ]}, 
