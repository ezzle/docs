...
{slot_reference: "name", value: [{value_type: "string", value_content: "Créer la transparence financière et développer les rapports financiers et de management"}, ]}, 
