...
{slot_reference: "name", value: [{value_type: "string", value_content: "gegevens i.v.m. pseudo-artikelnrs. op flow van PRI naar DXSI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "gegevens ivm pseudo-artikelnummers op flow van PRI naar DXSI"}, ]}, 
