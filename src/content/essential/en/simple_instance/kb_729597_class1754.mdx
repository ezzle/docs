...
{slot_reference: "name", value: [{value_type: "string", value_content: "Cocy  overzicht van de SPS-fiches, met mogelijkheid om de hits te raadplegen voor het hulpkantoor"}, ]}, 
