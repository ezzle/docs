...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Trésorie compte courant  Demander un retrait sur un compte propre ou dans un dossier sur un compte de tiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "compte courant  Demander un retrait sur un compte propre ou dans un dossier sur un compte de tiers"}, ]}, 
