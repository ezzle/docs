...
{slot_reference: "name", value: [{value_type: "string", value_content: "Numéros de compte financiers  imprimer des numéros de compte sur les avertissements extraits de rôle et les rappels à envoyer"}, ]}, 
