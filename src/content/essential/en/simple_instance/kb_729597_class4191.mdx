...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  Valider le dossier de demande (traiter les demandes des bénéficiaires)"}, ]}, 
