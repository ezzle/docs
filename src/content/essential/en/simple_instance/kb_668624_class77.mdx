...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_668624_Class78"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Opbrengsten onroerende goederen op flow van Consultimmo naar Stirint Autodt managed by ConsultImmo"}, ]}, 
