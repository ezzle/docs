...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Redmine"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Redmine est l'outil choisi par ICT Development pour gérer les tâches dans des projects et des applications dans le département."}, ]}, 
