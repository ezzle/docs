...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_314045_Class60"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens van een onroerend goed van een specifieke persoon (eigenaar) uit Patris bijgewerkt via Stipad op flow van Properties on Web naar Cadgis managed by PropertiesOnWeb_Prod"}, ]}, 
