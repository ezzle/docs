...
{slot_reference: "name", value: [{value_type: "string", value_content: "Boissons  ajouter des résultats des échantillons enregistrés au cadastre des boissons"}, ]}, 
