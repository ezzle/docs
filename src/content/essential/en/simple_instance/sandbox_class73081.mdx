...
{slot_reference: "name", value: [{value_type: "string", value_content: "divfichier Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "divfichier Relational Database on MariaDB/MySQL Environment"}, ]}, 
