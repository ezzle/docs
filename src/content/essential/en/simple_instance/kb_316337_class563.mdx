...
{slot_reference: "name", value: [{value_type: "string", value_content: "Interagir effectivement avec la Justice afin de réaliser, par la mise en oeuvre de récentes initiatives (una via, arrangement amiable), une récupération pragmatique et effective des sommes et capitaux frauduleux"}, ]}, 
