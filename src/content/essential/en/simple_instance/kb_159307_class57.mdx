...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_159307_Class58"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Lijst landmeters op flow van Landmeterplan naar MyMinFin Pro portlet (Landmeters/ Géométres) (human interface ?) managed by MyMinFin Pro (Landmeters/ Géométres) portlet_prod"}, ]}, 
