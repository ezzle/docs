...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_074792_Class37"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "informatie over toekenningen aan gemeenten voor maandelijkse afsluiting van ICPC comptabiliteit op flow van ICPC naar GEMB (stroom naar externe niet FOD Fin applicatie) managed by ICPC_PROD"}, ]}, 
