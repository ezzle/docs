...
{slot_reference: "name", value: [{value_type: "string", value_content: "données délais vérifications fysiques des déclarations PLDA à contrôler repris dans des fiches SPS sur le flux de Sps selectionprofiel vers FCP audit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des délais des vérifications fysiques des déclarations PLDA  à contrôler repris dans des fiches SPS sur le flux de SPS profil de séléction vers FCP audit"}, ]}, 
