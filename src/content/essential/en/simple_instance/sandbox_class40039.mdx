...
{slot_reference: "name", value: [{value_type: "string", value_content: "Technologie  Modèle de référence/normalisé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cartographie des composants technologiques utilisés dans l'organisation."}, ]}, 
