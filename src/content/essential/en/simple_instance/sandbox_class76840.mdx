...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification concernant des addresses étrangères sur le flux de APF vers Fatca"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Via le module APF, les données d'identification autour des adresses étrangères qui étaient reçues de Stirint Fatca, sont recherchées automatiquement dans Sitran"}, ]}, 
