...
{slot_reference: "name", value: [{value_type: "string", value_content: "référence vers déclaration NCTS sur déclaration PLDA sur le flux de PLDA vers Ncts RW"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclaration sur PLDA contient référence vers NCTS RW: verification si la déclaration NCTS existe et si les quantités mentionnés sont possible"}, ]}, 
