...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Extraits_en_ligne"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Délivrance en ligne des extraits cadastraux"}, ]}, 
