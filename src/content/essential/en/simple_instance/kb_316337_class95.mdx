...
{slot_reference: "name", value: [{value_type: "string", value_content: "Transmettre les nouveaux mécanismes de fraude découverts à toutes les instances concernées (tant à l'intérieur qu'à l'extérieur du SPF Finances)"}, ]}, 
