...
{slot_reference: "name", value: [{value_type: "string", value_content: "selection_profielen Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "selection_profielen Relational Database on MariaDB/MySQL Environment"}, ]}, 
