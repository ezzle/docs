...
{slot_reference: "name", value: [{value_type: "string", value_content: "GRA  Rechtstreeks raadplegen en wijzigen adressen ontvangstkantoren en inningsdiensten in de databank GRA: TP-vraag op terminal (“RA BIJ”)."}, ]}, 
