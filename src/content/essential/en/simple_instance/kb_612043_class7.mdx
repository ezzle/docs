...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_612043_Class8"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Betalingen van in en uitpandnames op flow van Pandregister naar Ingenico managed by Pandregister"}, ]}, 
