...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire PM4  notification de modification la déclaration"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire PM4  notification de modification de la déclaration"}, ]}, 
