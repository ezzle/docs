...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_856795_Class15"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_425693_Class77"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Identificatiegegevens op flow van Sitran naar AAPD / PRI over ESB managed by AAPD_PRI_Prod (webservice)"}, ]}, 
