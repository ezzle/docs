...
{slot_reference: "name", value: [{value_type: "string", value_content: "droits de propriété et données personnelles du propriétaire sur le flux de Consultimmo vers Regondes 2"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Consultimmo vers Regondes 2 droits+personne+propriétaire tous proviennent de Consultimmo"}, ]}, 
