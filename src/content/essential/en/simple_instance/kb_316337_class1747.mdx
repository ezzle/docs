...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PPLT"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de la Caisse des dépôts et Consignations, permettant de réaliser les mutations journalières."}, ]}, 
