...
{slot_reference: "description", value: [{value_type: "string", value_content: "Ensemble de composants pour réaliser des traitements batches qui peuvent être :  parallèles  clustérisés  avec du failover"}, ]}, 
