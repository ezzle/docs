...
{slot_reference: "name", value: [{value_type: "string", value_content: "autorisation douane transfrontalière"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "autorisation douane transfrontalière"}, ]}, 
