...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_604392_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Sociale en fiscale schulden op flow van E notaire2 naar SP 23 eFunctionnaire Instrumentant Ambtenaar managed by E_Notaire2"}, ]}, 
