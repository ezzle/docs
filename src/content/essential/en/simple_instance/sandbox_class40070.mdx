...
{slot_reference: "name", value: [{value_type: "string", value_content: "Processus physique  flux opérationnel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Description graphique des différentes étapes de l'exécution d'un processus métier."}, ]}, 
