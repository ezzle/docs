...
{slot_reference: "description", value: [{value_type: "string", value_content: "EMCS_chargement Relational Database on MariaDB/MySQL Environment"}, ]}, 
