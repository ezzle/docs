...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof stand alone  validations online techniques des fichiers XML avec des déclarations PP"}, ]}, 
