...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class196"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Boekhoudkundige transfer toegekende teruggaven / restituties op flow van TR Restitution naar ICPC managed by TR-Restitution"}, ]}, 
