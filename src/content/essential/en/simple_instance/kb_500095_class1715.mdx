...
{slot_reference: "name", value: [{value_type: "string", value_content: "dettes suite aux infractions liées aux plaques d'immatriculation sur le flux de Anpr vers TVA fichier"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dettes suite aux infractions liées aux plaques d'immatriculation sur le flux de Anpr vers TVA fichier"}, ]}, 
