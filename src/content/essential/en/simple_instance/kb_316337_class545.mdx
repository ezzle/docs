...
{slot_reference: "name", value: [{value_type: "string", value_content: "Faciliter l'accomplissement de l'obligation de déclaration via un pré-remplissage dans Tax-onweb (TOW)"}, ]}, 
