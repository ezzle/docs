...
{slot_reference: "name", value: [{value_type: "string", value_content: "P041 Réglementation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Réglementation (p41)"}, ]}, 
