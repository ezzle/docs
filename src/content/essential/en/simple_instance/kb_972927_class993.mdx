...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "RO  Rappel 2 à l'Etat partenaire UE managed by STIRint  CLO_PROD"}, ]}, 
