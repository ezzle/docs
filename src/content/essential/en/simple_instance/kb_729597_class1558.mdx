...
{slot_reference: "name", value: [{value_type: "string", value_content: "banaeos  ajouter des nouveaux dossiers par rapport aux demandes pour des autorisations AEO"}, ]}, 
