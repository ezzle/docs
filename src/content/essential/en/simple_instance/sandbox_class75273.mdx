...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire PM1  accorder délai de réponse supplémentaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire PM1  accorder délai de réponse supplémentaire"}, ]}, 
