...
{slot_reference: "name", value: [{value_type: "string", value_content: "service TOTSS Personnes Physiques"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application dans laquelle est repris, par contribuable et par exercise d'imposition, la cotisation spéciale de sécurité sociale"}, ]}, 
