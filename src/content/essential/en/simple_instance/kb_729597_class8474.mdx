...
{slot_reference: "name", value: [{value_type: "string", value_content: "Remote Access pour les agents et partenaires"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les utilisateurs externes (remote users) peuvent accéder de façon sécurisée aux reseaux internes du SPF Finances."}, ]}, 
