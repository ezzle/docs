...
{slot_reference: "name", value: [{value_type: "string", value_content: "ICPC  régistration des actions spécifiques de recouvrement sur une dette"}, ]}, 
