...
{slot_reference: "name", value: [{value_type: "string", value_content: "CFM (signature pour Myrent)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L'application CFM délivre la signature pour l'application Myrent."}, ]}, 
