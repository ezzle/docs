...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_580263_Class33"}, ]}, 
{slot_reference: "app_pro_persists_info_rep", value: [{value_type: "boolean", value_content: "false"}, ]}, 
{slot_reference: "used_in_app_dependencies", value: [{value_type: "simple_instance", value_content: "KB_933153_Class43"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "cijfers omtrent vervoermiddelen met diplomatieke vrijstelling (aantal atv vignetten) op flow van ATV naar informatieplan managed by ATV_Prod"}, ]}, 
