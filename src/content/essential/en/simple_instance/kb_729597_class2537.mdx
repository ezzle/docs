...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI dashboard  affichage des KPI’s existants (points de mesure) et vérifier s'ils sont atteints"}, ]}, 
