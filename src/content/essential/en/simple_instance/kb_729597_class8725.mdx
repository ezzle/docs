...
{slot_reference: "description", value: [{value_type: "string", value_content: "Columbus Output Management (Columbus OM) contient des fonctions pour imprimer, expédier et gérer les gros volumes de documents."}, ]}, 
