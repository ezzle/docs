...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  application calcul communication structurée (seulement pour paiements PP)"}, ]}, 
