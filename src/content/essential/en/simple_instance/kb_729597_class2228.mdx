...
{slot_reference: "name", value: [{value_type: "string", value_content: "SPS consultation  traduction du contenu technique d'une ligne de sélection dans Dataflux, en vue d'une sélection pour l'entrée automatique des déclarations d'importation et d'exportation dans MASP-PLDA, vers une explication valable pour le fonctionnaire vérifiant."}, ]}, 
