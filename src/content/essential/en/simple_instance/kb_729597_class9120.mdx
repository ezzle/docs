...
{slot_reference: "name", value: [{value_type: "string", value_content: "Wintel-Servers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Beschrijving van de Windows-serveromgeving van de FOD."}, ]}, 
