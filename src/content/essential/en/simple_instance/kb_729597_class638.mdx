...
{slot_reference: "name", value: [{value_type: "string", value_content: "VIES  Consulter les détails des acquisitions intracommunautaires effectuées par un assujetti à la TVA d'un autre État membre pour lequel le fournisseur est un assujetti à la TVA belge"}, ]}, 
