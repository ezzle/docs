...
{slot_reference: "name", value: [{value_type: "string", value_content: "service BusinessServicesAdmin"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Configuration des messages d'aide pour le support du composant navigateur (browser) et configuration des blacklist SEPA."}, ]}, 
