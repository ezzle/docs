...
{slot_reference: "name", value: [{value_type: "string", value_content: "valeur de vente  valeur vénale MM Zones"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "valeur de vente  valeur vénale MM Zones"}, ]}, 
