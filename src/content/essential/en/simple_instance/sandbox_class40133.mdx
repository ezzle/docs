...
{slot_reference: "name", value: [{value_type: "string", value_content: "Description d'objectif métiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les relations ou attributs principaux d'un objectif d'affaire."}, ]}, 
