...
{slot_reference: "name", value: [{value_type: "string", value_content: "Identificatiegegevens op flow van APF naar Belcotax on web 2017"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Identificatiegegevens op flow van APF naar Belcotax on web 2017"}, ]}, 
