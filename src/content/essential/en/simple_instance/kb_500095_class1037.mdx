...
{slot_reference: "name", value: [{value_type: "string", value_content: "données parcellaires sur le flux de Cadgis vers Arcmap"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données parcellaires sur le flux de Cadgis vers Arcmap"}, ]}, 
