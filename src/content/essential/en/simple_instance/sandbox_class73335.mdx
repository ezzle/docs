...
{slot_reference: "name", value: [{value_type: "string", value_content: "Situations de propriété / transferts de propriété des parcelles de Consultimmo vers FSB Fedict"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Consultimmo au FSB Fedict en acceptation dd mars 2017"}, ]}, 
