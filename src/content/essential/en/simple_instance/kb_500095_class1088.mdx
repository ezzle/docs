...
{slot_reference: "name", value: [{value_type: "string", value_content: "données personnelles sur le flux de Sitran vers Myrent"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "chercher des données personnelles (va sur webservice)"}, ]}, 
