...
{slot_reference: "name", value: [{value_type: "string", value_content: "données de la dette sur le flux de Gestion Des Debiteurs vers SPF Justice"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données de la dette sur le flux de Gestion Des Débiteurs vers SPF Justice"}, ]}, 
