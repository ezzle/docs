...
{slot_reference: "name", value: [{value_type: "string", value_content: "Docis user management  gestion des droits d'accès aux sites intranet Docis et Docis user mgmt."}, ]}, 
