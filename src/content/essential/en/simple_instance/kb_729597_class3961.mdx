...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof stand alone  vérifier pour quels employeurs un ESS n'a pas de mandat pour rentrer une déclaration PP"}, ]}, 
