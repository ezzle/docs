...
{slot_reference: "description", value: [{value_type: "string", value_content: "une base de données Access pour le traitement des demandes de décisions anticipées en matière fiscale."}, ]}, 
