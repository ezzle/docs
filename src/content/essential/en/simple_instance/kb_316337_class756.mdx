...
{slot_reference: "name", value: [{value_type: "string", value_content: "service VIP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Repository de documents pour les Directions I 5A, I 5B, I 3 et I 6A Application indépendante de tout autre projet 
Développé avec PHPRunner"}, ]}, 
