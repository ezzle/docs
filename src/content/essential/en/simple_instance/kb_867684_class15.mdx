...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_867684_Class16"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "informatie over akten ivm geregionaliseerde erfbelasting op flow van Vlabel naar Magda (externe niet FOD Fin applicaties) managed by Vlabel"}, ]}, 
