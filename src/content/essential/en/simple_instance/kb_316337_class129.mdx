...
{slot_reference: "name", value: [{value_type: "string", value_content: "Taxification en matière de blanchiment et description de la fraude grave"}, ]}, 
