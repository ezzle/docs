...
{slot_reference: "name", value: [{value_type: "string", value_content: "identification des personnes sur le flux de TR Restitution vers ESucc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de TR Restitution vers ESucc"}, ]}, 
