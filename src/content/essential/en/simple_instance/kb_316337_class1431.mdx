...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service RicohPrinters"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "application pour la gestion des imprimantes Ricoh"}, ]}, 
