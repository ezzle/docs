...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PC Certification d'origine"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Oorsprongscertificatie. Application sur PC (local), pas d'application MASP"}, ]}, 
