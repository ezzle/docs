...
{slot_reference: "name", value: [{value_type: "string", value_content: "banaeos-enregistrer la demande pour l' attribution (éventuelle) d'une autorisation AEO"}, ]}, 
