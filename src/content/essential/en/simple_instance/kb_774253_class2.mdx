...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_774253_Class3"}, ]}, 
...
Op basis van Eori nr. kunnen we Btw nr. en adresgegevens ophalen, want het gebeurt dat deze niet correct ingevuld zijn in Plda."}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Overtredingsinformatie op Flow van PLDA naar Register 480 managed by PLDA"}, ]}, 
