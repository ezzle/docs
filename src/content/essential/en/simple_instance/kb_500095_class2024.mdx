...
{slot_reference: "name", value: [{value_type: "string", value_content: "données signalétiques sur le flux de Sitran vers MOSS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données signalétiques sur le flux de Sitran vers MOSS"}, ]}, 
