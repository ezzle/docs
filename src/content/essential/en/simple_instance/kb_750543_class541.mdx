...
{slot_reference: "name", value: [{value_type: "string", value_content: "P701 Collecte et échange de demandes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Collecte et échange de demandes (P701)"}, ]}, 
