...
{slot_reference: "name", value: [{value_type: "string", value_content: "données de remboursements sur le flux de Fin Rek vers Icpc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données de remboursements sur le flux de Fin Rek vers Icpc"}, ]}, 
