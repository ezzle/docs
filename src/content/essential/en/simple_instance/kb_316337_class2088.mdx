...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service exercice d'imposition Personnes Morales"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Enregistrement des données fiscales relatives aux déclarations VenB, GNI/ven. et RPB"}, ]}, 
