...
{slot_reference: "name", value: [{value_type: "string", value_content: "AEO  annulations et regularisations  vue sur le nombre de déclarations d'importation et d'exportation annulées et régularisées, où les opérateurs économiques agréés (opérateurs avec une autorisation AEO) agissaient comme déclarant"}, ]}, 
