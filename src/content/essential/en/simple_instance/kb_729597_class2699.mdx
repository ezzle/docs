...
{slot_reference: "name", value: [{value_type: "string", value_content: "FACO  consulter les aperçus par rapport à des faillites des opérateurs spécifiques qui étaient titulaire d'une licence d'établissements d'accises valables, AEO, procédures douanières, ecoboni, produits d'énergie et électricité, ethylalcool et boissons alcoolisées et produits du tabac"}, ]}, 
