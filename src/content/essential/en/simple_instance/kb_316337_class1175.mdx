...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Business Data Management"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion des métadonnées de toutes les bases de données."}, ]}, 
