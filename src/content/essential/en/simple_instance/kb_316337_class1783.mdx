...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Déchets"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "enregistration des rapports de contrôle sur les déchets"}, ]}, 
