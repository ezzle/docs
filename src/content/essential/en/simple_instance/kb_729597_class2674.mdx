...
{slot_reference: "name", value: [{value_type: "string", value_content: "établissements d'accises-enregistrer des licences délivrés d'établissements d'accises"}, ]}, 
