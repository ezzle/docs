...
{slot_reference: "name", value: [{value_type: "string", value_content: "hyperlink sur le flux de pqui vers cdib website"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "hyperlink sur le flux de pdie vers cdib website"}, ]}, 
