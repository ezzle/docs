...
{slot_reference: "description", value: [{value_type: "string", value_content: "db vanaanfus (VA) Fichier Va-anfus : articles chiffrés historiquement versements anticipés"}, ]}, 
