...
{slot_reference: "name", value: [{value_type: "string", value_content: "SAFS  transmettre des actes des tiers saisies simplifiés  de Safs vers la BCSS"}, ]}, 
