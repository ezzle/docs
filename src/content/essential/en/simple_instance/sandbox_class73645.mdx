...
{slot_reference: "name", value: [{value_type: "string", value_content: "données de faillite sur le flux de Sp10b vers Fail Manager"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données de faillite sur le flux du Sp10b vers le gestionnaire des défaillances"}, ]}, 
