...
{slot_reference: "name", value: [{value_type: "string", value_content: "Emcs créer un accusé de réception: opérateur économique: destinataire final, opérateur économique: expéditeur"}, ]}, 
