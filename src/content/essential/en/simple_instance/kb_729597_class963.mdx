...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  Vraag een zoekopdracht voor slapende activa namens een derde partij (zoekdienst voor slapende activa)"}, ]}, 
