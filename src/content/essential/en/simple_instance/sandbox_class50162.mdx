...
{slot_reference: "name", value: [{value_type: "string", value_content: "ARITECH_PROD (contrôle d'accès)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le contrôle d’accès aux bâtiments: 5.000 NAMUR RUE DES BOURGEOIS 7"}, ]}, 
