...
{slot_reference: "name", value: [{value_type: "string", value_content: "publication de questions parlementaires (via email) sur le flux de FinDemand (ACM workflow dossiers transversaux) vers Fisconet+"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "publication de questions parlementaires (via email) sur le flux de FinDemand (ACM workflow dossiers transversaux) vers Fisconet+"}, ]}, 
