...
{slot_reference: "name", value: [{value_type: "string", value_content: "SP 10B  faillissementen CODA Files"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "SP 10B  faillissementen CODA Files"}, ]}, 
