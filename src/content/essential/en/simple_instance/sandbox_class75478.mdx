...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Trésorie compte courant  Ouvrir un dossier sur un compte de tiers et verser les fonds"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "compte courant  Ouvrir un dossier sur un compte de tiers et verser les fonds"}, ]}, 
