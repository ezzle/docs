...
{slot_reference: "name", value: [{value_type: "string", value_content: "signatures sur le flux de Der vers Adobe Lifecycle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "des signatures sur le flux de Der vers Adobe Lifecycle"}, ]}, 
