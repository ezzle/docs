...
{slot_reference: "name", value: [{value_type: "string", value_content: "Fonction hyperlink pour flux de Locostat vers Fotocol"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Locostat vers Fotocol (hyperlink)"}, ]}, 
