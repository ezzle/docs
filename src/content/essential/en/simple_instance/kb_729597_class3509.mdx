...
{slot_reference: "name", value: [{value_type: "string", value_content: "MBM  nombres et totaux trimestriels et annuels en fonction des points de mesure du plan stratégique"}, ]}, 
