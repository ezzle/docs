...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  Collection-Public sale notification  notification des ventes publiques à traiter"}, ]}, 
