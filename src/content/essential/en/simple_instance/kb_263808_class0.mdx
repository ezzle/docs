...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_341339_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info over uitgevoerde betalingen Stipad facturen op flow van Fedcom naar Stipad via FTP managed by FEDCOM_PROD"}, ]}, 
