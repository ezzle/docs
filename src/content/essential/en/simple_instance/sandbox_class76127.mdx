...
{slot_reference: "name", value: [{value_type: "string", value_content: "données dettes non fiscales sur le flux de First non fiscale vers ICPC pour bilan fiscal (chargement hebdomadaire)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Des données des dettes non fiscales sur le flux de First non fiscale vers ICPC pour bilan fiscal (chargement hebdomadaire)"}, ]}, 
