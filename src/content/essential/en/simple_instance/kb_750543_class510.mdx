...
{slot_reference: "name", value: [{value_type: "string", value_content: "P114 Support administratif"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "support administratif (p114)"}, ]}, 
