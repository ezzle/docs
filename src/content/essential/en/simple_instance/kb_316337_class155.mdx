...
{slot_reference: "name", value: [{value_type: "string", value_content: "Collaborer à l’échange, la collecte et l’analyse d’informations en rapport avec le financement du terrorisme"}, ]}, 
