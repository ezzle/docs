...
{slot_reference: "name", value: [{value_type: "string", value_content: "remboursements des droits d'enregistrement surpayés sur le flux de Comfor Java vers Btm par service web comfor java"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Comfor Java vers Btm par webservice comfor java. Des données des paiements sortants sont envoyés vers BPOST"}, ]}, 
