...
{slot_reference: "name", value: [{value_type: "string", value_content: "site web général cdib-portail d'information concernant différentes matières, comme la douane maritime et le Backscatter"}, ]}, 
