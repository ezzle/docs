...
{slot_reference: "name", value: [{value_type: "string", value_content: "Emcs créer provisoirement un e-AD: opérateur économique: expéditeur, bureau d'accises"}, ]}, 
