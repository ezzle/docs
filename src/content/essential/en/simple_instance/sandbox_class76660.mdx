...
{slot_reference: "name", value: [{value_type: "string", value_content: "hyperlink sur le flux de tabak vers site web G&amp;I"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "hyperlink sur le flux de tabak vers website G&amp;I"}, ]}, 
