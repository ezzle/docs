...
{slot_reference: "name", value: [{value_type: "string", value_content: "ATV-suivi du quota pour les achats des véhicules avec une exonération (temporaire) des droits de douane et/ou TVA"}, ]}, 
