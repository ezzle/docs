...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire déviation vérification – déviation vérification"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déviation verification"}, ]}, 
