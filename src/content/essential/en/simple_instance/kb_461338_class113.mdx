...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_461338_Class114"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Toepasselijk BTW % in een bepaalde lidstaat op flow van TIC (Taxation information en communication) naar MOSS managed by TIC Taxation information en communication"}, ]}, 
