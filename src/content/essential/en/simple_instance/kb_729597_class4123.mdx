...
{slot_reference: "name", value: [{value_type: "string", value_content: "First recovery  Court bailiff assignment  donner une mission à un huissier"}, ]}, 
