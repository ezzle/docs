...
{slot_reference: "description", value: [{value_type: "string", value_content: "db Vorst (VA)  vorige toestand Bestand Va-VORST : historiek van terugbetalingen (vorige toestand)"}, ]}, 
