...
{slot_reference: "name", value: [{value_type: "string", value_content: "Etablir et exécuter un plan d'action annuel 'Mesure de la charge de travail'"}, ]}, 
