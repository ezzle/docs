...
{slot_reference: "name", value: [{value_type: "string", value_content: "ESB_PROD fonctionalité Message Bus : livraison, routage, transformation, enrichissement, orchestration, techniques, adapters"}, ]}, 
