...
{slot_reference: "name", value: [{value_type: "string", value_content: "PC Fichier des diplomates_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Diplomaten est une application sur PC (local). Cette application n'existe plus. Maintenant application actuelle = vergunningen ?"}, ]}, 
