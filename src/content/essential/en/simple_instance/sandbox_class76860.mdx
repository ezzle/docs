...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification concernant des addresses étrangères sur le flux de APF vers Stirint OCDE"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de APF vers Stirint OCDE. Via le module APF les données d'identification concernant des addresses étrangères reçu de Stirint OCDE, sont recherchées automatiquement dans Sitran."}, ]}, 
