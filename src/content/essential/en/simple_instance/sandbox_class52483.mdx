...
{slot_reference: "name", value: [{value_type: "string", value_content: "RPBBEL  RPB 2011_PROD (enrôlements d'impots des sociétés)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application concernant les enrôlements d'impots des sociétés, exercice d'imposition 2011."}, ]}, 
