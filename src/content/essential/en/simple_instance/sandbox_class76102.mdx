...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données du plan cadastral sur le flux du serveur FTP vers Stipad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données plan cadastral sur le flux de FTP server vers Stipad"}, ]}, 
