...
{slot_reference: "name", value: [{value_type: "string", value_content: "flux du bilan fiscal ICPC vers Esucc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux d'ICPC bilan fiscal vers Esucc"}, ]}, 
