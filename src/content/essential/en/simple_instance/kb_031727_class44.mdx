...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "BBF  fichier CSV rempli par un collaborateur du Fonds spécial de protection managed by BBF  Applications de calculs fiscaux_prod"}, ]}, 
