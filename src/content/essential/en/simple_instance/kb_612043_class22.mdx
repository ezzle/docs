...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_682726_Class6"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Authenticatiegegevens op flow van Pandregister naar Fediam (stroom naar externe niet Fod Fin applicatie) managed by Pandregister"}, ]}, 
