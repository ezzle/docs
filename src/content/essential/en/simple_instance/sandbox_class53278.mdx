...
{slot_reference: "name", value: [{value_type: "string", value_content: "Horaires des travailleurs postés (AG D&amp;A)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Nouvelle application développée par AG Douane et Accises pour les horaires des travailleurs postés"}, ]}, 
