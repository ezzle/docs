...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Calcul IPM"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "service de calcul de l'impôt des personnes morales"}, ]}, 
