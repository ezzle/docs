...
{slot_reference: "name", value: [{value_type: "string", value_content: "données parcellaires (identification cadastrale / coördonnées de géolocalisation) sur le flux de Arcmap vers Cadgis"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données parcellaires (identification cadastrale / coördonnées de géolocalisation) sur le flux de Arcmap vers Cadgis"}, ]}, 
