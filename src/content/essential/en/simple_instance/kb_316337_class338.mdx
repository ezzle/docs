...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mettre en oeuvre le Customs Container Release Message (CCRM) – Phase 2 (intégration de la ENS et de la circulation plus facile entre les Pays-Bas et la Belgique)"}, ]}, 
