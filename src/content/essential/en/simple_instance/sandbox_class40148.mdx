...
{slot_reference: "name", value: [{value_type: "string", value_content: "Parties intéressées : catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des acteurs individuels de l'organisation renseignés dans l'architecture."}, ]}, 
