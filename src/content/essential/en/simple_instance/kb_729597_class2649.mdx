...
{slot_reference: "name", value: [{value_type: "string", value_content: "FCP Audit  aperçu au niveau d'un document (MRN) des libérations dans MASP-PLDA incl. la différence de temps entre les status 542 et 507 (respectivement entre les status Contrôle par MODA et biens libérés)"}, ]}, 
