...
{slot_reference: "name", value: [{value_type: "string", value_content: "Renvoi Automatique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce service permet de renvoyer automatiquement les messages en cas dՎchec lors du premier essai. Ce module est disponible au sein du framework CCFF."}, ]}, 
