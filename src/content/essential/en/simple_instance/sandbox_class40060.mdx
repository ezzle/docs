...
{slot_reference: "name", value: [{value_type: "string", value_content: "Parties intéressées synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétique des principaux attributs ou relation de chaque partie intéressée"}, ]}, 
