...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Geslid"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion des demandes de LID’s (= identifiant sur le mainframe BULL [autp])"}, ]}, 
