...
{slot_reference: "name", value: [{value_type: "string", value_content: "Réaliser des actions ciblées pour les groupes à risque identifiés dans l'accord de gouvernement"}, ]}, 
