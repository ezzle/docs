...
{slot_reference: "name", value: [{value_type: "string", value_content: "Flux de Graydon vers Faco actualisationr (informations sur les faillites)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Graydon vers Faco updater (informations sur les faillites)"}, ]}, 
