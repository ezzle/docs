...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  module générique  gestion des dossiers  UC  31-51 Suivi automatique des dossiers"}, ]}, 
