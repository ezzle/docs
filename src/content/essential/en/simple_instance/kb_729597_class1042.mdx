...
{slot_reference: "name", value: [{value_type: "string", value_content: "Belconet archiv_PROD  conversion du fichier plat (reçu du Bull mainframe) dans diverses fichiers pdf (zip) sur base d'une extraction des indexes"}, ]}, 
