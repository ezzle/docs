...
{slot_reference: "name", value: [{value_type: "string", value_content: "données sur des entreprises multinationales (MNE’s) concernant des impôts directs sur le flux de Ccn1 vers Stirint CBC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données sur des entreprises multinationales (MNE’s) concernant des impôts directs sur le flux de CCN1 vers Stirint CBC"}, ]}, 
