...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Succession  valider la demande de versement par les autres héritiers"}, ]}, 
