...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_417201_Class9"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Toekomst: POW-gegevens nodig ter voorbereiding hypothecaire inschrijving op flow van Consultimmo naar Debiteurenbeheer (voorlopig nog manueel o.b.v. POW, toekomst mogelijks via aanroep Consultimmo webservices) managed by ConsultImmo"}, ]}, 
