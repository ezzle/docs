...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de document comptable type amende pénale  sous type coûts additionels par application d'établissement penal fines"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de document comptable type amende pénale  sous type coûts additionels par application d'établissement penal fines"}, ]}, 
