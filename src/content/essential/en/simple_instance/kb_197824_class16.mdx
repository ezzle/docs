...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_197824_Class17"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "boekhoudkundige gegevens BTW aangiften m.b.t. diensten van telecommunicatie, radio en televisieomroep of elektronische diensten verleend aan mensen die niet btw-plichtig zijn in de lidstaten waarin deze diensten gebruikt worden, op flow van Moss naar Fedcom managed by Mini One Stop Shop Back Office_prod (MOSS)"}, ]}, 
