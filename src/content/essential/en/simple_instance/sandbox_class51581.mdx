...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des transferts de fichiers des Ftp's et des account Ftp (remplacée par Sterling)"}, ]}, 
