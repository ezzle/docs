...
{slot_reference: "name", value: [{value_type: "string", value_content: "Emcs créer une modification de destination: opérateur économique: expéditeur, opérateur économique: destinataire actuel"}, ]}, 
