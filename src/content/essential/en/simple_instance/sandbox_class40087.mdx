...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données  Sujet  synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétique des principaux attributs ou relations de chaque donnée sujet conceptuelle"}, ]}, 
