...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_138152_Class192"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Documenten (aktes?) op flow van Filenet ECM webservices naar Stipad managed by Filenet_PROD"}, ]}, 
