...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire PM6  notification de décision pour taxation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire PM6  notification de décision pour taxation"}, ]}, 
