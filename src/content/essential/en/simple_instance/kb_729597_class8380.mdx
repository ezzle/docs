...
{slot_reference: "description", value: [{value_type: "string", value_content: "Le Domain Name System (DNS : système de noms de domaine) est un système qui permet d’établir la correspondance entre un nom de domaine et une adresse IP, ou, plus generalement, de retrouver certaines informations a partir d’un nom de domaine."}, ]}, 
