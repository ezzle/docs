...
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Labnet est une application sur PC (local) qui est maintenant remplacé par LIMS."}, ]}, 
