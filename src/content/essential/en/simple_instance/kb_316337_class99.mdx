...
{slot_reference: "name", value: [{value_type: "string", value_content: "Soutenir tous les collaborateurs pour répondre aux interactions générales"}, ]}, 
