...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application Access des Handicapés"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L'application Access du Service P&amp;O contient des données personnelles des agents avec un handicap."}, ]}, 
