...
{slot_reference: "name", value: [{value_type: "string", value_content: "Locostat vérification des biens à contrôler dans le zone de l'expert"}, ]}, 
