...
{slot_reference: "name", value: [{value_type: "string", value_content: "données consolidées de MASP-PLDA, Seda et FEEDBACK sur le flux de monitoringtool vers feedback"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données consolidées de MASP-PLDA, Seda et FEEDBACK sur le flux de monitoringtool vers feedback"}, ]}, 
