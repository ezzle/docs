...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 104sp:Fiche services publics"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fiche d'information pour les services publics sur les fournitures et travaux, les loyers, les indemnités d'expropriation, les subventions, les allocations, etc."}, ]}, 
