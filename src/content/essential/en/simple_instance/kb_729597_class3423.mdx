...
{slot_reference: "name", value: [{value_type: "string", value_content: "TC non automatisée  rappels informatifs qui renseignent le titulaire d'un véhicule sur le fait que le véhicule doit être déclaré à partir de la mise en circulation"}, ]}, 
