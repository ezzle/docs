...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  Valider un fichier XML (fichier reçu des institutions financières)"}, ]}, 
