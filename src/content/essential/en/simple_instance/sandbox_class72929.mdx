...
{slot_reference: "description", value: [{value_type: "string", value_content: "db VA db UIT3 Fichier VA-UIT3 : montants prêts dans le futur libérés : sont envoyés au Taxi et à l'inscription impôts des sociétés  création du fichier VAUIT3 selon la date du bilan : 1x pour la clôture du bilan au 31/12 et mensuellement pour les autres dates du bilan."}, ]}, 
