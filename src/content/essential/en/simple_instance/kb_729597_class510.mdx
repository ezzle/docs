...
{slot_reference: "name", value: [{value_type: "string", value_content: "ICPC  enrôlement des droits constatés (articles d'enrôlement) traité par ICPC"}, ]}, 
