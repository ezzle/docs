...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class127"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info over AEO vergunningen op flow van AEO naar IPI informatieplan managed by AEO_PROD (Belgische Douane)  MASP vergunningen"}, ]}, 
