...
{slot_reference: "name", value: [{value_type: "string", value_content: "statistiques pour géomètres sur base de données Consultimmo sur le flux de Sigma vers MyMinfin PRO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "statistiques pour géomètres sur la base de données Consultimmo sur le flux de Sigma vers MyMinfin PRO"}, ]}, 
