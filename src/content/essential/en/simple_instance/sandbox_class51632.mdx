...
{slot_reference: "name", value: [{value_type: "string", value_content: "GE (Grandes Entreprises)_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de gestion de la population des Grandes Entreprises(GE) qui permet l'assignation automatique des Grandes Entreprises."}, ]}, 
