...
{slot_reference: "name", value: [{value_type: "string", value_content: "DMGC (data mgt. system)  gestion des contrôles demandées et des mécanismes de fraude identifiés"}, ]}, 
