...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_242815_Class7"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Lijsten betreffende de invoer en de weegcertificaten van bananen op flow van Agristat4 naar Dienst Tarief managed by AGRISTAT 4_Prod"}, ]}, 
