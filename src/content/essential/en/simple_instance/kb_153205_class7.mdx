...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_153205_Class8"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Alle patrimoniale informatie voor het grondgebied van de gemeente op jaarlijkse flow van Sigma naar Urbain (human interface) managed by Sigma_Prod"}, ]}, 
