...
{slot_reference: "name", value: [{value_type: "string", value_content: "recettes du modèle mathematique sur le flux de Respo vers SAS (interface  SAS mathematique modèle  Respo)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Respo vers SAS (interface  modèle mathématique SAS  Respo) 
Interface  Locoselect / Respo / TR pour les revenus Modèle mathématique"}, ]}, 
{slot_reference: "system_content_lifecycle_status", value: [{value_type: "simple_instance", value_content: "KB_229567_Class67"}, ]}, 
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class78787"}, ]}, 
