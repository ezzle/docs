...
{slot_reference: "description", value: [{value_type: "string", value_content: "Encodage dans la base de données sur la base des informations fournies par le locataire."}, ]}, 
