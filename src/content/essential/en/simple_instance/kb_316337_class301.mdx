...
{slot_reference: "name", value: [{value_type: "string", value_content: "Conclure des protocoles et des contrats de collaboration avec différentes parties prenantes"}, ]}, 
