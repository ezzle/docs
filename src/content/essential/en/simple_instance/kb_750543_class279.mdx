...
{slot_reference: "name", value: [{value_type: "string", value_content: "P77 Prévention et protection"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "? Prévention et protection (p77)"}, ]}, 
