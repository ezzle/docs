...
{slot_reference: "name", value: [{value_type: "string", value_content: "remboursements de taxe de circulation sur le flux de taxe de circulation automatisée vers UIT"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux remboursements de taxe de circulation de Taxe de Circulation Automatisée vers UIT, flux mensuel"}, ]}, 
