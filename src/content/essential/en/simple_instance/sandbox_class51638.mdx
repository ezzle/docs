...
{slot_reference: "name", value: [{value_type: "string", value_content: "GrandsLivres (souscrire à des bons d'état)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de l'Agence de la dette qui doit permettre à des citoyens de souscrire à des bons d'état."}, ]}, 
