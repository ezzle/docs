...
{slot_reference: "name", value: [{value_type: "string", value_content: "Capacité technologique : résumé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit une vue synthétique des principales caractéristiques d'une capacité technologique"}, ]}, 
