...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaires attestations 276 CONV (AG Fisc)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaires attestations 276 CONV (AG Fisc)"}, ]}, 
