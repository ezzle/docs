...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pdump Pcomp  résumé des dossiers clôturés et à traiter sur les contrôles des droits antidumping et compensateurs"}, ]}, 
