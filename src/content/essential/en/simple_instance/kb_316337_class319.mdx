...
{slot_reference: "name", value: [{value_type: "string", value_content: "Simplification administrative"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "La simplification administrative va également de pair avec l’e-government, la simplification et la digitalisation des processus."}, ]}, 
