...
{slot_reference: "name", value: [{value_type: "string", value_content: "Développer des synergies entre l'approche liée aux biens et l'approche liée aux opérateurs"}, ]}, 
