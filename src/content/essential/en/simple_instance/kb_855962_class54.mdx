...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_855962_Class55"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "alimentatieschulden op toekomstige flow van secal php naar first managed by Secal-Davo PHP_Prod"}, ]}, 
