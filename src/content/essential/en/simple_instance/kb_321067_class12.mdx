...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_321067_Class13"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "schuldinformatie op flow van ICPC naar WSM (wang screen mgr) managed by ICPC_PROD"}, ]}, 
