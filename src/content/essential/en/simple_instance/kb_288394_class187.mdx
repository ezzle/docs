...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class188"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_688041_Class20"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie omtrent elektronisch door notaris neergelegde akte met verzoek teruggave op flow van DER naar Respo / TR Restitution (manuele gegevensinvoer) managed by TR-Restitution"}, ]}, 
