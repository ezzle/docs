...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Succession  récupérer les fonds si héritiers connus de la CDC"}, ]}, 
