...
{slot_reference: "description", value: [{value_type: "string", value_content: "L’interface Fich-elec permet à Aut-TP/PO de gérer sa documentation électronique."}, ]}, 
