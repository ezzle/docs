...
{slot_reference: "name", value: [{value_type: "string", value_content: "Collaborer avec les régions pour améliorer la qualité du plan cadastral"}, ]}, 
