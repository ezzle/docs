...
{slot_reference: "name", value: [{value_type: "string", value_content: "Déterminer l'approche de recouvrement (p27)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déterminer l'approche de recouvrement"}, ]}, 
