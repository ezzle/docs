...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pdump Pcomp  ter beschikkingstelling van aangiften met betrekking tot de voorlopige antidumpingrechten (A35) en de voorlopige compenserende rechten (A45)"}, ]}, 
