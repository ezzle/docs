...
{slot_reference: "name", value: [{value_type: "string", value_content: "Cloaf Ninstitutions financières  clôture quotidienne et dehors de First des comptes de l'entreprise pour les dettes non fiscales"}, ]}, 
