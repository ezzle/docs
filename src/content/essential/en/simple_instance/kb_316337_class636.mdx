...
{slot_reference: "name", value: [{value_type: "string", value_content: "Développer un processus et une méthodologie (HR Cockpit) pour le suivi permanent de l'activité avec la collaboration des administrations générales et des services d'encadrement"}, ]}, 
