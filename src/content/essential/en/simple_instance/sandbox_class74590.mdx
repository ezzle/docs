...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 371BISP:annexe formulaire pour 371bis  Personnes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "annexe formulaire 371bis  désignation des Personnes"}, ]}, 
