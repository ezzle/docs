...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification sur le flux de Sitran vers Stirint DLO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données d'identification sur le flux de Sitran vers Stirint DLO"}, ]}, 
