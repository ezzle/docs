...
{slot_reference: "name", value: [{value_type: "string", value_content: "Centaur_PROD (contrôle d’accès)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le contrôle d’accès de Dinant."}, ]}, 
