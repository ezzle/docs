...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  consulter le détail du dossier de demande (recherches et reporting)"}, ]}, 
