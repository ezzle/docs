...
name: "snapshot 29-02-16_Class340"
type: "Technology_Function"
supertype: ["Technology_Logical", "Technology_Layer", "EA_Class", ":THING", "EA_Graph_Management", "EA_System"]
own_slot_value: [{slot_reference: "name", value: [{value_type: "string", value_content: "&lt; Dubbele redundante laag      Double couche redondante  &gt;::&lt;  Access control          Access control&gt;"}, ]}, 
