...
{slot_reference: "name", value: [{value_type: "string", value_content: "SP 10B  faillissementen' SepaService Request Parameters"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "SP 10B  Faillites' SepaService Request Parameters"}, ]}, 
