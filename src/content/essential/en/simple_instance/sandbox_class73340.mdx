...
{slot_reference: "name", value: [{value_type: "string", value_content: "Situations de propriété / transferts de propriété des parcelles sur le flux de Consultimmo vers Précompte Immobilier pour la Flandre par l'intégrateur de service"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Consultimmo vers précompte immobilier Interface avec passage à OV (précompte immobilier) par AG Fisc VDI Interface avec passage à OV (précompte immobilier) par AG Fisc (intégrateurs de service = VDI)."}, ]}, 
