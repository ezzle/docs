...
{slot_reference: "name", value: [{value_type: "string", value_content: "P057.BAI10 Gestion de la configuration (gestion de la capacités et de laconfiguration)"}, ]}, 
