...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class55"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "annulaties en regularisaties op Flow van Banaeos naar AEO managed by BANAEOS_Prod"}, ]}, 
