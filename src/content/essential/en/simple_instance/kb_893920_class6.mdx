...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "maquettes van pdf documenten op flow van scriptura naar columbus fedopress managed by Scriptura_PROD"}, ]}, 
