...
{slot_reference: "name", value: [{value_type: "string", value_content: "Lancer et poursuivre les initiatives pour la simplification des procédures douanières : Centralised Clearance (CC)"}, ]}, 
