...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation sur base de First de la notification de saisie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation sur la base de First de la notification de saisie"}, ]}, 
