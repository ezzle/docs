...
{slot_reference: "name", value: [{value_type: "string", value_content: "Protéger les données et sécurité de l'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Établir et mettre en oeuvre un plan de sécurité de l'information stratégique au sein du SPF Finances"}, ]}, 
