...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class67"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie om factuur op te maken (voor kadastrale uitreksels) in 1 dagelijkse grote XML via FTP (of voor SAP klanten: 1 grote factuur per maand) op flow van Stipad naar Fedcom via FTP (stroom naar externe niet Fod Fin applicatie) managed by STIPAD"}, ]}, 
