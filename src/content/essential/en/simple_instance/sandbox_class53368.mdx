...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la gestion des dossiers pour les services du président: application Oracle sur un operating system windows."}, ]}, 
