...
{slot_reference: "name", value: [{value_type: "string", value_content: "Assurer de manière continue les besoins étendus en formations techniques et génériques au sein de l'organisation via l’Académie et dans les délais proposés avec une attention particulière pour les formations techniques"}, ]}, 
