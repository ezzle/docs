...
{slot_reference: "name", value: [{value_type: "string", value_content: "certification"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Le Framework CCFF offre des services de certification offrant une transparence maximum."}, ]}, 
