...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat 4 registratie van de aangiften in het kader van de invoer van granen, de invoer en de weegcertificaaten van bananen, de uitvoer van suiker, de restituties en de substitutiecontroles."}, ]}, 
