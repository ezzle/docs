...
{slot_reference: "name", value: [{value_type: "string", value_content: "PLDA déclaration d'importation sur le flux de Goodsflow vers ICS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PLDA-déclaration d'importation gevalideerd par check dans Goodsflow"}, ]}, 
