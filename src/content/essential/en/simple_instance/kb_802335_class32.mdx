...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_802335_Class33"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "BTW aangifte nr. 446 op flow van intervat naar Stiron np managed by Intervat_prod"}, ]}, 
