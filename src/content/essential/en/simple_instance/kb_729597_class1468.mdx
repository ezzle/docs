...
{slot_reference: "name", value: [{value_type: "string", value_content: "régistre 480  livraison des extraits de données de l'application régistre 480 au watchlist PNR (Passenger Name Record)"}, ]}, 
