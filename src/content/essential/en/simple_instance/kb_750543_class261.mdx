...
{slot_reference: "name", value: [{value_type: "string", value_content: "P089 Infothèque"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "? Infothèque (p89)"}, ]}, 
