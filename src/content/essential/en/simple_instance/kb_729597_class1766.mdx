...
{slot_reference: "name", value: [{value_type: "string", value_content: "Cocy  pour le team CABC/SBC: statistiques des opérateurs, postes ou la combinaison des postes et pays"}, ]}, 
