...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros de comptes financiers sur le flux de Calcul Ipp vers taxi (stockés par Calculipp service web et db TAXI)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "numéros de comptes financiers sur le flux de Calcul Ipp vers taxi (stockés par Calculipp webservice dans db TAXI)"}, ]}, 
