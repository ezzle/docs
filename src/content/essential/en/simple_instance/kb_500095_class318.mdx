...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de l'accord amiable par application d'établissement penal fines (component transaction)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de l'accord amiable par application d'établissement penal fines (component transaction)"}, ]}, 
