...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PC Labnet"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Labnet. Application sur PC (local): accès alloués localement et gérés localement. Application qui est maintenant remplacé par LIMS."}, ]}, 
