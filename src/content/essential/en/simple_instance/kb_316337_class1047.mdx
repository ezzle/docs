...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Carpoolplaza"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Est un lien vers la plus grande base de données de covoiturage en Belgique www.Taxistop.be"}, ]}, 
