...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class147"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Instructies (omzendbrieven) op flow van Risicobeheer DMGC naar DMGC Website menu managed by RISICOBEHEER-DMGC-GESTION DES RISQUES_Prod"}, ]}, 
