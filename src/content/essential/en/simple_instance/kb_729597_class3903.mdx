...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pdump Pcomp  mise à disposition des déclarations par rapport aux droits antidumping (A35) et droits compensateurs (A45) provisoires"}, ]}, 
