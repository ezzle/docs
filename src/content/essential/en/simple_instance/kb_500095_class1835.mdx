...
{slot_reference: "name", value: [{value_type: "string", value_content: "selection documents pdf de Der sur le flux de Stipad vers Filenet"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "selection documents pdf de Der sur le flux de Stipad vers Filenet"}, ]}, 
