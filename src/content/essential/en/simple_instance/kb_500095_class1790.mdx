...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations de la dette sur le flux d'ICPC vers WSM (wang screen mgr)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "informations de la dette sur le flux d'ICPC vers WSM (wang screen mgr)"}, ]}, 
