...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire EORI a3"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "EORI formulaire: demande/BE/EORI/A3  formulaire de demande pour un numéro EORI pour une entreprise Belge ou personne"}, ]}, 
