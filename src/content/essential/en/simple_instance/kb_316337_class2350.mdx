...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service MessageStore"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Système de fichiers MASP dans lequel des messages sont stockés"}, ]}, 
