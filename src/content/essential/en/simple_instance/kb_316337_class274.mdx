...
{slot_reference: "name", value: [{value_type: "string", value_content: "Optimiser le processus 'traductions' grâce à l'intégration de l'application Trados en vue de disposer d'une base de données partagée pour la gestion des traductions"}, ]}, 
