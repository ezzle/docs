...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion de la Comptabilité des dépôts"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion Comptabilité des dépôts"}, ]}, 
