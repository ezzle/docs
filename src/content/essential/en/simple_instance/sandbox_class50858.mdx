...
{slot_reference: "description", value: [{value_type: "string", value_content: "Webservice pour l'utilisation des outils pdf dans le cadre du framework CCFF"}, ]}, 
