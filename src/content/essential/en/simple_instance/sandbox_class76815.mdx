...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification sur le flux manuel de Sitran vers Matchmaker"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Le centre de documentation de Denderleeuw recherche manuellement, via le module  Matchmaker , les données d'identification relatives aux adresses étrangères reçues de Stirint Crs qui n'ont pas pu être trouvées par APF à Sitran. Les données d'identification trouvées via le Matchmaker sont ensuite saisies manuellement dans Stirint CRS."}, ]}, 
