...
{slot_reference: "name", value: [{value_type: "string", value_content: "NCTS opladen  charger des extraits de données de l'application MASP-NCTS (New Computerized Transit System), qui sont fournis chaque jour par le service Automatisation"}, ]}, 
