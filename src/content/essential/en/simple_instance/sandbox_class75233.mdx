...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire convention d'utilisateur enregistré  régistre des gages"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "convention d'utilisateur enregistré régistre des gages (en production depuis 1/1/2018)"}, ]}, 
