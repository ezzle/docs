...
{slot_reference: "name", value: [{value_type: "string", value_content: "ICPC  traiter les mouvements sur les comptes bancaires des bureaux de perception (critique)"}, ]}, 
