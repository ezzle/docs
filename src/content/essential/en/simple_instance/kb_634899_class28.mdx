...
{slot_reference: "app_pro_to_inforep_from_app", value: [{value_type: "simple_instance", value_content: "KB_958736_Class1052"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "informatie over eigendomstoestanden van percelen op flow van consultimmo naar Prodocs managed by Prodocs_Prod"}, ]}, 
