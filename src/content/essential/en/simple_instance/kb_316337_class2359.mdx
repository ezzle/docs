...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service ForeCL"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "ForeCL contient des informations sur la valeur de vente des biens immobiliers. Application AA Padoc"}, ]}, 
