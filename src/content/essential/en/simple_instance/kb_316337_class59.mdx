...
{slot_reference: "name", value: [{value_type: "string", value_content: "Apporter un soutien dans le développement personnel et l’évaluation les collaborateurs"}, ]}, 
