...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "RO  Rappel 1 à l'Etat partenaire UE managed by STIRint  DLO_PROD"}, ]}, 
