...
{slot_reference: "name", value: [{value_type: "string", value_content: "180B AUT  Opvolging van de oude schulden en de niet geautomatiseerd ingekohierde schulden (zie ICPC)"}, ]}, 
