...
{slot_reference: "name", value: [{value_type: "string", value_content: "&lt; Application Server Services  &gt;::&lt;  JEE-applicatieserver          Serveur d’applications PhP&gt;"}, ]}, 
