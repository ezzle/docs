...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs_Prod  module listing général  consultation du listing Vatrifund pour remboursement de la TVA dans un dossier étranger pour vérifier si celle-ci a encore des dettes ouvertes vis-à-vis le SPF Finances"}, ]}, 
