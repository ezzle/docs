...
{slot_reference: "description", value: [{value_type: "string", value_content: "Op de site https://www.omgevingsloket.be kan de omgevingsvergunning aangevraagd worden. De omgevingsvergunning verenigt en vervangt de stedenbouwkundige vergunning en de milieuvergunning. Sinds 23 februari 2017 geldt de milieuvergunning / omgevingsvergunning voor een ingedeelde inrichting of activiteit voor onbepaalde duur.
