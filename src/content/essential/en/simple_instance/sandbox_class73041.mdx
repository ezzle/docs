...
{slot_reference: "name", value: [{value_type: "string", value_content: "coûts de l'huissiers"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "coûts de l'huissiers"}, ]}, 
