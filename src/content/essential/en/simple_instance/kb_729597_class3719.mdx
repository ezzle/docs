...
{slot_reference: "name", value: [{value_type: "string", value_content: "Docis  documentation pour une liste des pays pour soutenir le contrôle sur les documents falsifiés"}, ]}, 
