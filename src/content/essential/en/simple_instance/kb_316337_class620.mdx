...
{slot_reference: "name", value: [{value_type: "string", value_content: "Impliquer les membres du personnel en lançant des initiatives de co-création via les plateformes d'échange ou les évènements au niveau central et local"}, ]}, 
