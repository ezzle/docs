...
{slot_reference: "name", value: [{value_type: "string", value_content: "db ADIS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur db ADIS"}, ]}, 
