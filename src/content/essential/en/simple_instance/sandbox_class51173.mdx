...
{slot_reference: "name", value: [{value_type: "string", value_content: "DMFA Trésorerie_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application externe chez Persopoint pour rentrer une déclaration DMFA pour le SPF Finances."}, ]}, 
