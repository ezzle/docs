...
{slot_reference: "name", value: [{value_type: "string", value_content: "InternetAccessStreet (partie du firewall)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application fait partie des services de firewall."}, ]}, 
