...
{slot_reference: "name", value: [{value_type: "string", value_content: "service ServiceNow"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Plate-forme ServiceNow pour la gestion opérationnelle ICT et la gestion des services"}, ]}, 
