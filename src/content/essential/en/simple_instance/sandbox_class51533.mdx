...
{slot_reference: "name", value: [{value_type: "string", value_content: "FIRST-RVBWP_PROD (collecte des déclarations du précompte mobilier)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Partie de l'application FIRST destinée à la collecte des déclarations du précompte mobilier"}, ]}, 
