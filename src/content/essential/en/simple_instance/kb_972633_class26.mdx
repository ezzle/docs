...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_972633_Class27"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "AEO vergunning op flow van AEO EU naar EORI (db EORI) managed by EOS = AEO applicatie (Europese Commissie)"}, ]}, 
