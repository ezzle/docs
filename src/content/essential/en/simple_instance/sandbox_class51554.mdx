...
{slot_reference: "name", value: [{value_type: "string", value_content: "ForeCL (informations sur la valeur de vente des biens immobiliers)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "ForeCL contient des informations sur la valeur de vente des biens immobiliers"}, ]}, 
