...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  ré-injecter l'envoi de la déclaration PP vers le mainframe (à partir d'un bureau de recettes), ainsi la modification du status"}, ]}, 
