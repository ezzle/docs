...
{slot_reference: "name", value: [{value_type: "string", value_content: "connectivité mobile"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce service couvre les raccordements sans fil au réseau interne du FinNet des Finances, à partir de l’extérieur des bâtiments des Finances."}, ]}, 
