...
{slot_reference: "name", value: [{value_type: "string", value_content: "identification opérateur économique dans EORI  db EORI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "identification opérateur économique dans Eori  db EORI"}, ]}, 
