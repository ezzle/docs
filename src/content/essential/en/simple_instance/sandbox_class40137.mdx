...
{slot_reference: "name", value: [{value_type: "string", value_content: "Représentation de données : résumé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les principales relations d'une représentation de donnée."}, ]}, 
