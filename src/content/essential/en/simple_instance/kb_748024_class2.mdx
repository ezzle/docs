...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_748024_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Pseudo artikels van kadastrale matrix op flow van PRI naar Regondes 2 (over ESB) managed by AAPD_PRI_Prod (webservice)"}, ]}, 
