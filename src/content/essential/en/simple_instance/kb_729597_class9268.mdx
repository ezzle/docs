...
{slot_reference: "description", value: [{value_type: "string", value_content: "Applications utilisant l'environnement de développement et d'exécution Powerbuilder et les bases de données Oracle"}, ]}, 
