...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  supprimer la réservation d'un coffre fort (traiter les demandes des bénéficiaires)"}, ]}, 
