...
{slot_reference: "name", value: [{value_type: "string", value_content: "Développer une stratégie et une feuille de route pour la digitalisation dans les prochaines années"}, ]}, 
