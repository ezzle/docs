...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting Personal property withholding taks  déclarer le précompte mobilier sur les dividendes"}, ]}, 
