...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class153"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "accijnsvergunningen voor vervoer onder schorsingsregeling op flow van EMCS Seed naar IPI informatieplan managed by EMCS  SEED_PROD"}, ]}, 
