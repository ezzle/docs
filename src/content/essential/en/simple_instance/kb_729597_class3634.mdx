...
{slot_reference: "name", value: [{value_type: "string", value_content: "Ecoboni  livrer, imprimer et gérer des licences pour emballages réutilisables (avec consigne)"}, ]}, 
