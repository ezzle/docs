...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant des revenus générés par une personne dans un pays où il n'est pas un habitant sur le flux de Stirint Autodt vers Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant des revenus générés par une personne dans un pays où il n'est pas habitant sur le flux de Stirint Autodt vers Stirint isi"}, ]}, 
