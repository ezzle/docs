...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Trésorie dépossession involontaire de titres  récupérer les fonds en TRansférer les titres virtuels"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire Trésorie dépossession involontaire de titres  récupérer les fonds et transférer les titres virtuels"}, ]}, 
