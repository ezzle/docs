...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_366793_Class16"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Signaal op moment dat belastingsgegevens binnenkomen uit het buitenland op flow van Stirint Dlo naar Belconet (volgens SAD doc. Stirint) managed by STIRint  DLO_PROD"}, ]}, 
