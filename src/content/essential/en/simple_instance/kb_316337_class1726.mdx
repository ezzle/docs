...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service TAB"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Petite base de données (table) avec constantes (valeurs constantes concernant l'impôt des sociétés) qui sert comme module."}, ]}, 
