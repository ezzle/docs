...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gérer les cessions de créances à l'aide de deux options : imposer l'obligation aux banques d'introduire les cessions par voie électronique ou leur imputer les frais administratifs"}, ]}, 
