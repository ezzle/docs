...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_568992_Class5"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "(toekomst) XML met tariefgegevens van Europa op flow van CCN Gateway 1 naar toekomstige applicatie Tarbel2 managed by CCN gateway 1"}, ]}, 
