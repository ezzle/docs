...
{slot_reference: "name", value: [{value_type: "string", value_content: "Assurer le lien au niveau international et régional dans le cadre de la transmission d'informations"}, ]}, 
