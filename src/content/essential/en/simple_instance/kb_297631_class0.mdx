...
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce portail donne un échantillon de vues utiles que l'équipe EA peut produire pour vous fournir des informations utiles. Plus disponible sur demande.

Votre voix compte. Contactez-nous via le formulaire de commentaires sur la barre de menu ci-dessus."}, ]}, 
