...
{slot_reference: "name", value: [{value_type: "string", value_content: "Unnecessary requests for information that is already known and available must be prevented to avoid vexing the users and public. Consistency of data is improved."}, ]}, 
