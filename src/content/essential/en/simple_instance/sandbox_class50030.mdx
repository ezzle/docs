...
{slot_reference: "name", value: [{value_type: "string", value_content: "Access Risco_PROD (contrôle d'acces)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour le contrôle d'acces aux bâtiments (1300 WAVRE AVENUE EINSTEIN 8)"}, ]}, 
