...
{slot_reference: "name", value: [{value_type: "string", value_content: "Non IAM Java CCFF weblogic db2 sans filenet sans stack UI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Stack de l'application SAFS (application interne SPF Finances; à la BCSS c'est l'application E Deduction). SAFS = saisie arrêt simplifié caisse de vacances"}, ]}, 
