...
{slot_reference: "name", value: [{value_type: "string", value_content: "Définition et protection des DMZ"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "La fonctionnalité 'Définition et protection des DMZ' englobe tous les composants nécessaires pour pouvoir définir et séparer les différentes DMZ au niveau de la sécurité."}, ]}, 
