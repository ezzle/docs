...
{slot_reference: "name", value: [{value_type: "string", value_content: "données à archiver précompte immobilier sur le flux mensuel de OV to belconet archive"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "précompte immobilier chaque mois archivé"}, ]}, 
