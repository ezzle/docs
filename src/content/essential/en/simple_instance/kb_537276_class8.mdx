...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_537276_Class9"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flow van DER naar Taskmanager (archived interface)"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Uit te voeren taken op flow van DER naar Taskmanager (archived interface) managed by DER_PROD"}, ]}, 
