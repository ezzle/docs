...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_008868_Class59"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "(in ontwikkeling) Informatie op flow van Properties on Web naar Comfor managed by PropertiesOnWeb_Prod"}, ]}, 
