...
{slot_reference: "name", value: [{value_type: "string", value_content: "java-pas de CCFF-MySQL/MariaDB"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "java-pas de CCFF-MySQL/MariaDB"}, ]}, 
