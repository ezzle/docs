...
{slot_reference: "name", value: [{value_type: "string", value_content: "P085 Support juridique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "support juridique (p85)"}, ]}, 
