...
{slot_reference: "name", value: [{value_type: "string", value_content: "Liste des feuilles de calcul pour importation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste des modèles de feuilles de calculs (CSV) permettant d'importer des données dans Essential"}, ]}, 
