...
{slot_reference: "name", value: [{value_type: "string", value_content: "Situations de propriété / transferts de propriété des parcelles de Consultimmo vers l'huissier de justice"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Consultimmo à l'huissier de justice dans l'acceptation datée de mars 2017"}, ]}, 
