...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service CRS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "CRS (Norme commune de présentation de l'information)= standard mondial pour l'échange automatique d'informations financières
Ne s'applique qu'aux impôts directs, pas à la TVA.
Application d'échange automatique d'information concernant le Ruling (décision anticipée) au sein de l'OCDE et au G20 (Exchange on Tax Ruling). Le but de cette application est l'implémentation de la nouvelle norme commune en matière de transparence et d’échange de renseignements.
