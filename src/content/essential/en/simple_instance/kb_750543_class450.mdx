...
{slot_reference: "name", value: [{value_type: "string", value_content: "Sécurité et stabilité financière"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Sécurité et stabilité financières"}, ]}, 
