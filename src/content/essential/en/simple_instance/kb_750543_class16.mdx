...
{slot_reference: "name", value: [{value_type: "string", value_content: "Livraison et distribution"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Livrer les fournitures et matériels de bureau dans les délais, assurer une gestion des stocks optimale."}, ]}, 
