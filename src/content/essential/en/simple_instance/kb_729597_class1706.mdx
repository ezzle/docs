...
{slot_reference: "name", value: [{value_type: "string", value_content: "DMGC (data mgt. system)  faire des nouvelles fiches SPS, (dés)activer et modifier le contenu des fiches existantes"}, ]}, 
