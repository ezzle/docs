...
{slot_reference: "name", value: [{value_type: "string", value_content: "Vignetten 705 (identification de véhicule sur le plan de la règlementation douanière) sur le flux de Vignetten 705 vers E705 db"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Vignetten 705 (identification de véhicule sur le plan de règlementation douanière) sur le flux de Vignetten 705 vers E705 db"}, ]}, 
