...
{slot_reference: "name", value: [{value_type: "string", value_content: "TR-Restitution_Prod::TR  module régistration pour soumettre les demandes"}, ]}, 
