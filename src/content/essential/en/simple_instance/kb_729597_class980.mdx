...
{slot_reference: "name", value: [{value_type: "string", value_content: "GES  petit régistre d'attente des remboursements exécutés mais bloqués"}, ]}, 
