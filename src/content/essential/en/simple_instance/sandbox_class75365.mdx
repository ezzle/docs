...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulier Squeeze-out  de fondsen recupereren en virtuele effecten transfereren"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Squeeze-out  geld ophalen en virtuele effecten overboeken"}, ]}, 
