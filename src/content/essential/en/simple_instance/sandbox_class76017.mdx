...
{slot_reference: "name", value: [{value_type: "string", value_content: "données opérateur économique sur le flux de Sitran vers PDIE"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Sitran vers PDIE pour les données d'un opérateur économique"}, ]}, 
