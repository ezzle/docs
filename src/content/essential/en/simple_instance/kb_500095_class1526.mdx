...
{slot_reference: "name", value: [{value_type: "string", value_content: "Recapitulatie fiches 281 op flow van Belcotax on web 2017 naar PDS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Recapitulatie fiches 281 op flow van Belcotax on web 2017 naar PDS"}, ]}, 
