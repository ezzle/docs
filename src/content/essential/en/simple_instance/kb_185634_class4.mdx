...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_185634_Class5"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Xml bestand met boekhoudkundige info hypotheken op flow van Hypocomptabi naar Fedcom (stroom naar externe niet FOD Fin applicatie) managed by Hypocomptabi_PROD"}, ]}, 
