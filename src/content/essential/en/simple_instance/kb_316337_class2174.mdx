...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Gestion de projets"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "service Gestion de projets"}, ]}, 
