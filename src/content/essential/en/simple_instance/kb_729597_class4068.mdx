...
{slot_reference: "name", value: [{value_type: "string", value_content: "Diplomacy  re-vérifier les quotas autorisés, par catégorie de profil diplomatique"}, ]}, 
