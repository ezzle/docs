...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flow van Comfor Java naar Myrent via webservice Comfor java"}, ]}, 
