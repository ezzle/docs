...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_608025_Class8"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "saldi vervolgingskosten deurwaarders op flow van Icpc naar PC-FRMS managed by ICPC_PROD"}, ]}, 
