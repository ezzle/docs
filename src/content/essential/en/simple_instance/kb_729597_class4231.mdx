...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting gestion des prescriptions  calcul et suivi de la date de prescription des dettes"}, ]}, 
