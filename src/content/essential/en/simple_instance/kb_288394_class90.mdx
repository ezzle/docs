...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_288394_Class66"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie over straten op flow van Stipad naar NSR best address (MEOW) (human) managed by STIPAD"}, ]}, 
