...
{slot_reference: "name", value: [{value_type: "string", value_content: "Emcs créer un rappel pour l'accusé de réception: bureau d'accises, opérateur économique: destinataire actuel"}, ]}, 
