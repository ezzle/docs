...
{slot_reference: "name", value: [{value_type: "string", value_content: "paiements vers tous les pays SEPA sur le flux de Stiron Inv vers BTM (fichier SEPA)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Stiron Inv vers BTM : fichier Sepa : les paiements vers tous les pays du SEPA sont effectués par voie électronique (BTM  Bank Transaction Manager) et dès que le PCR est débité des montants payés, il est enregistré dans Stiron."}, ]}, 
