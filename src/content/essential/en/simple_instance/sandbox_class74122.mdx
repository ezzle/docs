...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 201.2: liste"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste des effets, sommes, valeurs et objets découverts dans les coffres."}, ]}, 
