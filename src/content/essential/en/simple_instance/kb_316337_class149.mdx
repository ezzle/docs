...
{slot_reference: "name", value: [{value_type: "string", value_content: "Intensifier la lutte contre la fraude au niveau non fiscal : stupéfiants"}, ]}, 
