...
{slot_reference: "name", value: [{value_type: "string", value_content: "pay it conversion des  messages JMS vers fichier XML pour la Poste Financière"}, ]}, 
