...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service ISI-base"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Centralisation des dossiers qui sont maintenant maintenus localement pour les particuliers et les entreprises"}, ]}, 
