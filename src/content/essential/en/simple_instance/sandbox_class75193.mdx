...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire lettre modèle enregistrement"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire lettre modèle enrégistrement"}, ]}, 
