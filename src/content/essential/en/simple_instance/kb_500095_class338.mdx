...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation sur base de Gestion Des Debiteurs du plan de paiements TVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation sur la base de Gestion Des Debiteurs du plan de paiements TVA"}, ]}, 
