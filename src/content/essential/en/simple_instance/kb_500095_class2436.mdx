...
{slot_reference: "name", value: [{value_type: "string", value_content: "information de taxation impôts directs pour non résidents sur le flux de Stirint Ocde vers Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "information de taxation impôts directs pour non résidents sur le flux de Stirint Ocde vers Stirint isi"}, ]}, 
