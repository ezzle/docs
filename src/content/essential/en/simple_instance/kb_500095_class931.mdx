...
{slot_reference: "name", value: [{value_type: "string", value_content: "apercu des status des procédures ETL en cours sur le flux de My ETL D&amp;A vers IRMA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "apercu des status des procédures ETL en cours sur le flux de My ETL D&amp;A vers IRMA"}, ]}, 
