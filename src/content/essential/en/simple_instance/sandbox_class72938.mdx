...
{slot_reference: "description", value: [{value_type: "string", value_content: "db Vacourex (VA), fichier Va-courex : contient l'historique de ce qui était dans le fichier actuel pendant 1 an archivé après 7 ans."}, ]}, 
