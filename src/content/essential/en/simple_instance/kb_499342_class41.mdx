...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_499342_Class42"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Uitnodigingen tot betaling op maandelijkse flow van Geautomatiseerde Verkeersbelasting naar Fedopress managed by Geautomatiseerde VB   TC Automatisé_PROD"}, ]}, 
