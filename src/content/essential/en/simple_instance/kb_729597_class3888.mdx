...
{slot_reference: "name", value: [{value_type: "string", value_content: "BV Land  consultation des paiements PP dans BV Land à l'exception des paiements enrôlés (pas dans Finprof)"}, ]}, 
