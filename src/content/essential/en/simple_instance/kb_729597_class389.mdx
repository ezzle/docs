...
{slot_reference: "name", value: [{value_type: "string", value_content: "Lifecycle  donner des possibilités d'édition à un document PDF acrobat reader"}, ]}, 
