...
{slot_reference: "name", value: [{value_type: "string", value_content: "Jira (suivi des projets, bugtracking)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Jira est un logiciel pour le suivi des projets"}, ]}, 
