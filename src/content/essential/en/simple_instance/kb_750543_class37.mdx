...
{slot_reference: "name", value: [{value_type: "string", value_content: "Contrôle des Instruments et des Institutions Financières"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Contrôle des Instruments et des intitutions financièrs"}, ]}, 
