...
{slot_reference: "app_pro_to_inforep_from_app", value: [{value_type: "simple_instance", value_content: "KB_962852_Class18"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "SAD aangifte PLDA single administrative document managed by PLDA::toegang tot Europese applicaties"}, ]}, 
