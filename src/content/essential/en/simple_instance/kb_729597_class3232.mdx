...
{slot_reference: "name", value: [{value_type: "string", value_content: "Géomètre Fonctionnaire générer des numéros CAD pour les géomètres fonctionnaire qui n'en disposent pas"}, ]}, 
