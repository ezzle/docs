...
{slot_reference: "name", value: [{value_type: "string", value_content: "fiche papier VA2"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "fiche papier VA2"}, ]}, 
