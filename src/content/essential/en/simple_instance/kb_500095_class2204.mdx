...
{slot_reference: "name", value: [{value_type: "string", value_content: "statistiques sur le flux de PLDA Globalisatie vers BNB"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "statistiques sur le flux de PLDA Globalisation vers BNB"}, ]}, 
