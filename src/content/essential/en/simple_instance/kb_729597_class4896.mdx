...
{slot_reference: "name", value: [{value_type: "string", value_content: "Tax-on-web: enregistrer des déclarations des impôts pour les personnes physiques"}, ]}, 
