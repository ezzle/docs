...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire reconaissance Libéralités déductibles annexe pour institutions pour opération de secours aux pays en voie de développement"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Annexe sur la reconnaissance des subventions déductibles pour les établissements fournissant une aide aux pays en développement ( https://financien.belgium.be/sites/default/files/downchargements/143-documents-pays en voie de développement.pdf )"}, ]}, 
