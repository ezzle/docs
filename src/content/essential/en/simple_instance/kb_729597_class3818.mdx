...
{slot_reference: "name", value: [{value_type: "string", value_content: "RAM  Risk et audit management  consultation de tous les fichiers créés"}, ]}, 
