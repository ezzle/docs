...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pseudo numéro d'articles (des matrices cadastraux) sur le flux de PRI vers Consultimmo sur ESB pour alors transférer ces pseudo numéros d'articles à l'AG Fisc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Pseudo numéro d'articles (des matrices cadastraux) sur le flux de PRI vers Consultimmo sur ESB pour communiquer ces pseudo numéros d'articles ensuite à l'AG Fisc"}, ]}, 
