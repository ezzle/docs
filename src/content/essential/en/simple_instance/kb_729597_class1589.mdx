...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  transversaal  nationaal overzicht per schuldenaar (over de Rechtbanken heen)"}, ]}, 
