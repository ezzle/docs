...
{slot_reference: "name", value: [{value_type: "string", value_content: "cap  offre de travail sélection des déclarations pour CAP suite aux initiatives de datamining et suite aux hits de Dataflux"}, ]}, 
