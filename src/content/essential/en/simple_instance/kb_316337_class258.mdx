...
{slot_reference: "name", value: [{value_type: "string", value_content: "Elaborer le traitement des déclarations EMCS par l'outil de sélection automatique SEDA"}, ]}, 
