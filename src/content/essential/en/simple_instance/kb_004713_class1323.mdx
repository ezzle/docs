...
{slot_reference: "name", value: [{value_type: "string", value_content: "Transfert d'engagement (écriture de journal) dans Fedcom"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Transfert d'engagement (écriture de journal) dans Fedcom"}, ]}, 
