...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool Handhaving  met à disposition de l'information à l'application Feedback pour consulter des statistiques et des rapports pour évaluer la gestion des risques"}, ]}, 
