...
ancienne application Vignettes  705 fonctionne avec un Mysql db mais la nouvelle application vignettes 705 fonctionna avec la base de données db2."}, ]}, 
