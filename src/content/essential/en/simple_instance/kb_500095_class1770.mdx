...
{slot_reference: "name", value: [{value_type: "string", value_content: "infos sur les dettes sur le flux de Open ICPC vers DAD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "infos sur les dettes sur le flux de Open ICPC vers DAD"}, ]}, 
