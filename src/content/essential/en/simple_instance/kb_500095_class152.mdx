...
{slot_reference: "name", value: [{value_type: "string", value_content: "valeur de vente  MMZones"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "valeur de vente  MMZones"}, ]}, 
