...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  transversaal  automatische verzending van rappels naar het buitenland  in workflow AP  adequate gegevens in xml"}, ]}, 
