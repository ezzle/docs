...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification concernant des addresses étrangères sur le flux de APF vers Stirint ETR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de APF vers Stirint ETR. Via le module APF les données d'identification concernant des addresses étrangères reçu de Stirint ETR, sont recherchées automatiquement dans Sitran."}, ]}, 
