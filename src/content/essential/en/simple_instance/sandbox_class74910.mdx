...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire AMORTD:tableau des amortissements"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "système dégressif."}, ]}, 
