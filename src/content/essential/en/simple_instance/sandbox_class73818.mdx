...
{slot_reference: "name", value: [{value_type: "string", value_content: "Flux de Belcotax vers Taxi"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Belcotax vers Taxi"}, ]}, 
