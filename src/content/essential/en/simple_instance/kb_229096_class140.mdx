...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class141"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Info seda selectielijnen op flow van Sps Consultatie naar DMGC Data mgt. system managed by CONSULTATIE SPS FICHES-CONSULTATION FICHES SPS_Prod"}, ]}, 
