...
{slot_reference: "name", value: [{value_type: "string", value_content: "Documents (actes ?) sur le flux des services Web Filenet ECM vers Stipad"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "documents (aktes?) sur le flux de Filenet ECM webservices vers Stipad"}, ]}, 
