...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pourvoir le SPF Finances d'une identité graphique forte et moderne, reflétant l'image du SPF Finances et reconnaissable par toutes les parties prenantes."}, ]}, 
