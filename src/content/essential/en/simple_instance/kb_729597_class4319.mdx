...
{slot_reference: "name", value: [{value_type: "string", value_content: "First   Collection-Transacties  beheer geautomatiseerde en niet-geautomatiseerde minnelijke schikkingen"}, ]}, 
