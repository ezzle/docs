...
{slot_reference: "name", value: [{value_type: "string", value_content: "messages xml signatures électroniques sur le flux de esignature masp vers ecs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "des messages xml avec des signatures électroniques (sera remplacé par le développement Européen dans le cadre de UU &amp; MDS)"}, ]}, 
