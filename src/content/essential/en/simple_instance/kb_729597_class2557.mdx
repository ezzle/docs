...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI dashboard  afficher les détails d'un code IPI, entre autres les chiffres par région et par service pour ce code IPI"}, ]}, 
