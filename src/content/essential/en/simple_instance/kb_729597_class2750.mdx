...
{slot_reference: "name", value: [{value_type: "string", value_content: "EMCS new  raffiner et exporter des listes des e-AD's (documents administratifs électroniques)"}, ]}, 
