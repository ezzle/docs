...
{slot_reference: "name", value: [{value_type: "string", value_content: "service OBO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application d'automatisation du travail du bureau de commande CA/BBI"}, ]}, 
