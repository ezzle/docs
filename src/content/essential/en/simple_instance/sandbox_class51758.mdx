...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPMAF (Fischiers pour l'INAMI)_Prod"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application Standalone pour la création des fichiers pour l'INAMI."}, ]}, 
