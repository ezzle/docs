...
{slot_reference: "name", value: [{value_type: "string", value_content: "FACO  consulter les faillites publiés quotidiennement et les concordats judiciaires"}, ]}, 
