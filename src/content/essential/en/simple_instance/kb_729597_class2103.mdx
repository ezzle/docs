...
{slot_reference: "name", value: [{value_type: "string", value_content: "établissements d'accises-Via le site web général G&amp;I, consulter le contenu des licence enregistrés d'une manière conviviale"}, ]}, 
