...
{slot_reference: "name", value: [{value_type: "string", value_content: "Comptable (Cellule Facturation et Gestion des Paiements  Division Délivrance dInformations)"}, ]}, 
