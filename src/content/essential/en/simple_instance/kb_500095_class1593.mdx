...
{slot_reference: "name", value: [{value_type: "string", value_content: "résultat contrôle déclarations ECS sur le flux de MODA vers ECS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "MODA délivre des services dont dépendent ICS et ECS"}, ]}, 
