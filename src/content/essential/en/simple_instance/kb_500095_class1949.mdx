...
{slot_reference: "name", value: [{value_type: "string", value_content: "données signalétiques opérateur économique EORI sur le flux de Sitran vers EORI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données signalétiques EORI opérateur économique sur le flux de Sitran vers EORI"}, ]}, 
