...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service E-Signature"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Service Web pour la signature électronique de documents pdf."}, ]}, 
