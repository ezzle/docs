...
{slot_reference: "name", value: [{value_type: "string", value_content: "données numéros Eori sur le flux de Eori vers Tarbel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données des numéros Eori sur le flux de Eori vers Tarbel"}, ]}, 
