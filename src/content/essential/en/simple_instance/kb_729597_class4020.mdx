...
{slot_reference: "name", value: [{value_type: "string", value_content: "Ingave dossiers met voorstel tot controle door alle agenten AA Fisc / BBI"}, ]}, 
