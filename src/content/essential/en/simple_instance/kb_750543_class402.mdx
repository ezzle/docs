...
{slot_reference: "name", value: [{value_type: "string", value_content: "P050 Assistance aux utilisateurs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Assistance aux utilisateurs (P50)"}, ]}, 
