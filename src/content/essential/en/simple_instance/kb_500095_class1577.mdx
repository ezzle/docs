...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros de comptes financiers sur le flux de Myminfin vers Calcul ipp"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "stocker des numéros de comptes financiers dans db Taxi par Calcul Ipp webservice"}, ]}, 
