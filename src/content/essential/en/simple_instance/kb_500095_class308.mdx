...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation des informations concernant les bureaux SPF Finances par application organization"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation des informations concernant les bureaux du SPF Finances par application organization"}, ]}, 
