...
{slot_reference: "name", value: [{value_type: "string", value_content: "Numéros des comptes financiers  gestion des numéros de compte des personnes naturelles sur lesquelles les remboursements des impôts des personnes physiques sont versés (sauvés dans le db “REK”)"}, ]}, 
