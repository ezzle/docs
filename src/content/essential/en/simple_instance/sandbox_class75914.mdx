...
{slot_reference: "description", value: [{value_type: "string", value_content: "Flow van Respo naar STATIS Interface Statis : geautomatiseerde  extracties bezorgd"}, ]}, 
