...
{slot_reference: "name", value: [{value_type: "string", value_content: "BD TVA_Signa"}, ]}, 
...
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class80805"}, ]}, 
