...
{slot_reference: "app_pro_to_inforep_from_app", value: [{value_type: "simple_instance", value_content: "KB_962852_Class47"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "SAD aangifte PLDA single administrative document managed by PLDA::het registreren van een nieuw geschildossier en de daarbij horende schuld(en) in de schuldendatabank"}, ]}, 
