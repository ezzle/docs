...
{slot_reference: "name", value: [{value_type: "string", value_content: "données opérateurs économiques AEO sur le flux mensuel de Banaeos vers Plan d'information (pour une grande partie automatiquement)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données AEO-opérateurs économiques sur le flux mensuel de Banaeos vers plan d'information (pour une grande partie automatiquement)"}, ]}, 
