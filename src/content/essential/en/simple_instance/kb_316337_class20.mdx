...
{slot_reference: "name", value: [{value_type: "string", value_content: "Rédiger un certain nombre d'arrêtés royaux relatifs à la protection de la vie privée"}, ]}, 
