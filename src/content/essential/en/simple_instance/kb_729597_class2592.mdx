...
{slot_reference: "name", value: [{value_type: "string", value_content: "GI consult  consulter l'information statistique des applications feedback liés aux fiches SPS"}, ]}, 
