...
{slot_reference: "name", value: [{value_type: "string", value_content: "PCIWECC_PROD (application locale de l'AG D&amp;A)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PCIWECC est une application de l'AG Douane et Accises: application sur PC (local)."}, ]}, 
