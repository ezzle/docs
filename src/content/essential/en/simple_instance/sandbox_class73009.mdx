...
{slot_reference: "name", value: [{value_type: "string", value_content: "Demat info comptable"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Demat info comptable"}, ]}, 
