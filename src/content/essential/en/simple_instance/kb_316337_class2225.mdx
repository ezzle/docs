...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Sharepoint"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la collaboration et le partage des documents."}, ]}, 
