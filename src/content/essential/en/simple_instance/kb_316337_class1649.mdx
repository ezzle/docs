...
{slot_reference: "name", value: [{value_type: "string", value_content: "service ALM (Application lifecycle management)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application lifecycle management  gestion des tests"}, ]}, 
