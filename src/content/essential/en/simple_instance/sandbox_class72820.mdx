...
{slot_reference: "description", value: [{value_type: "string", value_content: "Propriété/parcelle (données)  Propriété de la relation de POW. La propriété et les données de signélatique forment ensemble l'aperçu de propriété"}, ]}, 
