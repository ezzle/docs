...
{slot_reference: "name", value: [{value_type: "string", value_content: "Analyser les sites internet existants et regrouper les différents sites internet existants du SPF Finances en un seul site internet intégré"}, ]}, 
