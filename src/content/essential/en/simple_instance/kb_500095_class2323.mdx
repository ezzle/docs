...
{slot_reference: "name", value: [{value_type: "string", value_content: "Langue et formulaire d'enregistrement sur le flux d'Entité-TVA vers Moss"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux d'Entité-TVA vers Moss : Langue et formulaire d'enrégistrement: cherché dans Stiron Entité parce que ca concerne tous les assujettis à la TVA connus"}, ]}, 
