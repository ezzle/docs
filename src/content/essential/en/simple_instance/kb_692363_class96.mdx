...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_692363_Class97"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Plda aangiftes geselecteerd voor controle (uit sps fiches) op flow van sps consultatiefiches naar cocy managed by CONSULTATIE SPS FICHES-CONSULTATION FICHES SPS_Prod"}, ]}, 
