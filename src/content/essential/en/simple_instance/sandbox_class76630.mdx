...
{slot_reference: "name", value: [{value_type: "string", value_content: "hyperlink sur le flux de Dranken vers Cdib website"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "hyperlink sur le flux de Dranken vers Cdib website"}, ]}, 
