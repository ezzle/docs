...
{slot_reference: "name", value: [{value_type: "string", value_content: "Hyperlink sur le flux de IRMA vers CDIB website"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Hyperlink sur le flux de IRMA vers CDIB website"}, ]}, 
