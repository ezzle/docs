...
{slot_reference: "name", value: [{value_type: "string", value_content: "Complétude"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les données  sont complètes
(instances  et leurs 
caractéristiques) par rapport à la réalité et aux 
processus de collectes"}, ]}, 
