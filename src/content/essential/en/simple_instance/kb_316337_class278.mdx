...
{slot_reference: "name", value: [{value_type: "string", value_content: "Optimiser le processus 'fleet management' par l'implémentation d'un software pour une gestion centralisée et le contrôle du parc automobile du SPF Finances"}, ]}, 
