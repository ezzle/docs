...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA Dashboard  affichage van statistieken van selectie, controle, en controleresultaten"}, ]}, 
