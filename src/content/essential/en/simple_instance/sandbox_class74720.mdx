...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 799: déclaration spécifique TVA en matière du transport rémunéré sur route des personnes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclaration spécifique TVA en matière du transport rémunéré sur route des personnes"}, ]}, 
