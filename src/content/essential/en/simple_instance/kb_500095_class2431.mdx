...
{slot_reference: "name", value: [{value_type: "string", value_content: "information de taxation impôts directs pour non résidents sur le flux de Stirint DLO vers Stirint Autodt"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "information de taxation impôts directs pour non résidents sur le flux de Stirint DLO vers Stirint Autodt"}, ]}, 
