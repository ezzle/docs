...
{slot_reference: "name", value: [{value_type: "string", value_content: "Résultats contrôles selection déclarations PLDA sur le flux de DMGC data mgt system vers PLDA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Résultats des contrôles de selection des déclarations PLDA sur le flux de DMGC data mgt system vers PLDA"}, ]}, 
