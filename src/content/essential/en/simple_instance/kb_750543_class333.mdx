...
{slot_reference: "name", value: [{value_type: "string", value_content: "P129 Tenue de commande"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Tenue de commande (p129)"}, ]}, 
