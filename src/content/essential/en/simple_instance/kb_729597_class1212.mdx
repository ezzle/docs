...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module de gestion de dossiers  Iris  listes (sur base de datamining) dans gestion Des Débiteurs"}, ]}, 
