...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_001950_Class29"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Geconsolideerde data uit MASP-PLDA, seda en FEEDBACK op flow van monitoringtool naar informatieplan managed by Monitoringtool_Dev"}, ]}, 
