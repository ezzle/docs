...
{slot_reference: "name", value: [{value_type: "string", value_content: "Tax Fraud Reporting  aperçu sommaire des statistiques des documents d'infraction"}, ]}, 
