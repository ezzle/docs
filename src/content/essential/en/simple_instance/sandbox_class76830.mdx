...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification concernant des addresses étrangères reçu de Stirint CRS sur le flux de Sitran vers APF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Sitran vers APF Via le module APF, les données d'identification autour des adresses étrangères sont reçues de Stirint CRS, automatiquement recherchées à Sitran."}, ]}, 
