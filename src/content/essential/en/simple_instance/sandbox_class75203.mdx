...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demander lettre modèle"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire demander lettre modèle"}, ]}, 
