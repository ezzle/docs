...
{slot_reference: "name", value: [{value_type: "string", value_content: "NCTS-au moment du départ : l'régistration d'une partie d'une garantie pour les droits qui sont impliqués pendant le transport"}, ]}, 
