...
{slot_reference: "name", value: [{value_type: "string", value_content: "Flux de l'application Solvabilité des personnes morales (SPF Justice) vers Gestion des Débiteurs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de l'application Solvabilité des personnes morales (SPF Justice) vers Gestion Des Débiteurs"}, ]}, 
