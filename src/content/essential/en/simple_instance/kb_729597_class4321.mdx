...
{slot_reference: "name", value: [{value_type: "string", value_content: "First   Collection-Transactions  gestion des transactions amiables automatisées et non automatisées"}, ]}, 
