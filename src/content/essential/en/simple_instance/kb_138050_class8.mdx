...
{slot_reference: "name", value: [{value_type: "string", value_content: "Requires standards and guidelines to develop system components. Agencies will need to focus on business-centric, loosely-coupled, service-oriented design, e.g. the use of design patterns, rules engines and so on."}, ]}, 
