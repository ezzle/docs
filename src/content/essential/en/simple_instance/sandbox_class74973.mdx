...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Bon de commande info du monnaie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce formulaire et version papier est destiné aux clients particuliers pour effectuer leur commande de produits numismatiques par courrier postal."}, ]}, 
