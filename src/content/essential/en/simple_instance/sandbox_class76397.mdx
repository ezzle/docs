...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'un bien immobilier d'une personne spécifique (propriétaire) de Patris actualisées par Stipad sur le flux de Properties on Web vers Cadgis"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Données d'une propriété d'une personne spécifique (propriétaire) de Patris mises à jour via Stipad sur le flux de Properties on Web vers Cadgis"}, ]}, 
