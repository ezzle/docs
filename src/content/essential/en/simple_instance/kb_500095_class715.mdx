...
{slot_reference: "name", value: [{value_type: "string", value_content: "modifications en ICPC sur dernière période sur le flux d'ICPC vers Open ICPC, chaque 30 minutes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux modifications dans ICPC sur dernière période d'ICPC vers Open ICPC, chaque 30 minutes"}, ]}, 
