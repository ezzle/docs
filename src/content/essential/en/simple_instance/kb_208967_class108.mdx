...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class109"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "? toekomst flow van stirint bbi naar first ? managed by STIRint  BBI_PROD"}, ]}, 
