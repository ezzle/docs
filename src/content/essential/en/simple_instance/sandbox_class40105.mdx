...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  processus  catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Tableau contenant la liste des processus métiers significative pour l'organisation."}, ]}, 
