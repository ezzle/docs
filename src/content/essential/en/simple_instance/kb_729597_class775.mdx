...
{slot_reference: "name", value: [{value_type: "string", value_content: "First non fiscal  recouvrement annuel des recouvrements non fiscaux via fichier central des concessions"}, ]}, 
