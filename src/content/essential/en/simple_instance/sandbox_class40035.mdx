...
{slot_reference: "name", value: [{value_type: "string", value_content: "Applications  Service  Services applicatifs  Synthèse"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Fournit une vue synthétique des relations principales d'un service applicatif"}, ]}, 
