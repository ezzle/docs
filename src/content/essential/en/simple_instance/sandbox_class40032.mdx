...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue des services applicatifs   tableau"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des services applicatifs significatifs pour l'organisation."}, ]}, 
