...
{slot_reference: "name", value: [{value_type: "string", value_content: "Stats Acc  statistiques trimestriels accises pour le Service Législation sur les accises"}, ]}, 
