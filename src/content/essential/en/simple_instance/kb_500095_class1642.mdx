...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire rose après vérification avec sticker e705 avec le mention si le TVA a été payé."}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire rose après vérification avec sticker e705 avec le mention si le TVA a été payé."}, ]}, 
