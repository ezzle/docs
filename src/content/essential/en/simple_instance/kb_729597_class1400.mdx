...
{slot_reference: "name", value: [{value_type: "string", value_content: "pay it-approuver des remboursements via un workflow définie dans PAY-IT"}, ]}, 
