...
{slot_reference: "description", value: [{value_type: "string", value_content: "Module de calcul du groupe cible de l impot de société des Petites et Moyennes Entreprises"}, ]}, 
