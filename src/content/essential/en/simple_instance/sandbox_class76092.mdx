...
{slot_reference: "name", value: [{value_type: "string", value_content: "données déclaration d'importation sur le flux de ICS vers module de recherche S&amp;S"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des déclaration d'importations sur le flux de ICS vers le module de recherche S&amp;S"}, ]}, 
