...
{slot_reference: "name", value: [{value_type: "string", value_content: "service CaliberRm"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Requirements Management pour des projets configuré avant le 01/06/2013."}, ]}, 
