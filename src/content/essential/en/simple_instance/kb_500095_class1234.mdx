...
{slot_reference: "description", value: [{value_type: "string", value_content: "PLDA_2017 Relational Database on MariaDB/MySQL Environment  replication db de PLDA db2 base de données vers PLDA mysql base de données"}, ]}, 
