...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire pour remboursement 437 sur le flux de Ordeuro vers Fedcom (flux vers application externe non SPF Finances) (interface humaine ?)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de Ordeuro vers Fedcom (formulaire de retour 437) (flux vers une application externe non SPF Finances) (interface humaine)"}, ]}, 
