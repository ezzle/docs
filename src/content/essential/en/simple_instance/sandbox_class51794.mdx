...
{slot_reference: "name", value: [{value_type: "string", value_content: "Viewer BCE (remplacé par service web Sitran)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Interface graphique de consultation de la base de données BCE (remplacé par le webservice Sitran)."}, ]}, 
