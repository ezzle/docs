...
{slot_reference: "description", value: [{value_type: "string", value_content: "PLDA_chargementivan Relational Database on MariaDB/MySQL Environment"}, ]}, 
