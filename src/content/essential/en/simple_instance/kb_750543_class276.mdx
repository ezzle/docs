...
{slot_reference: "name", value: [{value_type: "string", value_content: "P093 Suivi de dossiers transversaux"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Suivi de dossier transversal (p93)"}, ]}, 
