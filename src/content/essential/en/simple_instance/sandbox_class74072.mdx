...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 151.3: relevé mensuel concernant le taxe annuel sur les opérations d'assurance"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Relevé mensuel concernant la taxe annuelle sur les opérations d'assurance (estimation forfaitaire de la taxe  primes exonérées non déterminées)."}, ]}, 
