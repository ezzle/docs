...
{slot_reference: "name", value: [{value_type: "string", value_content: "questions pour renseignements internationaux et assistance au recouvrement sur le flux de Stirint Int Inv vers Myscan"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "questions pour renseignements internationaux et assistance au recouvrement sur le flux de Stirint Int Inv vers Myscan"}, ]}, 
