...
{slot_reference: "name", value: [{value_type: "string", value_content: "phase de production de Data Architecture Modeling"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L’outil Embarcadero E/R Studio permet aux 'DataBase Administrators' (DBA) d’analyser les structures de données DB2 dans une optique de ' trans-projet ', afin de pouvoir gérer et optimiser leur emploi dans le contexte de la production."}, ]}, 
