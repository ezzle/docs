...
{slot_reference: "name", value: [{value_type: "string", value_content: "extraits automatisées sur le flux de TR Restitution vers Statis"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de TR Restitution vers Statis Interface Statis : extraits automatisées livrées"}, ]}, 
