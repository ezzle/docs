...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire pour notification de comptes à l'étranger au CAP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire pour notification des comptes à l'étranger au Point de contact central BNB"}, ]}, 
