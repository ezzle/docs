...
{slot_reference: "name", value: [{value_type: "string", value_content: "PropertiesOnWeb  chercher un droit réel de propriété  transaction 6: via numéro d'article"}, ]}, 
