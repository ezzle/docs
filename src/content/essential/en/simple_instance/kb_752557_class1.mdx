...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Toekomst: schuldinformatie op webservice: flow van First naar DAD managed by FIRST"}, ]}, 
