...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  annulation d'une imputation d'un paiement sur chaque dette"}, ]}, 
