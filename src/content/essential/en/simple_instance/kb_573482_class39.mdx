...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_573482_Class40"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "seda selectielijnen op flow van DMGC data mgt system naar SPS consultatie managed by DMGC  Data Mgmt System_Prod"}, ]}, 
