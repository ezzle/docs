...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire rappel supplémentaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire rappel supplémentaire"}, ]}, 
