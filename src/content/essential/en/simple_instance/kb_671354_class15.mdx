...
{slot_reference: "name", value: [{value_type: "string", value_content: "Active Directory NL"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Active Directory domein services voor de Wintel (PC+servers) omgeving van de FOD Financiën."}, ]}, 
