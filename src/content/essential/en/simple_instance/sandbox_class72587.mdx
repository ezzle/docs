...
{slot_reference: "description", value: [{value_type: "string", value_content: "Interface Database Management Services / FileServices  WindowsSMB / DB  CDB Les courriers finaux (sortants) ainsi que les courriers entrants et retour de demande d'informations sont scannés et stockés dans la db sous forme de PDF, des modèles de courrier au format Word y sont également stockés."}, ]}, 
