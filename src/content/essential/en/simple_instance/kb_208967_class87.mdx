...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class88"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "vragen om internationale inlichtingen en invorderingsbijstand op flow van stirint int inv naar stirint bbi managed by STIRint  Internationale Invorderingen_PROD"}, ]}, 
