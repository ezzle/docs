...
{slot_reference: "name", value: [{value_type: "string", value_content: "dm_selections Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dm_selections Relational Database on MariaDB/MySQL Environment"}, ]}, 
