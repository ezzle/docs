...
{slot_reference: "name", value: [{value_type: "string", value_content: "Précompte immobilier_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "application pour l'établissement et l'enregistrement du précompte immobilier pour la Région Wallonne (régionalisée pour les autres régions)"}, ]}, 
