...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_603289_Class17"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flow van db Locoselect naar db Stipad (Patris) over SAS"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Lijst van gegevens over onroerende goederen en hun transacties (o.b.v. manuele opzoeking) op Flow van Stipad (Patris) naar Locoselect over SAS managed by STIPAD"}, ]}, 
