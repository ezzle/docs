...
{slot_reference: "name", value: [{value_type: "string", value_content: "Interactieve digitale Printingservice Scriptura Interactive"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "De interactieve digitale printingservice “Scriptura interactive” biedt:
