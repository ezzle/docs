...
{slot_reference: "name", value: [{value_type: "string", value_content: "Certificatie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Het CCFF Framework biedt certificatieservices die een maximale transparantie verzekeren."}, ]}, 
