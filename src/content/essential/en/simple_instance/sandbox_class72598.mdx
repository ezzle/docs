...
{slot_reference: "name", value: [{value_type: "string", value_content: "db Cloaf taxes diverses"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db Cloaf taxes diverses"}, ]}, 
