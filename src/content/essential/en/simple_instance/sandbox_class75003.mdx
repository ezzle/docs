...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire DIESEL: diesel professionel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce formulaire global remplace les formulaires mensuels séparés et peut être utilisé pour les déclarations mensuelles à partir de juillet 2005."}, ]}, 
