...
{slot_reference: "description", value: [{value_type: "string", value_content: "db Courant (VA) fichier Va-Courant: contient uniquement des versements anticipés de l'année en cours"}, ]}, 
