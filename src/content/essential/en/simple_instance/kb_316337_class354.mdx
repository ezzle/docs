...
{slot_reference: "name", value: [{value_type: "string", value_content: "Sensibiliser les collaborateurs et les former pour écrire des textes et messages lisibles"}, ]}, 
