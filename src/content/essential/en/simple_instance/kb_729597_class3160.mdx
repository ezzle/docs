...
{slot_reference: "name", value: [{value_type: "string", value_content: "Versements anticipés_PROD::actualisation des données d'adresse des nouveaux indépendants à l'aide de Sitran"}, ]}, 
