...
{slot_reference: "name", value: [{value_type: "string", value_content: "RAM  Risk et audit management  feuille où les risques sont inventoriés"}, ]}, 
