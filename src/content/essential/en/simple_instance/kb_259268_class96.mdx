...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "KANTOOR Database (RDC) managed by Calcul IPP  AanslagJaar 2019_PROD"}, ]}, 
