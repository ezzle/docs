...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Gazage Conteneurs"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application avec des informations sur le gazage de conteneurs et les précautions à prendre à ce sujet."}, ]}, 
