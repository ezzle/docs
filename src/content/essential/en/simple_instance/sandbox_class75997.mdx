...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données impôts directs sur des entreprises multinationales des pays différents (aussi bien Européen que non-Européen) sur le flux de Stirint Beps Cbc vers CTS"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données des impôts directs sur des entreprises multinationales des pays différents (aussi bien Europees que non-Européen) sur le flux de Stirint beps Cbc vers CTS"}, ]}, 
