...
replication db de la base de données db2 PLDA vers la base de données mysql PLDA + la base de données PLDA en MySQL utilisé par le service service gestion de données de l'AG D&amp;A est aussi une réplication de la base de donnée Pldtb de tarbel"}, ]}, 
