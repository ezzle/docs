...
{slot_reference: "name", value: [{value_type: "string", value_content: "db répertoire PM"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "db PM db répertoire"}, ]}, 
