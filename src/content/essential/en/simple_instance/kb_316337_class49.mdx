...
{slot_reference: "name", value: [{value_type: "string", value_content: "Des sélections de recrutement ciblées au SELOR pour les profils techniques"}, ]}, 
