...
{slot_reference: "name", value: [{value_type: "string", value_content: "hyperlinks sur le flux de Cadgis vers POW"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Cadgis vers POW uniquement hyperlinks"}, ]}, 
