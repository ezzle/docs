...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_544904_Class78"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_544904_Class79"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Toekomst: refertenummers internationaal verzonden pakjes op input flow van E Commerce naar SEDA managed by PC Acces toepassing internationaal verzonden pakjes / in toekomst = E Commerce"}, ]}, 
