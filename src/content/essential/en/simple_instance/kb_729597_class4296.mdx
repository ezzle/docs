...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  ajouter des bénéficiaires à une demande (traiter les demandes des bénéficiaires)"}, ]}, 
