...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class84"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "aangifte btw schuld van BTW belastingplichtige die goederen (bv een wagen) zonder Btw gekocht heeft en waarop BTW moet betaald worden in het land van bestemming waar die goederen (bv wagen) gebruikt zal worden op flow van Stirint Clo naar Stirint Bbi managed by STIRint  CLO_PROD"}, ]}, 
