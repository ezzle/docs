...
{slot_reference: "description", value: [{value_type: "string", value_content: "formulier laatste termijn voor opsturen documenten alvorens te schrappen"}, ]}, 
