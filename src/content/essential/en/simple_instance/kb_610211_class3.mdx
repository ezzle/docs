...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_610211_Class4"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "documenten op te slaan op flow van Hypo p8 Image Retriever naar Filenet managed by HYPO_P8_ImageRetriever_Prod"}, ]}, 
