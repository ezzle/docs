...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_467819_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens omtrent invordering Btw schulden op manuele flow van Stiron inv naar eforms managed by STIRON-Lot2-Invordering_PROD"}, ]}, 
