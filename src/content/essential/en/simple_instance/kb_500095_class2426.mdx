...
{slot_reference: "name", value: [{value_type: "string", value_content: "information de taxation TVA non résidents sur le flux de Stirint ISI vers Stir Tva"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "information de taxation TVA non résidents sur le flux de Stirint ISI vers Stir Tva"}, ]}, 
