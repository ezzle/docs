...
{slot_reference: "name", value: [{value_type: "string", value_content: "question pour compléter les données d'identité d'une personne avec une faillite sur le flux de SP10b vers Sitran"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "question pour compléter les données d'identification d'une personne avec une faillite sur le flux de SP10b vers Sitran"}, ]}, 
