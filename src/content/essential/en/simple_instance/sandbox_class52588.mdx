...
{slot_reference: "name", value: [{value_type: "string", value_content: "SITRAN_WS service web"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Webservice Sitran"}, ]}, 
