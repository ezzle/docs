...
{slot_reference: "name", value: [{value_type: "string", value_content: "Etablissement de la Taxe sur la valeur ajoutée (BTW-TVA)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Etablissement de la Taxe sur la valeur ajoutée (BTW-TVA)"}, ]}, 
