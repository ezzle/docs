...
{slot_reference: "description", value: [{value_type: "string", value_content: "PLDA_statsaccises Relational Database on MariaDB/MySQL Environment"}, ]}, 
