...
{slot_reference: "name", value: [{value_type: "string", value_content: "vignettes 705  4  module de consultation accessible pour un public plus large des utilisateurs spécifiquement autorisés, y compris des fonctionnaires de l'Administration Générale de l'ISI"}, ]}, 
