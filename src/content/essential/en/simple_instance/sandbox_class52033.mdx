...
{slot_reference: "name", value: [{value_type: "string", value_content: "Neeva_PROD (RH)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application externe dans le domaine RH."}, ]}, 
