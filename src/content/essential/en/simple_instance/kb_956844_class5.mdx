...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_956844_Class6"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens uit periodieke btw-aangiftes komende van Intervat op flow van STIR-TVA_PROD naar Landbouw en Visserij (Externe) managed by STIR-TVA_PROD"}, ]}, 
