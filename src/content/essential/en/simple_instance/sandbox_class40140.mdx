...
{slot_reference: "name", value: [{value_type: "string", value_content: "Présentation synthétique d'un acteur groupe"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présentation synthétique des principaux attributs ou relations d'un acteur organisationnel donné"}, ]}, 
