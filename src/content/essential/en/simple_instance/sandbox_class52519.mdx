...
{slot_reference: "name", value: [{value_type: "string", value_content: "Système SAP de DHL et UPS (dans l'àvenir) (extern)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Système SAP de DHL et UPS sera lié dans l'avenir à l'application Be-Gate / E Commerce."}, ]}, 
