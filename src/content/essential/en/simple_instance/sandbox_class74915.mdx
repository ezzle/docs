...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire AMORTL:tableau des amortissements  système linéaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "tableau des amortissements  système linéaire."}, ]}, 
