...
{slot_reference: "description", value: [{value_type: "string", value_content: "Jenkins CI est le open-source continuous integration server principal."}, ]}, 
