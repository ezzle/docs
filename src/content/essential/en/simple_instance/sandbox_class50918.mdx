...
{slot_reference: "name", value: [{value_type: "string", value_content: "Client Consultimmo consultable par Credoc"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Chez Crédoc, il y a un client spécifique disponible pour consulter l'information de Consultimmo."}, ]}, 
