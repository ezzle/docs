...
{slot_reference: "name", value: [{value_type: "string", value_content: "Analyser et uniformiser le traitement des litiges au sein du SPF Finances et viser l'uniformisation"}, ]}, 
