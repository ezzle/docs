...
{slot_reference: "name", value: [{value_type: "string", value_content: "Autorisations AEO déclarées définitive sur le flux de Banaeos vers AEO sur base du service web AEO"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les permis AEO définitifs déclarés sur le flux de Banaeos vers AEO basés sur le webservice AEO Ce qui entre dans Banaeos va aussi en Europe, mais le webservice Aeo va reprendre les Aeo qui ont été déclarés définitifs, car dans Banaeos vous voyez aussi les Aeo qui sont en demande."}, ]}, 
