...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA dashboard  verkrijgen,in een virtueel venster, voor een gekozen operator, van het detail van de aangifte met een link naar de feedback pagina's."}, ]}, 
