...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire SS56"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Contrôle en vue d'obtenir une allocation d'un CPAS"}, ]}, 
