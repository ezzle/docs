...
{slot_reference: "name", value: [{value_type: "string", value_content: "dettes saisie-arrêt exécution simplifiée (saisie-arrêt) sur le flux de SAFS vers ICPC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "dettes saisie-arrêt exécution simplifiée (saisie-arrêt) sur le flux de SAFS vers ICPC"}, ]}, 
