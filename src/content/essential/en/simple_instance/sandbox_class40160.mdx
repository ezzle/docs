...
{slot_reference: "name", value: [{value_type: "string", value_content: "Catalogue des capacités applicatives"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des capacités applicatives."}, ]}, 
