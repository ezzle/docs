...
{slot_reference: "description", value: [{value_type: "string", value_content: "SAD aangifte PLDA (single administrative document): generieke definitieve Plda aangifte"}, ]}, 
