...
{slot_reference: "name", value: [{value_type: "string", value_content: "MyETL D&amp;A (status des procédures ETL en cours)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Aperçu du status des procédures ETL en cours chez l'AG Douane et Accises."}, ]}, 
