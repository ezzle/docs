...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 43B déclaration mise en service de bien immobilier sur le flux d'Urbain vers Scriptura"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "La partie Prodocs d'Urbain utilise scriptura (pour le suivi des documents 43B et autres ...); formulaire 43B déclaration mise en service  bien immobilier"}, ]}, 
