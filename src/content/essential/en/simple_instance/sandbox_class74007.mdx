...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulaire lié au suivi de l’avancement de constructions ou travaux (43B, Prodocs…) (AG DocPat)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulaire lié au suivi de l’avancement de constructions ou travaux (43B, Prodocs…) (AG DocPat)"}, ]}, 
