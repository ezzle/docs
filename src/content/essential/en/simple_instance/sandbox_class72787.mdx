...
{slot_reference: "name", value: [{value_type: "string", value_content: "db Open-PPL"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "base de données relationnelle avec copie des données dans la base de données BV-LAND sur le mainframe du SMOC8."}, ]}, 
