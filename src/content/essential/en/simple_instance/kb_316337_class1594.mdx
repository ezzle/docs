...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Brochure Internet"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Un processus de commandes de brochure a été établi par sur un serveur qui se trouve chez Belgacom (‘koba’)."}, ]}, 
