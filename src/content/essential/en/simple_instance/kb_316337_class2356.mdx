...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Ftp_server"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "La gestion des transferts de fichiers des Ftp's et des account Ftp (remplacée par Sterling)"}, ]}, 
