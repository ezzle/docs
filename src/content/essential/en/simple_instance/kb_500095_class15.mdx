...
{slot_reference: "name", value: [{value_type: "string", value_content: "signalétique transversale Personnes assujeties à la TVA sur le flux de Stiron Signalétique vers Stiron TR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "signalétique transversale des assujettis à la TVA sur le flux de Stiron signalétique vers Stiron TR"}, ]}, 
