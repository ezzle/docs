...
{slot_reference: "name", value: [{value_type: "string", value_content: "régistre 480  possibilités de consultation et le reporting concernant des infractions constatées AG D&amp;A et les contrevenants y liés"}, ]}, 
