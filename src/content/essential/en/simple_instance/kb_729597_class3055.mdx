...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  droits de consultation, détail des imputations sur une dette"}, ]}, 
