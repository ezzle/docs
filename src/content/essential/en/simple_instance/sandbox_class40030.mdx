...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application Modèle de référence"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Carthographie des capacités applicatives significatives pour l'organisation."}, ]}, 
