...
{slot_reference: "name", value: [{value_type: "string", value_content: "valeurs vénales sur le flux de Locostat vers Locostat Expert Archive"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "valeurs vénales sur le flux de Locostat vers Locostat Expert Archive"}, ]}, 
