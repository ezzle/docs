...
{slot_reference: "name", value: [{value_type: "string", value_content: "rapport de conseil stratégique utilisation et gestion de données"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Conseil stratégique élaboré lors de la mission de conseil Gestion et utilisation des données (automne 2018)."}, ]}, 
