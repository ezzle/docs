...
{slot_reference: "name", value: [{value_type: "string", value_content: "les données de personnes sur le flux de Der vers Comfor JAVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "les données de personnes de Comfor Java sont importés à partir de DER"}, ]}, 
