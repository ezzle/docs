...
{slot_reference: "name", value: [{value_type: "string", value_content: "Renseignements sur des faillites du Moniteur Belge"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Informations des faillites du moniteur Belge"}, ]}, 
