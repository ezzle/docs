...
{slot_reference: "name", value: [{value_type: "string", value_content: "SASP  aperçu des déclarations pertinentes d'import pour la libre circulation (déclarations d'import avec la code 4011 dans la case 44 du dossier document unique)"}, ]}, 
