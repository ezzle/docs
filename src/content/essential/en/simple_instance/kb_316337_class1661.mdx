...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Fich-elec"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L’interface Fich-elec permet à Aut-TP/PO de gérer sa documentation électronique (DI’s). Homepage: http://fichelec.finbel.intra"}, ]}, 
