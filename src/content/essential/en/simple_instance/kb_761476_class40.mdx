...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_761476_Class41"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Authentieke akten (incl. metagegevens) op flow van Movables naar Vlabel over ESB (stroom naar externe niet Fod Fin applicatie) managed by Movables_PROD"}, ]}, 
