...
{slot_reference: "name", value: [{value_type: "string", value_content: "requête pour évaluation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "requête pour valuation"}, ]}, 
