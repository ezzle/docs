...
{slot_reference: "name", value: [{value_type: "string", value_content: "données concernant des dettes non fiscales sur le flux de 180bnfi vers eforms"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données concernant des dettes non fiscales sur le flux de 180bnfi vers E-Forms"}, ]}, 
