...
{slot_reference: "name", value: [{value_type: "string", value_content: "PC Taxe environnementale_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Milieutaks est une application sur PC (local), n'est plus utilisé."}, ]}, 
