...
{slot_reference: "name", value: [{value_type: "string", value_content: "service ClientDiagnosis"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application de test de la configuration PDF (utilise capicom.dll et web crypto API qui sera abandonné dans FireFox 34)"}, ]}, 
