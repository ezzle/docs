...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Zylab"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "ZyLab eDiscoveryplatform sert aux contrôles e audit."}, ]}, 
