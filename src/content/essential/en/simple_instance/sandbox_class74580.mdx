...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 371: demande pour attestation hypothécaire concernant un bien immobilier."}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demande pour attestation hypothécaire concernant un bien immobilier."}, ]}, 
