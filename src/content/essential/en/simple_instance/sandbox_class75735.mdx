...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulieren attesten niet activiteit (AA Fisc)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Formulieren attesten niet activiteit (AA Fisc)"}, ]}, 
