...
{slot_reference: "name", value: [{value_type: "string", value_content: "Tax Fraud Reporting  régistration et reporting de la clôture financière des documents d'infraction"}, ]}, 
