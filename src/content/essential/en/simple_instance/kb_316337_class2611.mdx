...
{slot_reference: "name", value: [{value_type: "string", value_content: "service portail Bi"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Portail pour afficher les rapports Microsoft BI (Business Intelligence)."}, ]}, 
