...
{slot_reference: "name", value: [{value_type: "string", value_content: "Développer une vision pour les médias sociaux et l'utilisation d'outils performants de monitoring"}, ]}, 
