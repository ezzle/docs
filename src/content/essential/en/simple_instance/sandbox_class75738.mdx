...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaires B"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Contrôle des conditions de propriété en vue de l'obtention d'une allocation dans le secteur du logement social"}, ]}, 
