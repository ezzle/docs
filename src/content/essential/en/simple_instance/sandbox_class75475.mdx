...
{slot_reference: "name", value: [{value_type: "string", value_content: "Formulier schatkist rekening courant  opening van een rekening courant"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Zichtrekening  Openen van een zichtrekening"}, ]}, 
