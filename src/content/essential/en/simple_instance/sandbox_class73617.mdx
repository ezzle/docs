...
{slot_reference: "name", value: [{value_type: "string", value_content: "Fichier excel avec des remboursements pour Pieter De Braekeleer (compensation des dettes, bilan fiscal) sur le flux manuel de PLDA vers Open Ic"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux manuel de PLDA vers open ic avec excel avec remboursements à AGPR Service ABA"}, ]}, 
