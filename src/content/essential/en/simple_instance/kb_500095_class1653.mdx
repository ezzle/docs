...
{slot_reference: "name", value: [{value_type: "string", value_content: "SAD déclaration PLDA single administrative document"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "déclaration PLDA SAD single administrative document"}, ]}, 
