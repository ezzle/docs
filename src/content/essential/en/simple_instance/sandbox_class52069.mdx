...
{slot_reference: "name", value: [{value_type: "string", value_content: "Listes CRN PP (Personnes Physiques)_PROD"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "des listes permettant un suivi détaillé de l'évolution des travaux de taxation"}, ]}, 
