...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire porte-fort"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire porte-fort dans laquelle l'héritier déclare être responsable de la distribution"}, ]}, 
