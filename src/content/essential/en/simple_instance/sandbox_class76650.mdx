...
{slot_reference: "name", value: [{value_type: "string", value_content: "hyperlink sur le flux de MBM Motorbrigades vers cdib website"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "hyperlink sur le flux de MBM Brigade motorisées vers cdib website"}, ]}, 
