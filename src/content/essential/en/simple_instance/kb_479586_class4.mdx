...
{slot_reference: "description", value: [{value_type: "string", value_content: "De GDPR-portal richt zich op weergaven om records van verwerkingsactiviteiten van persoonsgegevens te beheren"}, ]}, 
