...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_729355_Class6"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Flow van Hyporeg naar Filenet"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Informatie omtrent images van documenten (aktes, hypotheekoverschrijvingen) op flow van Hyporeg naar Filenet managed by HYPO-REG_PROD"}, ]}, 
