...
{slot_reference: "name", value: [{value_type: "string", value_content: "Flux de fleetmanagement vers Fedcom"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de fleetmanagement vers Fedcom"}, ]}, 
