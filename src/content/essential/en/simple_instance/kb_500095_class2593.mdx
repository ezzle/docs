...
{slot_reference: "name", value: [{value_type: "string", value_content: "infos sur autorisations AEO et certificats AEO concernant déclarations précédentes et non conformités sur le flux de Banaeos vers CGSI (est GI consult)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "futur: infos sur autorisations AEO et certificats AEO concernant déclarations précédentes et non conformités sur le flux de Banaeos vers CGSI"}, ]}, 
