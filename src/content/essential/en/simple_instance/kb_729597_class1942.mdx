...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat volledige db gérer indépendamment les données de géoréférencement Agristat"}, ]}, 
