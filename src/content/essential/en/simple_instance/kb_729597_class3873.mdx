...
{slot_reference: "name", value: [{value_type: "string", value_content: "Pdump Pcomp  régistration des contrôles sur les droits antidumping et compensateurs"}, ]}, 
