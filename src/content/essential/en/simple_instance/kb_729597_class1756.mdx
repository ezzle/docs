...
{slot_reference: "name", value: [{value_type: "string", value_content: "Cocy  aperçu des fiches SPS, avec possibilité pour consulter les hits pour la filiale"}, ]}, 
