...
{slot_reference: "name", value: [{value_type: "string", value_content: "service FinDomImmo"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Un outil de gestion permettant l'établissement du patrimoine privé de l'Etat"}, ]}, 
