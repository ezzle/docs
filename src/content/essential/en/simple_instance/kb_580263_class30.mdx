...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_580263_Class31"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "inlichtingen inzake mogelijk agressieve fiscale planningsconstructies op flow van Stirint MDR naar CCN Gateway 2 managed by Stirint MDR"}, ]}, 
