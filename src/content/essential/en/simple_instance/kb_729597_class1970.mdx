...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat volledige db-consulter les aperçus, concernant régistrations dans le cadre de l'importation des graines, l'importation et de certificats de pesage des bananes, l'exportation du sucre, les contrôles de substitution et les restitutions."}, ]}, 
