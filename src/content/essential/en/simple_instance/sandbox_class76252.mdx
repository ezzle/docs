...
{slot_reference: "name", value: [{value_type: "string", value_content: "données des biens immobiliers sur le flux de Consultimmo vers client Federation Wallonie Bruxelles sur ESB (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données biens immobiliers sur le flux de Consultimmo vers client Federation Wallonie Bruxelles sur ESB (flux vers application externe non SPF Finances)"}, ]}, 
