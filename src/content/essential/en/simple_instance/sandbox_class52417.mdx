...
{slot_reference: "description", value: [{value_type: "string", value_content: "Redmine est l'outil choisi par ICT Development pour gérer les tâches dans des projets et des applications dans le département ICT."}, ]}, 
