...
{slot_reference: "name", value: [{value_type: "string", value_content: "service DA Outfit"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion des uniformes douaniers"}, ]}, 
