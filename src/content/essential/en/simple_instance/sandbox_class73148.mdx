...
{slot_reference: "name", value: [{value_type: "string", value_content: "des documents contenant des instructions relatives à la sécurité, à l'économie, à la santé et à l'environnement"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "des documents contenant des instructions relatives à la sécurité, à l'économie, à la santé et à l'environnement"}, ]}, 
