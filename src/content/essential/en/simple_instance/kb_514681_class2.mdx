...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_514681_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "overschrijving tss journaals van betaalgegevens nav registratie huurcontract (nodig voor de formaliteit in myrent) op flow van Comfor naar Myrent managed by COMFOR_PROD"}, ]}, 
