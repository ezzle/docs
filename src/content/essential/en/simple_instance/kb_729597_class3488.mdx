...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool Handhaving  compléter les données de l'application Feedback, concernant les fiches SPS prioritaires, sur une manière correcte et fiable"}, ]}, 
