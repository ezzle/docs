...
{slot_reference: "name", value: [{value_type: "string", value_content: "numéros Eori sur le flux de Ncts vers Eori"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de NCTS vers Eori"}, ]}, 
