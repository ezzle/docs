...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_226478_Class4"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Selectie percelen uit Cadgis in XML op flow van Cadgis naar Stipad managed by CadGIS  cadgisserver  R2_PROD"}, ]}, 
