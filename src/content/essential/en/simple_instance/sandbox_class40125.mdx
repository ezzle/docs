...
{slot_reference: "name", value: [{value_type: "string", value_content: "Projets  catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des projets significatifs pour l'organisation."}, ]}, 
