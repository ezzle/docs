...
{slot_reference: "name", value: [{value_type: "string", value_content: "SEDA dashboard  verkrijgen, in een virtueel venster, van het detail van operatoren voor een waarde van het criterium"}, ]}, 
