...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Identity Manager"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Ce service garde des données des fonctionnaires (qui est qui, où travaille-t-il…) (au sein de l'IAM)"}, ]}, 
