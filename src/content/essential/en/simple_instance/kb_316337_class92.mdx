...
{slot_reference: "name", value: [{value_type: "string", value_content: "Rationaliser les différentes initiatives relatives à la restructuration et au regroupement des services/équipes"}, ]}, 
