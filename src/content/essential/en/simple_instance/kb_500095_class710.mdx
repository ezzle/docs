...
{slot_reference: "name", value: [{value_type: "string", value_content: "modification / ajout des rues sur le flux de MEOW NSR vers Urbain (interface humaine)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Flux de NSR vers Urbain (interface humaine). Même si c'est stocké dans la même base de données, les demandes de modification / ajout de rues sont ré-encodé manuellement dans NSR (permet un check)"}, ]}, 
