...
{slot_reference: "name", value: [{value_type: "string", value_content: "données signalétiques de personnes assujetties au précompte professionel sur le flux de Sitran vers BV Land"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données signalétiques de personnes assujetties au précompte professionel sur le flux de Sitran vers BVLand"}, ]}, 
