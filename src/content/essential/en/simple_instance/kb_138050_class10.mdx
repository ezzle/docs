...
{slot_reference: "name", value: [{value_type: "string", value_content: "DP-01 Les données constituent un avantage"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Les informations ont une valeur et sont gérées en conséquence"}, ]}, 
