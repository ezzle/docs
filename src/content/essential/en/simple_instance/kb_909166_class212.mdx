...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class213"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Vragen om internationale inlichtingen en invorderingsbijstand op flow van Stirint Int Inv naar Myscan managed by STIRint  Internationale Invorderingen_PROD"}, ]}, 
