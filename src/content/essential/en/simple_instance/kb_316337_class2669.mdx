...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service PC gestion des adresses"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Adressenbeheer est une application locale sur PC chez AA D&amp;A."}, ]}, 
