...
{slot_reference: "name", value: [{value_type: "string", value_content: "Hypo reg consulter des dossiers pour des virements pour des bureaux d'régistration"}, ]}, 
