...
{slot_reference: "name", value: [{value_type: "string", value_content: "STATIS  Archivage et consultation des bilans sélectionnés des données collectées dans les bureaux depuis 2002"}, ]}, 
