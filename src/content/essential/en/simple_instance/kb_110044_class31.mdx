...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_110044_Class32"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "inlichtingen inzake mogelijk agressieve fiscale planningsconstructies op flow van Stirint MDR naar Stirint managed by Stirint MDR"}, ]}, 
