...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Elearning"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Plateforme e-learning : portail qui est géré et suivi par une firme externe."}, ]}, 
