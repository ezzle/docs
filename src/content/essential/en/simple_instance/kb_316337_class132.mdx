...
{slot_reference: "name", value: [{value_type: "string", value_content: "Etendre et user des possibilités de SEDA comme outil de sélection et optimiser l'utilisation des techniques de datamining"}, ]}, 
