...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool Handhaving  facilitation des demandes d'information complexes, reçues via l'application IRMA (Information Request Management)"}, ]}, 
