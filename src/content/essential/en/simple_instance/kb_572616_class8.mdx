...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_572616_Class9"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Kohieren, rollen en aanmaningen nalatigheidsintresten niet-fiscale schulden via dagelijkse flat file op flow van Debiteurenbeheer naar 180b Nfi managed by Mijn kantoor invordering03-Debiteurenbeheer_Prod"}, ]}, 
