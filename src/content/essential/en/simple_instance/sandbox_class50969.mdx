...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la Comptabilité des extraits (cadastraux), local."}, ]}, 
