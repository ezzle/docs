...
{slot_reference: "name", value: [{value_type: "string", value_content: "paiements traités de taxe de circulation sur le flux de taxe de circulation automatisée to belconet archive, flux mensuel"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux des paiements traités de taxe de circulation de taxe de circulation automatisée vers belconet archive, flux mensuel"}, ]}, 
