...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  transversal  Envoi automatique des rappels vers l'étranger  dans le workflow AP  données adéquates en xml"}, ]}, 
