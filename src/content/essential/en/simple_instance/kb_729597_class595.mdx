...
{slot_reference: "name", value: [{value_type: "string", value_content: "VIES  consulter les taux de change utilisés dans les acquisitions intracommunautaires"}, ]}, 
