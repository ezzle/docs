...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service estimation du tax gap TVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Modèle analytique pour l'estimation du tax gap concernant la TVA."}, ]}, 
