...
{slot_reference: "name", value: [{value_type: "string", value_content: "cap  rapports partiels: plus spécifiquement par rapport aux déclarations d'importation et d'exportation"}, ]}, 
