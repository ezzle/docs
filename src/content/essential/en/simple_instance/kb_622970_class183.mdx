...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_682726_Class29"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Analysegegevens + link tussen een formaliteit in de HYPO omgeving en het bijbehorend beeld van akte in de STIPAD objectstore op flow van Stipad naar Hypo (2 webservices: 1 via ESB en 1 rechtstreeks) managed by STIPAD"}, ]}, 
