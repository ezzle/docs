...
{slot_reference: "name", value: [{value_type: "string", value_content: "Taxe de circulation-TcBook_Prod (SPF Mobilité)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "BD Taxe de circulation est l'application du SPF Mobilité et transport pour le taxe de circulation."}, ]}, 
