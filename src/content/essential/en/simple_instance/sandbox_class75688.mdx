...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire Vignet 705 –  manuel B"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "705: fiche d'information destinée aux titulaires de permis du groupe B concernant les vignettes 705 véhicules neufs / commerce de détail"}, ]}, 
