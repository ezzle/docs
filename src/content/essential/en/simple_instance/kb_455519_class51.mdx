...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_455519_Class52"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "verwijzing naar de instructies in niet-fiscale documentatie op flow van SPS consultatie naar niet fiscale doc managed by CONSULTATIE SPS FICHES-CONSULTATION FICHES SPS_Prod"}, ]}, 
