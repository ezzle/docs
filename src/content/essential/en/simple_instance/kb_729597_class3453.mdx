...
{slot_reference: "name", value: [{value_type: "string", value_content: "COCY  aperçus partiels spécifiques des données de cycles de contrôle de MASP-PLDA"}, ]}, 
