...
{slot_reference: "name", value: [{value_type: "string", value_content: "P087 Rédiger des avis et des rapports"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "P87 Rédiger des avis et des rapports"}, ]}, 
