...
{slot_reference: "name", value: [{value_type: "string", value_content: "Générateur UUID (Universal Unique Identifiers)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Générer des sets individuels ou bulk des Universal Unique Identifiers (UUID)"}, ]}, 
