...
{slot_reference: "name", value: [{value_type: "string", value_content: "Info pages de couverture pour stockage sur le flux de gds web vers Stiron"}, ]}, 
...
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class77252"}, ]}, 
