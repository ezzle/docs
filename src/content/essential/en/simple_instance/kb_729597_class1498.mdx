...
{slot_reference: "name", value: [{value_type: "string", value_content: "gestion des risques (DMGC)  consultation des notes, circulaires, livres, templates, profils de risque, méchanismes de fraude, indicateurs de risque et autre  documentation pertinente"}, ]}, 
