...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 152.1: taxe annuel sur les opérations d'assurance"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Révision des déclarations numéro 151² (taxe annuelle sur les opérations d'assurance)."}, ]}, 
