...
{slot_reference: "name", value: [{value_type: "string", value_content: "Donnée physique : résumé"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Présente les principales relations d'une donnée objet physique."}, ]}, 
