...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande d'une autorisation européenne chez AG D&amp;A pour l'usage des sceaux d'un modèle spécifique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Demande d'autorisation d'utiliser des sceaux d'un modèle spécial: article 233, paragraphe 4, point c), du code Taric, code de certificat C523 autorisation d'utiliser des sceaux d'un modèle spécial"}, ]}, 
