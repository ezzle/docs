...
{slot_reference: "name", value: [{value_type: "string", value_content: "signal Database (MariaDB/MySQL)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "signal Relational Database on MariaDB/MySQL Environment"}, ]}, 
