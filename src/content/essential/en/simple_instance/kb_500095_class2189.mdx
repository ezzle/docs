...
{slot_reference: "name", value: [{value_type: "string", value_content: "statistiques concernant déclarations PLDA sélectionnées sur le flux de Seda vers Ipi plan d'information"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "statistiques concernant des déclarations PLDA sélectionnées sur le flux de Seda vers Ipi plan d'information"}, ]}, 
