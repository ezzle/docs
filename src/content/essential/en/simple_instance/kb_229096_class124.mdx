...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class125"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Resultaten a posteriori controles plda aangiftes op flow van CAP naar SPS consultatie managed by CAP_Prod"}, ]}, 
