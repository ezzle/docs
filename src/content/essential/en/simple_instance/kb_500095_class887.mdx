...
{slot_reference: "name", value: [{value_type: "string", value_content: "fichier xml pour clôturer la comptabilité sur le flux mensuel de Stiron inv vers Fedcom"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Stiron inv vers Fedcom: chaque mois fichier xml pour la clôture de la comptabilité"}, ]}, 
