...
{slot_reference: "name", value: [{value_type: "string", value_content: "DB NP: schéma: NPP  tableau NPP_T_AJ"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "DB NP : schéma : NPP : E Notaire utilise la table  NPP_T_AJ  de db NP pour connaître les données du bureau compétent pour le contribuable NP (n° RR, année)."}, ]}, 
