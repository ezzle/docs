...
{slot_reference: "name", value: [{value_type: "string", value_content: "licence alcool  délivrer une licence d'ethylalcool et boissons alcoolisées (autre que sous le régime de suspension des droits d'accise)"}, ]}, 
