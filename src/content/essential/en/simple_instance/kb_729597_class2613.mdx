...
{slot_reference: "name", value: [{value_type: "string", value_content: "Feedback  module de recherche pour chercher sur fiche SPS, sur code de bien, sur expéditeur et/ou destinataire"}, ]}, 
