...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire pour radiation d'un compte étranger déjà communiqué au CAP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire pour radiation d'un compte étranger déjà communiqué au Point de contact central BNB"}, ]}, 
