...
{slot_reference: "name", value: [{value_type: "string", value_content: "Information  Modèle de référence"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cartographie des concepts informationnels significatifs pour l'organisation."}, ]}, 
