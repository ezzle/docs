...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_802335_Class31"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "BTW aangiftes op flow van Intervat naar PDF Helper managed by Intervat_prod"}, ]}, 
