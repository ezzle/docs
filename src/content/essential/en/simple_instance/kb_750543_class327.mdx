...
{slot_reference: "name", value: [{value_type: "string", value_content: "P043 Méthodes de travail"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Méthodes de travail (p43)"}, ]}, 
