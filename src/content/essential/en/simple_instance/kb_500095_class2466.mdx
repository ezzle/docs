...
{slot_reference: "name", value: [{value_type: "string", value_content: "données à archiver versements anticipés dans un fichier sur flux annuel de versements anticipés to belconet archive"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données à archiver pour des versements anticipés dans un fichier sur flux annuel de versements anticipés vers belconet archive"}, ]}, 
