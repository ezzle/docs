...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Euroboundaries"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Un projet historique contenant toutes les coördonnées des frontières nationales. Gestion des postes-frontières Belges."}, ]}, 
