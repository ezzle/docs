...
{slot_reference: "name", value: [{value_type: "string", value_content: "Diplomacy  régistration des déclarations 136F pour l'achat des produits contingentés avec exonération des droits de douane, impôts et autres cotisations similaires"}, ]}, 
