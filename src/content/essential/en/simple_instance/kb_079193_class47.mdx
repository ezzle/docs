...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_079193_Class48"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "The NCTS system integrates with AEO system in order to retrieve authorisations for locations used by traders when creating SP MRNs."}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "movement reference numbers op Flow van NCTS naar AEO managed by NCTS_PROD"}, ]}, 
