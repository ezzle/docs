...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service ACM workflow"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Service qui fournit des applications de workflow construites sur la plate-forme IBM ACM."}, ]}, 
