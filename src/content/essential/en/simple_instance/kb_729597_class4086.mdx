...
{slot_reference: "name", value: [{value_type: "string", value_content: "First   Collection-Public sale Notificatie  notificatie van openbare verkoop  behandelen"}, ]}, 
