...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_761476_Class11"}, ]}, 
{slot_reference: "app_pro_persists_info_rep", value: [{value_type: "boolean", value_content: "false"}, ]}, 
{slot_reference: "used_in_app_dependencies", value: [{value_type: "simple_instance", value_content: "KB_761476_Class8"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Kadastraal plan (o.b.v. kadastrale code en o.b.v. volgnummer) op flow van Surveyorplan naar Eregistration over ESB (stroom naar externe niet Fod Fin applicatie) managed by SurveyorPlan_PROD"}, ]}, 
