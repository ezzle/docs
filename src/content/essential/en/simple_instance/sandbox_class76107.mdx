...
{slot_reference: "name", value: [{value_type: "string", value_content: "Données géomètres et numéros Cad sur le flux de plan de géomètre vers Géomètre Fonctionnaire (interface humaine)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données géomètres et numéros cadastraux sur le flux de plan de géomètre vers Géomètre Fonctionnaire (interface humaine)"}, ]}, 
