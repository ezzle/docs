...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service e-TIR gate"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "MASP Gateway avec e-TIR depuis NCTS (AG Douane et Accises)."}, ]}, 
