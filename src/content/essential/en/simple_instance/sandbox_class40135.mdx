...
{slot_reference: "name", value: [{value_type: "string", value_content: "Donnée Objet: cartographie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Résumé des relations ou attributs d'une donnée objet logique"}, ]}, 
