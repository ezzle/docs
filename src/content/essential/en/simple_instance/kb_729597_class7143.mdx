...
{slot_reference: "name", value: [{value_type: "string", value_content: "Monitoringtool Handhaving  aperçus des statistiques dans le cadre du suivi et de l'évaluation de la gestion de maintien de l’ordre concernant les déclarations d'import et d'export, des déclaration sommaires à l'entrée (ENS) et au sorti (EXS) et de services de messagerie"}, ]}, 
