...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_456742_Class3"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "POW-gegevens nodig ter voorbereiding hypothecaire inschrijving op manuele flow van Properties on web naar Debiteurenbeheer managed by PropertiesOnWeb_Prod"}, ]}, 
