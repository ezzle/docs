...
{slot_reference: "name", value: [{value_type: "string", value_content: "IPI  plan d'information  rassembler les données concernant les objectifs (KPI’s) du SPF Finances"}, ]}, 
