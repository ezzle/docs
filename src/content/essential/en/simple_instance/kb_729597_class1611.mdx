...
{slot_reference: "name", value: [{value_type: "string", value_content: "fumigation des containers  information concernant la fumigation des containers"}, ]}, 
