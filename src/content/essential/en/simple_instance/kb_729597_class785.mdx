...
{slot_reference: "name", value: [{value_type: "string", value_content: "First module non fiscal  Consultation des créanciers  Recouvrement non fiscal"}, ]}, 
