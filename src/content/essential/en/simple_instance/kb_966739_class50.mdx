...
{slot_reference: "app_pro_to_inforep_from_app", value: [{value_type: "simple_instance", value_content: "KB_852741_Class199"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "aangifte Finprof managed by SP 02  Declarations au precompte professionnel  Front-End_PROD Finprof::Finprof  Status BV-aangifte à jour gehouden in db  (bv. als vergissing in aangifte rechtgezet)."}, ]}, 
