...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  module générique  suppression recouvrement  UC 31-12 décision d'autorisation de suspension"}, ]}, 
