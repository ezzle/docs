...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Framework lot 3 (connection mainframe)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Framework lot 3 (mainframe connection) service. Connecteur vers les mainframes."}, ]}, 
