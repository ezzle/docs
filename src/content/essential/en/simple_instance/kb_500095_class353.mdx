...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation sur base de Gestion Des Debiteurs de la retenue TVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation sur la base de Gestion Des Débiteurs de la retenue TVA"}, ]}, 
