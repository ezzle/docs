...
{slot_reference: "name", value: [{value_type: "string", value_content: "Stiron lot2 INV  apurement petits soldes: si une opération de recouvrement coûte plus cher qu'elle ne rapporte"}, ]}, 
