...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service GESFOR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application pour la Gestion des formations: inscriptions, séminaires…"}, ]}, 
