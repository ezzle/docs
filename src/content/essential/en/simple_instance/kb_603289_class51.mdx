...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_603289_Class52"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Wijziging / toevoeging van straten op flow van MEOW NSR naar Urbain (human interface) managed by NSR-BestAdres_PROD"}, ]}, 
