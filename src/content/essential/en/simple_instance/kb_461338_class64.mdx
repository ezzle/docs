...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_461338_Class65"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Btw-aangiftes m.b.t. BTW op intracommunautaire leveringen van intellectuele rechten op flow van Voes naar Filenet managed by STIRint  VAT on e-services_PROD (voes)"}, ]}, 
