...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "279E1  Imposition d'office notification Annexe managed by BizTaxBO_PROD"}, ]}, 
