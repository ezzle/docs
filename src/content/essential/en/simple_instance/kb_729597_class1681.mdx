...
{slot_reference: "name", value: [{value_type: "string", value_content: "revoir les quota ATV accordés (pour achats des véhicules avec une exonération temporaire des droits de douane et/ou TVA)"}, ]}, 
