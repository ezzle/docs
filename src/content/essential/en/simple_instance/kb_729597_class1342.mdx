...
{slot_reference: "name", value: [{value_type: "string", value_content: "BV Land  db “Open BVL”  utilisé pour flux journalier vers AG Fisc du db “Openbvl” vers db “PPFollow up”"}, ]}, 
