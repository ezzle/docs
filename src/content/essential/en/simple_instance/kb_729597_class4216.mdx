...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  Annuler un dossier de demande (traiter les demandes des bénéficiaires)"}, ]}, 
