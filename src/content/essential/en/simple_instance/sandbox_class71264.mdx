...
{slot_reference: "name", value: [{value_type: "string", value_content: "BBF client  Personne Physique sans NN (RDC Database)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Representation et DB relationnelle de BBF client sur la base d'informations d'identification alternative, et l'absence de numéro de Régistre National Belge. C'est en particulier le cas des personnes inconnues du numéro de Régistre National, Régistre Bis, etc."}, ]}, 
{slot_reference: "system_content_lifecycle_status", value: [{value_type: "simple_instance", value_content: "KB_229567_Class67"}, ]}, 
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class80794"}, ]}, 
