...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Personnes Morales"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Consultation et modification du répertoire général des personnes morales (données d'identification et données fiscales)."}, ]}, 
