...
{slot_reference: "name", value: [{value_type: "string", value_content: "données déclaration NCTS sur le flux de PLDA Goodsflow vers Ncts"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de PLDA Goodsflow vers NCTS. Déclaration NCTS est validé par check dans Goodsflow"}, ]}, 
