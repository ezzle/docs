...
{slot_reference: "name", value: [{value_type: "string", value_content: "Métiers  Domaines  catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des différents domaines métiers significatifs pour l'organisation."}, ]}, 
