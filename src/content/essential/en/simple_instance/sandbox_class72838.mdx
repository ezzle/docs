...
{slot_reference: "description", value: [{value_type: "string", value_content: "Données des parcelles utilisées dans les remboursements en cours : les données des parcelles sont saisies dans un certain type de remboursement"}, ]}, 
