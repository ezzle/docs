...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_106368_Class161"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "info omtrent voertuigen die in het buitenland aangekocht worden, maar in België ingeschreven worden, op flow van vignetten 705 naar IPI informatieplan managed by Vignettes 705_Prod"}, ]}, 
