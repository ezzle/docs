...
{slot_reference: "name", value: [{value_type: "string", value_content: "Diagnose van de Gegevensstromen"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Onderzoek van onderbrekingen en stoornissen in de prestaties van de end-to-end gegevensstromen."}, ]}, 
