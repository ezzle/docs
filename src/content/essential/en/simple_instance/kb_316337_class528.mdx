...
{slot_reference: "name", value: [{value_type: "string", value_content: "Généraliser le dépôt électronique légalement obligatoire pour les PME et les GE"}, ]}, 
