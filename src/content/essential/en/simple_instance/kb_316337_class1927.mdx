...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Hiërarchie"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application affiche les différents niveaux hiérarchiques et les points de contacts de l'administration.(IAM) (nouvel ldap)"}, ]}, 
