...
{slot_reference: "name", value: [{value_type: "string", value_content: "Feuille de route  catalogue par couche"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste, par domaine architectural, des feuilles de route stratégiques renseignées dans l'architecture."}, ]}, 
