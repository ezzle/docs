...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 121.1: déclaration TVA 6%  construction d'immeuble"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déclaration à présenter pour l'établissement d'un logement privé avec une TVA de 6% en 2009 sur une base d'imposition maximale de 50.000 EUR"}, ]}, 
