...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des débiteurs  module d'impression  imprimer des formulaires d' Icdowin"}, ]}, 
