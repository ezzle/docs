...
{slot_reference: "name", value: [{value_type: "string", value_content: "échange de l'information des plaques d'immatriculation G sur le flux de l' application Energie vers Vignetten 705 (chez SPF Mobilité) (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "échange information des plaques G d'immatriculation d' Energie vers Vignettes 705 ( SPF Mobilité) (flux vers application externe non SPF Finances)"}, ]}, 
