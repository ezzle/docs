...
{slot_reference: "description", value: [{value_type: "string", value_content: "Un processus de commandes de brochure a été établi sur un serveur qui se trouve chez Belgacom (‘koba’)."}, ]}, 
