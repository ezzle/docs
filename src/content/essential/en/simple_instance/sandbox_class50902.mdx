...
{slot_reference: "name", value: [{value_type: "string", value_content: "Check in at work (aanwezigheidsregistratie bij werken in onroerende staat)"}, ]}, 
