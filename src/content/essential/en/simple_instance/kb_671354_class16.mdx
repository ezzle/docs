...
{slot_reference: "name", value: [{value_type: "string", value_content: "Active Directory FR"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Services de domaine Active Directory pour l’environnement Wintel (PC + serveurs) du SPF Finances."}, ]}, 
