...
{slot_reference: "name", value: [{value_type: "string", value_content: "vignettes 705  2 modules de chargement pour des messages XML, fournis par les titulaires de licence concernant vignettes 705 (cette fonctionalité est exclusivement disponible pour de nouveaux véhicules)"}, ]}, 
