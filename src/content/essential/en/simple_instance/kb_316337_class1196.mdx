...
{slot_reference: "name", value: [{value_type: "string", value_content: "service CCFF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "connecteur CCFF Message"}, ]}, 
