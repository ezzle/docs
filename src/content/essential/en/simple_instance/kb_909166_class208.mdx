...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_909166_Class209"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "aangiftes Intervat voor andere lidstaten van de BTW belastingplichtige die een wagen zonder Btw gekocht heeft (en waarop BTW moet betaald worden in het land van bestemming waar de wagen gebruikt zal worden) op flow van Stirint clo naar Myscan managed by STIRint  CLO_PROD"}, ]}, 
