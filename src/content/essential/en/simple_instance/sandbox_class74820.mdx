...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire demande d'une autorisation européenne chez AG D&amp;A pour la maintenance d'une ligne maritime"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "demande d'une autorisation pour la maintenance d'une ligne maritime : article 120 code Taric de certificat C510 autorisation pour la maintenance d'une ligne maritime"}, ]}, 
