...
{slot_reference: "name", value: [{value_type: "string", value_content: "gestion des risques (DMGC)  gérer le contenu des pages web de l'application gestion des risques (DMGC)"}, ]}, 
