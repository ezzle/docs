...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Eplan2"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Suivi des plans de travail des agents des services de recherche. Réalisé pour le Centre National de Recherche (CNR) – Nationale OpsporingsDirectie (NCO)."}, ]}, 
