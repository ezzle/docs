...
{slot_reference: "description", value: [{value_type: "string", value_content: "Module de first (auparavant stimer) First base = interface technique"}, ]}, 
