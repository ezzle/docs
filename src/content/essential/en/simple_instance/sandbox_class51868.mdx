...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mantis (outil pour la gestion des projets)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Mantis est un outil pour la gestion des projets chez l'AG Fiscalité (impôts des personnes physiques)."}, ]}, 
