...
{slot_reference: "name", value: [{value_type: "string", value_content: "Agristat 4 régistration des déclarations dans le cadre de l'importation des graines, l'importation et les certificats de pesage des bananes, l'exportation du sucre, les restitutions et les contrôles de substitution."}, ]}, 
