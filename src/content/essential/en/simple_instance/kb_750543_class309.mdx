...
{slot_reference: "name", value: [{value_type: "string", value_content: "P130 Gestion de l'automatisation"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "? Gestion de l'automatisation (p130)"}, ]}, 
