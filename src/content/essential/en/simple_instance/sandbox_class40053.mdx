...
{slot_reference: "name", value: [{value_type: "string", value_content: "Technologie  Composant  catalogue alphabétique"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Liste alphabétique des composants technologiques significatifs pour l'organisation."}, ]}, 
