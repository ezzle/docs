...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_194576_Class10"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_194576_Class11"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "adhv stamnummer worden documenten rechtstreeks opgezocht in de filenet object store"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens personeelsleden op flow van MYPO naar Doctran managed by MyPO_PROD"}, ]}, 
