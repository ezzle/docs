...
{slot_reference: "name", value: [{value_type: "string", value_content: "Documentation du patrimoine"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Dans le cadre de la circulation juridique des biens, garantir la sécurité juridique en conservant la documentation patrimoniale."}, ]}, 
