...
{slot_reference: "name", value: [{value_type: "string", value_content: "valeurs vénales sur le flux de Locostat Expert Archive vers Locostat"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Locostat Expert Archive vers Locostat"}, ]}, 
