...
{slot_reference: "description", value: [{value_type: "string", value_content: "Biztax back office: application pour le traitement des déclarations d'impôt des sociétés (inclu les non résidents), impôt des personnes morales."}, ]}, 
