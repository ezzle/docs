...
{slot_reference: "description", value: [{value_type: "string", value_content: "Application utilisant un logiciel PHP fonctionnant sur un serveur d'application IIS, avec une base de données MySQL ou MariaDB sur le serveur Windows (en utilisant l'authentification IAM)."}, ]}, 
