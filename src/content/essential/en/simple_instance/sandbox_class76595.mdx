...
{slot_reference: "name", value: [{value_type: "string", value_content: "Contrats de bail sur le flux de Myrent vers service web IPI (flux vers application externe non SPF Finances)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Myrent vers webservice IPI (flux vers application externe non SPF Finances) interface entre MyRent (Fodfin) ; MyRentPro (application pour des agents immobiliers) ; MyRentCitoyens ; SOAP Based"}, ]}, 
