...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_972927_Class496"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "brief anomalie DP signaletiek 3 managed by STIR-TVA_PROD"}, ]}, 
