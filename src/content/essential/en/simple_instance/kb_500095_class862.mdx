...
{slot_reference: "name", value: [{value_type: "string", value_content: "fichier xml concernant saisie-arrêts (VFDB) sur le flux de BCSS vers l'ONVA"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "fichier sur flux de BCSS vers ONVA. fichier XML va de BCSS vers différents intégrateurs (maintenant ONVA  ; futur : intégrateur Région wallonne pour Adeps... )."}, ]}, 
