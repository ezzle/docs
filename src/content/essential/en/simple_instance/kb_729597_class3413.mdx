...
{slot_reference: "name", value: [{value_type: "string", value_content: "Niet Geaut VB  TC VB Lite bevat in feite alleen de consultatie en berekeningsfunctionaliteit (simulatiescherm) (gebruikt door AA D&amp;A)"}, ]}, 
