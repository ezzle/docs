...
{slot_reference: "description", value: [{value_type: "string", value_content: "Outil de chargement pour charger rapidement et efficacement les actions de contrôle et leurs fichiers associés dans l'application Stirco (ETL)."}, ]}, 
