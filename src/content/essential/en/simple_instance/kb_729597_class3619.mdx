...
{slot_reference: "name", value: [{value_type: "string", value_content: "E705db  faire des changements de fond aux régistrations des utilisateurs avec des droits d'accès inférieures et ajouter des nouvelles valeurs aux certains tableaux de référence"}, ]}, 
