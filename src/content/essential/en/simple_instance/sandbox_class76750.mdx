...
{slot_reference: "name", value: [{value_type: "string", value_content: "données d'identification sur le flux de APF to belcotax on web 2017"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "données d'identification sur le flux de APF vers belcoTax on Web 2017"}, ]}, 
