...
{slot_reference: "name", value: [{value_type: "string", value_content: "informations sur des entreprises avec le risque sur dégradation de la solvabilité sur le flux de SAS vers Solvabilité (application externe SPF Justice)"}, ]}, 
...
{slot_reference: "external_repository_instance_reference", value: [{value_type: "simple_instance", value_content: "sandbox_Class77505"}, ]}, 
