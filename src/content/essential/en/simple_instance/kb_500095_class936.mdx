...
{slot_reference: "name", value: [{value_type: "string", value_content: "AG DocPat acte authentique bordereau jugement"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "acte authentique bordereau jugement de l'AG DocPat"}, ]}, 
