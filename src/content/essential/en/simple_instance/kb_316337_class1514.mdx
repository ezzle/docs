...
{slot_reference: "name", value: [{value_type: "string", value_content: "service BizTax"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Biztax Management. Traitement des déclarations d'impôt des sociétés, impôt des personnes morales, sociétés BNI (double avec service Stiron Back-Office)."}, ]}, 
