...
{slot_reference: "name", value: [{value_type: "string", value_content: "ICPC  Pcfrms  manuele listing vervolgingskosten deurwaarders  php Service Listings"}, ]}, 
