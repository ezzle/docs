...
{slot_reference: "description", value: [{value_type: "string", value_content: "Gérer la flotte du SPF Finances de manière optimale et assurer la mise à disposition des chauffeurs dans les délais demandés par les clients."}, ]}, 
