...
{slot_reference: "name", value: [{value_type: "string", value_content: "Coopération douanière nationale et internationale"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Coopération douanière nationale et internationale"}, ]}, 
