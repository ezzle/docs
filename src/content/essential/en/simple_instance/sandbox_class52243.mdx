...
{slot_reference: "name", value: [{value_type: "string", value_content: "PersAssist_Prod (MyPenO de l'AG Documentation Patrimoniale)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Outil de gestion du personnel, MyPenO de l' AG Documentation Patrimoniale. Sera migré vers My PenO général"}, ]}, 
