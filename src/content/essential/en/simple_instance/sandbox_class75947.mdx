...
{slot_reference: "name", value: [{value_type: "string", value_content: "données créance alimentaire sur le flux de Secal php vers ICPC pour comparaison de dettes"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux vers ICPC pour le bilan fiscal: paiement créance d'alimentation sur la base de comparaison de dettes: transfer de dettes vers le bilan fiscal va par Secal PHP (pas par Secal mainframe)"}, ]}, 
