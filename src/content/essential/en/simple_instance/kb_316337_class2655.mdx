...
{slot_reference: "name", value: [{value_type: "string", value_content: "service Fichier PC Diplomates"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "PC Diplomaten = application sur PC (local). Cette application n'existe plus."}, ]}, 
