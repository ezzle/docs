...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application   modèle des plates formes technologiques"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Description graphique des composants technologiques logiques nécessaire au support d'une application donnée."}, ]}, 
