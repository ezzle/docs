...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_972633_Class77"}, ]}, 
...
{slot_reference: "operated_data_reps", value: [{value_type: "simple_instance", value_content: "KB_685739_Class0"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Controleresultaat dat oorspronkelijk uit MODA komt op Flow van Plda naar Ccrm managed by PLDA"}, ]}, 
