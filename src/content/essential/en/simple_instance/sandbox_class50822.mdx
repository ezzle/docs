...
{slot_reference: "description", value: [{value_type: "string", value_content: "Ceci est un lien vers la plus grande base de données de covoiturage en Belgique (www.Taxistop.be)."}, ]}, 
