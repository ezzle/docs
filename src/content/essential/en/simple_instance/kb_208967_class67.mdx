...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_208967_Class68"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "TIN nrs, notificaties, aanslagbiljetten niet inwoners (voor de directe belastingen) op flow van Stirint Dlo naar Cbc managed by STIRint  DLO_PROD"}, ]}, 
