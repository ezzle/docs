...
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application garde des données des fonctionnaires du SPF Finances (qui est qui, où travaille-t-il…)."}, ]}, 
