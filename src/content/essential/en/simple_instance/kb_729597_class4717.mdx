...
{slot_reference: "name", value: [{value_type: "string", value_content: "STATIS  beheer van een jaarlijks formulier voor het manueel verzamelen van gegevens"}, ]}, 
