...
{slot_reference: "name", value: [{value_type: "string", value_content: "service XWiki"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "partie de l' architecture technique du framework CCFF"}, ]}, 
