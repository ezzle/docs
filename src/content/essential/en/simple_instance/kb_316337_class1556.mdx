...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Archivage-Mail2"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "archivage Mail2 =&gt; archivage des mails de l' application Mail2"}, ]}, 
