...
{slot_reference: "name", value: [{value_type: "string", value_content: "Signalétique des ayants droits BBF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Signalétique des ayants droits BBF"}, ]}, 
