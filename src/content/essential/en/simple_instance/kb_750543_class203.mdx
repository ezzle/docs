...
{slot_reference: "name", value: [{value_type: "string", value_content: "Gestion des autorisations de libération des dépôts"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Gestion de l'autorisation de libération des dépôts"}, ]}, 
