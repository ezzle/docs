...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  opzoeking van slapende tegoeden in naam van een derde (opzoeking van slapende tegoeden service)"}, ]}, 
