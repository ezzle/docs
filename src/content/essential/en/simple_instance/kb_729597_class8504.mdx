...
{slot_reference: "name", value: [{value_type: "string", value_content: "Double couche redondante"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "L’architecture de la solution est basée sur une configuration de Firewalls en deux couches."}, ]}, 
