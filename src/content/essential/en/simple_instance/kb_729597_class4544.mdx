...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  fichier Identifin reçu (fichier reçu des institutions financières)"}, ]}, 
