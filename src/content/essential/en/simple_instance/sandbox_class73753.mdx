...
{slot_reference: "name", value: [{value_type: "string", value_content: "Renseignements financiers des impôts directs sur le flux de Stirint Crs vers Stirint ISI"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "informations financières impôts directs sur le flux de Stirint Crs à Stirint Isi"}, ]}, 
