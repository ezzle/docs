...
{slot_reference: "name", value: [{value_type: "string", value_content: "visualisation de l'entité des coûts solidaires chez amendes pénales par application DU-FNF"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "visualisation de l'entité des coûts solidaires chez amendes pénales par application DU-FNF"}, ]}, 
