...
{slot_reference: "description", value: [{value_type: "string", value_content: "taric Relational Database on MariaDB/MySQL Environment: taric est le nom de la db Européen  Tarbel"}, ]}, 
