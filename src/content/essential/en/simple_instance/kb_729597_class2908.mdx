...
{slot_reference: "name", value: [{value_type: "string", value_content: "Stiron lot2 INV  enregistrer l'ordre de recouvrement TVA (automatiquement ou manuellement)"}, ]}, 
