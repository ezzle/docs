...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_893920_Class36"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "DDS 2 Data Dissimenation System dient om gegevens in te voeren rechtstreeks door Europa zelf in Tarbel."}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Tariefgegevens op Flow van Dds2 naar Tarbel managed by Taric DDS2 Europese applicatie"}, ]}, 
