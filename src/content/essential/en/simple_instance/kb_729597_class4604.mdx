...
{slot_reference: "name", value: [{value_type: "string", value_content: "Finprof  Status de la déclaration PP tenu à jour dans le db (par exemple si une erreur dans la déclaration est rectifiée)"}, ]}, 
