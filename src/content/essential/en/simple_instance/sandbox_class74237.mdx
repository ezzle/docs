...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire 275R: réserve d'investissement"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Déclaration destinée à établir le montant de la réserve d'investissement."}, ]}, 
