...
{slot_reference: "name", value: [{value_type: "string", value_content: "Application  feuille de route"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Chronogramme graphique du cycle de vie d'une application et des technologies qui permettent de la réaliser."}, ]}, 
