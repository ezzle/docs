...
{slot_reference: "name", value: [{value_type: "string", value_content: "Envoyer les avertissements extraits de rôle au maximum électroniquement"}, ]}, 
