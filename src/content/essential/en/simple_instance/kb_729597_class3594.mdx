...
{slot_reference: "name", value: [{value_type: "string", value_content: "Comfor  gestion de la comptabilité des différents bureaux d'régistration"}, ]}, 
