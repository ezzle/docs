...
{slot_reference: "name", value: [{value_type: "string", value_content: "formulaire pour actualisation des données déjà communiquées au Cap  d'un compte étranger"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "formulaire pour actualisation des données déjà communiquées au Cap  d'un compte étranger"}, ]}, 
