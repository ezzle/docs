...
{slot_reference: "name", value: [{value_type: "string", value_content: "tableaux excel sigma"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "tableaux excel Sigma"}, ]}, 
