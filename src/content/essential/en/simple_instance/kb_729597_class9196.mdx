...
{slot_reference: "description", value: [{value_type: "string", value_content: "Power BI est utilisé pour créer des rapports / tableaux de bord pour des projets, par exemple. Nous pouvons considérer Power BI non seulement comme une application, mais aussi comme un produit technologique."}, ]}, 
