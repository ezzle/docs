...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_551377_Class60"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Gegevens betreffende de meetpunten (IPI-codes) op flow van Informatieplan naar IPI Dashboard managed by IPI Informatieplan-Plan d'information_Prod"}, ]}, 
