...
{slot_reference: "name", value: [{value_type: "string", value_content: "Comfor  traiter la formalité de la régistration de façon électronique"}, ]}, 
