...
{slot_reference: "name", value: [{value_type: "string", value_content: "service PersAssist"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Outil de gestion du personnel, MyPenO de Padoc. Sera migré vers My PenO"}, ]}, 
