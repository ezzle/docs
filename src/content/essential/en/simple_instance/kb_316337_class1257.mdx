...
{slot_reference: "description", value: [{value_type: "string", value_content: "Cette application fournit des données TVA D&amp;A dans le cadre des processus p31 collecte et p4 AEO et authorisations."}, ]}, 
