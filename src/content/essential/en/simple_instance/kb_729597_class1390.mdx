...
{slot_reference: "name", value: [{value_type: "string", value_content: "Mijn kantoor  recouvrement03 : module de Gestion des débiteurs  gestion du dettes de l'AGPR"}, ]}, 
