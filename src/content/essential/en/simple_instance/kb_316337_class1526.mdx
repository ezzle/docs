...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service Open ICPC"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Accès primitif au db OpenIC qui met les informations sur les dettes à disposition d'autres applications."}, ]}, 
