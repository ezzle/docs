...
{slot_reference: "name", value: [{value_type: "string", value_content: "Stats Acc  statistiques mensuels AC4 pour les différentes catégories d'accises"}, ]}, 
