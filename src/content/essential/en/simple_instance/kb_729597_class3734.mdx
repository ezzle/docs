...
{slot_reference: "name", value: [{value_type: "string", value_content: "First  accounting  UC 09-01  Fedcom  ajout de la date valeur dans la base de données"}, ]}, 
