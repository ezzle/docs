...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  opzoeking van slapende tegoeden in zijn eigen naam (opzoeking van slapende tegoeden service)"}, ]}, 
