...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_229096_Class131"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Resultaten controles selectie PLDA aangiftes op flow van DMGC data mgt system naar PLDA managed by DMGC  Data Mgmt System_Prod"}, ]}, 
