...
{slot_reference: "name", value: [{value_type: "string", value_content: "Service FlowMonitoring"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "application de monitoring SD ICT"}, ]}, 
