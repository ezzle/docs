...
{slot_reference: "name", value: [{value_type: "string", value_content: "données véhicules membres de personnel Shape sur le flux mensuel de Shape vers Taxe de circulation automatisée (fichier txt envoyé par mail mensuellement)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de Shape vers taxe de circulation automatisée (txt-fichier envoyé chaque mois par mail) avec des données des véhicules des membres de personnel Shape, flux mensuel."}, ]}, 
