...
{slot_reference: "name", value: [{value_type: "string", value_content: "service application des handicaps"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Application Access de SD P&amp;O: contient des données personnelles des agents avec un handicap."}, ]}, 
