...
{slot_reference: "name", value: [{value_type: "string", value_content: "Lutter contre les mécanismes de fraude fiscale (p23.1)"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Activités principales:
 gestion des connaissances
 Détection et analyse
 Traitement des dossiers et des affaires
