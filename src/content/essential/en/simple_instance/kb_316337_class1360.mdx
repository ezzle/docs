...
{slot_reference: "name", value: [{value_type: "string", value_content: "service BBF  Rapportage"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "UC_03_Reporting : paquet UC de BBF contenant les Use Cases pour le reporting. Cela inclut la visualisation et l'exportation des rapports."}, ]}, 
