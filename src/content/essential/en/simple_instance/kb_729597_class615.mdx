...
{slot_reference: "name", value: [{value_type: "string", value_content: "MOSS  régistration: un module d’régistration, qui permet aux contribuables de s’enregistrer dans le système"}, ]}, 
