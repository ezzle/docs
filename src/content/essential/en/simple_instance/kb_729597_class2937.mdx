...
{slot_reference: "name", value: [{value_type: "string", value_content: "Stiron lot2 INV  encoder, modifier, arrêter, annuler des actions de recouvrement de la dette TVA (possiblement une action globale pour tous les articles de dette TVA ouverts)"}, ]}, 
