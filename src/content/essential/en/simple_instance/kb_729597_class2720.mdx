...
{slot_reference: "name", value: [{value_type: "string", value_content: "EuVID  Autocrim  info sur les plaques d'immatriculation de tous les pays du monde"}, ]}, 
