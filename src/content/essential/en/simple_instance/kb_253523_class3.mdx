...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_253523_Class4"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "gegevens ivm pseudo-artikelnrs. op flow van PRI naar DXSI managed by AAPD_PRI_Prod (webservice)"}, ]}, 
