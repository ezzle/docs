...
{slot_reference: "name", value: [{value_type: "string", value_content: "UIT  remboursements journaliers à la charge du comptable local qui a reçu l'argent sur son compte"}, ]}, 
