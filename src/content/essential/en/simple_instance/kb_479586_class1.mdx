...
{slot_reference: "name", value: [{value_type: "string", value_content: "Portail RGDP"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "Le portail RGDP se concentre sur les vues pour gérer les enregistrements des activités de traitement des données personnelles"}, ]}, 
