...
{slot_reference: "name", value: [{value_type: "string", value_content: "flux de clm vers fedcom"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "flux de clm vers Fedcom"}, ]}, 
