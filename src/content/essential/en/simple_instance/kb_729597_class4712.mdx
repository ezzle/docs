...
{slot_reference: "name", value: [{value_type: "string", value_content: "STATIS  publicatie van een jaarlijkse tabel van statistieken te raadplegen door het Rekenhof"}, ]}, 
