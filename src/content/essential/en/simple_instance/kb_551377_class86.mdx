...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_551377_Class87"}, ]}, 
...
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "data om ad hoc bevragingen te beantwoorden op flow van emcs g&amp;i naar irma managed by Emcs_web_prod / Emcs_new_prod (php AA D&amp;A Gegevensbeheer)"}, ]}, 
