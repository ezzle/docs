...
{slot_reference: "name", value: [{value_type: "string", value_content: "situation de bilan fiscal pour notaires sur le flux d'ICPC vers E Notariat et alors de E Notariat vers E Functionnaire"}, ]}, 
{slot_reference: "description", value: [{value_type: "string", value_content: "situation de bilan fiscal pour notaires sur le flux d'ICPC vers E Notariat et alors de E Notariat vers E Functionnaire"}, ]}, 
