...
{slot_reference: "name", value: [{value_type: "string", value_content: "PANDORA  générer un message PAM (fichier reçu des institutions financières)"}, ]}, 
