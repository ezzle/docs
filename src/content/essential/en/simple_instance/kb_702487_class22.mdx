...
own_slot_value: [{slot_reference: "app_pro_to_inforep_to_inforep", value: [{value_type: "simple_instance", value_content: "KB_702487_Class23"}, ]}, 
...
{slot_reference: "relation_description", value: [{value_type: "string", value_content: "Men kan identificatie code opzoeken van een persoon of onderneming op basis van andere gegevens Sitran (dan de identificatiecode)"}, ]}, 
{slot_reference: "relation_name", value: [{value_type: "string", value_content: "Signaletiekgegevens op flow van Sitran naar Entité managed by SITRAN"}, ]}, 
