...
{slot_reference: "name", value: [{value_type: "string", value_content: "First PPWT-TPW  tax on participation of workers and dividends  déclarer le précompte mobilier sur les taxes sur la participation des salariés"}, ]}, 
